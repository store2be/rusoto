...
impl SignedRequest {
    ...
    // The request has to have already been signed
    pub fn presigned_url(&mut self, creds: &AwsCredentials) -> String {
        ...
        debug!("canonical_query_stirng: {:?}", self.canonical_query_string);
