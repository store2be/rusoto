...
pub struct AttachStaticIpRequest {
    ...
    #[doc="<p>The name of the static IP.</p>"]
    #[serde(rename="staticIpName")]
    pub static_ip_name: String,
}
...
pub struct AvailabilityZone {
    ...
    #[doc="<p>The name of the Availability Zone. The format is <code>us-east-1a</code> (case-sensitive).</p>"]
...
pub struct Blueprint {
    ...
    #[doc="<p>The description of the blueprint.</p>"]
    #[serde(rename="description")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub description: Option<String>,
    #[doc="<p>The group name of the blueprint (e.g., <code>amazon-linux</code>).</p>"]
    #[serde(rename="group")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub group: Option<String>,
    #[doc="<p>A Boolean value indicating whether the blueprint is active. When you update your blueprints, you will inactivate old blueprints and keep the most recent versions active.</p>"]
    #[serde(rename="isActive")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_active: Option<bool>,
    #[doc="<p>The end-user license agreement URL for the image or blueprint.</p>"]
    #[serde(rename="licenseUrl")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub license_url: Option<String>,
    #[doc="<p>The minimum machine size required to run this blueprint. <code>0</code> indicates that the blueprint runs on all instances.</p>"]
    #[serde(rename="minPower")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub min_power: Option<i64>,
    #[doc="<p>The friendly name of the blueprint (e.g., <code>Amazon Linux</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The product URL to learn more about the image or blueprint.</p>"]
    #[serde(rename="productUrl")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub product_url: Option<String>,
    #[doc="<p>The type of the blueprint (e.g., <code>os</code> or <code>app</code>).</p>"]
    #[serde(rename="type")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub type_: Option<String>,
    #[doc="<p>The version number of the operating system, application, or stack (e.g., <code>2016.03.0</code>).</p>"]
    #[serde(rename="version")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub version: Option<String>,
    #[doc="<p>The version code.</p>"]
...
pub struct Bundle {
    ...
    #[doc="<p>The number of vCPUs included in the bundle (e.g., <code>2</code>).</p>"]
    #[serde(rename="cpuCount")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub cpu_count: Option<i64>,
    #[doc="<p>The size of the SSD (e.g., <code>30</code>).</p>"]
    #[serde(rename="diskSizeInGb")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub disk_size_in_gb: Option<i64>,
    #[doc="<p>The Amazon EC2 instance type (e.g., <code>t2.micro</code>).</p>"]
    #[serde(rename="instanceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub instance_type: Option<String>,
    #[doc="<p>A Boolean value indicating whether the bundle is active.</p>"]
    #[serde(rename="isActive")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_active: Option<bool>,
    #[doc="<p>A friendly name for the bundle (e.g., <code>Micro</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The power of the bundle (e.g., <code>500</code>).</p>"]
    #[serde(rename="power")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub power: Option<i64>,
    #[doc="<p>The price in US dollars (e.g., <code>5.0</code>).</p>"]
    #[serde(rename="price")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub price: Option<f32>,
    #[doc="<p>The amount of RAM in GB (e.g., <code>2.0</code>).</p>"]
    #[serde(rename="ramSizeInGb")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ram_size_in_gb: Option<f32>,
    #[doc="<p>The data transfer rate per month in GB (e.g., <code>2000</code>).</p>"]
...
pub struct CloseInstancePublicPortsRequest {
    ...
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>Information about the public port you are trying to close.</p>"]
...
pub struct CreateDomainEntryRequest {
    ...
    #[doc="<p>The domain name (e.g., <code>example.com</code>) for which you want to create the domain entry.</p>"]
...
pub struct CreateInstanceSnapshotRequest {
    ...
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>The name for your new snapshot.</p>"]
...
pub struct CreateInstancesFromSnapshotRequest {
    ...
    #[doc="<p>The names for your new instances.</p>"]
    #[serde(rename="instanceNames")]
    pub instance_names: Vec<String>,
    #[doc="<p>The name of the instance snapshot on which you are basing your new instances. Use the get instance snapshots operation to return information about your existing snapshots.</p>"]
    #[serde(rename="instanceSnapshotName")]
    pub instance_snapshot_name: String,
    #[doc="<p>The name for your key pair.</p>"]
    #[serde(rename="keyPairName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub key_pair_name: Option<String>,
    #[doc="<p>You can create a launch script that configures a server with additional user data. For example, <code>apt-get –y update</code>.</p> <note> <p>Depending on the machine image you choose, the command to get software on your instance varies. Amazon Linux and CentOS use <code>yum</code>, Debian and Ubuntu use <code>apt-get</code>, and FreeBSD uses <code>pkg</code>. For a complete list, see the <a href=\"http://lightsail.aws.amazon.com/ls/docs/getting-started/articles/pre-installed-apps\">Dev Guide</a>.</p> </note>"]
...
pub struct CreateInstancesRequest {
    ...
    #[serde(rename="availabilityZone")]
    pub availability_zone: String,
    #[doc="<p>The ID for a virtual private server image (e.g., <code>app_wordpress_4_4</code> or <code>app_lamp_7_0</code>). Use the get blueprints operation to return a list of available images (or <i>blueprints</i>).</p>"]
    #[serde(rename="blueprintId")]
    ...
    #[serde(rename="instanceNames")]
    pub instance_names: Vec<String>,
    #[doc="<p>The name of your key pair.</p>"]
    #[serde(rename="keyPairName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub key_pair_name: Option<String>,
    #[doc="<p>A launch script you can create that configures a server with additional user data. For example, you might want to run <code>apt-get –y update</code>.</p> <note> <p>Depending on the machine image you choose, the command to get software on your instance varies. Amazon Linux and CentOS use <code>yum</code>, Debian and Ubuntu use <code>apt-get</code>, and FreeBSD uses <code>pkg</code>. For a complete list, see the <a href=\"http://lightsail.aws.amazon.com/ls/docs/getting-started/articles/pre-installed-apps\">Dev Guide</a>.</p> </note>"]
    #[serde(rename="userData")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub user_data: Option<String>,
}
...
pub struct CreateKeyPairResult {
    ...
    #[doc="<p>An array of key-value pairs containing information about the results of your create key pair request.</p>"]
    #[serde(rename="operation")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub operation: Option<Operation>,
    ...
    #[doc="<p>A base64-encoded public key of the <code>ssh-rsa</code> type.</p>"]
...
pub struct DeleteDomainEntryRequest {
    ...
    #[serde(rename="domainEntry")]
    pub domain_entry: DomainEntry,
    #[doc="<p>The name of the domain entry to delete.</p>"]
    #[serde(rename="domainName")]
    pub domain_name: String,
}
...
pub struct Disk {
    ...
    #[doc="<p>The resources to which the disk is attached.</p>"]
    #[serde(rename="attachedTo")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attached_to: Option<String>,
    #[doc="<p>The attachment state of the disk.</p>"]
    #[serde(rename="attachmentState")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attachment_state: Option<String>,
    #[doc="<p>The date when the disk was created.</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>The number of GB in use by the disk.</p>"]
    #[serde(rename="gbInUse")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub gb_in_use: Option<i64>,
    #[doc="<p>The input/output operations per second (IOPS) of the disk.</p>"]
    #[serde(rename="iops")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub iops: Option<i64>,
    #[doc="<p>A Boolean value indicating whether the disk is attached.</p>"]
    #[serde(rename="isAttached")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_attached: Option<bool>,
    #[doc="<p>A Boolean value indicating whether this disk is a system disk (has an operating system loaded on it).</p>"]
    #[serde(rename="isSystemDisk")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_system_disk: Option<bool>,
    #[doc="<p>The region and Availability Zone where the disk is located.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>The name of the disk.</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The disk path.</p>"]
    #[serde(rename="path")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub path: Option<String>,
    #[doc="<p>The resource type of the disk. </p>"]
    #[serde(rename="resourceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resource_type: Option<String>,
    #[doc="<p>The size of the disk in GB.</p>"]
    #[serde(rename="sizeInGb")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub size_in_gb: Option<i64>,
    #[doc="<p>The support code. Include this code in your email to support when you have questions about an instance or another resource in Lightsail. This code enables our support team to look up your Lightsail information more easily.</p>"]
...
pub struct Domain {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub arn: Option<String>,
    #[doc="<p>The date when the domain recordset was created.</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>An array of key-value pairs containing information about the domain entries.</p>"]
    #[serde(rename="domainEntries")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub domain_entries: Option<Vec<DomainEntry>>,
    #[doc="<p>The AWS Region and Availability Zones where the domain recordset was created.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
...
pub struct DomainEntry {
    #[doc="<p>The ID of the domain recordset entry.</p>"]
    #[serde(rename="id")]
    #[serde(skip_serializing_if="Option::is_none")]
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The options for the domain entry.</p>"]
    #[serde(rename="options")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub options: Option<::std::collections::HashMap<String, String>>,
    #[doc="<p>The target AWS name server (e.g., <code>ns-111.awsdns-22.com.</code>).</p>"]
    #[serde(rename="target")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub target: Option<String>,
    #[doc="<p>The type of domain entry (e.g., <code>SOA</code> or <code>NS</code>).</p>"]
    #[serde(rename="type")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub type_: Option<String>,
}
...
pub struct GetActiveNamesResult {
    ...
    #[doc="<p>A token used for advancing to the next page of results from your get active names request.</p>"]
...
pub struct GetBlueprintsRequest {
    ...
    #[doc="<p>A token used for advancing to the next page of results from your get blueprints request.</p>"]
    #[serde(rename="pageToken")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub page_token: Option<String>,
}
...
pub struct GetBundlesRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub include_inactive: Option<bool>,
    #[doc="<p>A token used for advancing to the next page of results from your get bundles request.</p>"]
    #[serde(rename="pageToken")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub page_token: Option<String>,
}
...
pub struct GetInstanceAccessDetailsRequest {
    ...
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>The protocol to use to connect to your instance. Defaults to <code>ssh</code>.</p>"]
...
pub struct GetInstanceMetricDataRequest {
    ...
    pub end_time: f64,
    #[doc="<p>The name of the instance for which you want to get metrics data.</p>"]
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>The metric name to get data about. </p>"]
    #[serde(rename="metricName")]
    pub metric_name: String,
    #[doc="<p>The time period for which you are requesting data.</p>"]
    #[serde(rename="period")]
    pub period: i64,
    #[doc="<p>The start time of the time period.</p>"]
    #[serde(rename="startTime")]
    pub start_time: f64,
    #[doc="<p>The instance statistics. </p>"]
    #[serde(rename="statistics")]
    pub statistics: Vec<String>,
    #[doc="<p>The unit. The list of valid values is below.</p>"]
    #[serde(rename="unit")]
    pub unit: String,
}
...
pub struct GetInstanceMetricDataResult {
    ...
    #[doc="<p>The metric name to return data for. </p>"]
    #[serde(rename="metricName")]
    #[serde(skip_serializing_if="Option::is_none")]
...
pub struct GetOperationsForResourceRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub page_token: Option<String>,
    #[doc="<p>The name of the resource for which you are requesting information.</p>"]
...
pub struct GetOperationsResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub next_page_token: Option<String>,
    #[doc="<p>An array of key-value pairs containing information about the results of your get operations request.</p>"]
    #[serde(rename="operations")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub operations: Option<Vec<Operation>>,
}
...
pub struct GetStaticIpsResult {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub next_page_token: Option<String>,
    #[doc="<p>An array of key-value pairs containing information about your get static IPs request.</p>"]
...
pub struct Instance {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub arn: Option<String>,
    #[doc="<p>The blueprint ID (e.g., <code>os_amlinux_2016_03</code>).</p>"]
    #[serde(rename="blueprintId")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub blueprint_id: Option<String>,
    #[doc="<p>The friendly name of the blueprint (e.g., <code>Amazon Linux</code>).</p>"]
    ...
    #[doc="<p>The bundle for the instance (e.g., <code>micro_1_0</code>).</p>"]
    #[serde(rename="bundleId")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub bundle_id: Option<String>,
    #[doc="<p>The timestamp when the instance was created (e.g., <code>1479734909.17</code>).</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>The size of the vCPU and the amount of RAM for the instance.</p>"]
    #[serde(rename="hardware")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub hardware: Option<InstanceHardware>,
    #[doc="<p>The IPv6 address of the instance.</p>"]
    #[serde(rename="ipv6Address")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ipv_6_address: Option<String>,
    #[doc="<p>A Boolean value indicating whether this instance has a static IP assigned to it.</p>"]
    #[serde(rename="isStaticIp")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_static_ip: Option<bool>,
    #[doc="<p>The region name and availability zone where the instance is located.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>The name the user gave the instance (e.g., <code>Amazon_Linux-1GB-Virginia-1</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>Information about the public ports and monthly data transfer rates for the instance.</p>"]
    ...
    #[doc="<p>The type of resource (usually <code>Instance</code>).</p>"]
    #[serde(rename="resourceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resource_type: Option<String>,
    #[doc="<p>The name of the SSH key being used to connect to the instance (e.g., <code>LightsailDefaultKeyPair</code>).</p>"]
    #[serde(rename="sshKeyName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ssh_key_name: Option<String>,
    #[doc="<p>The status code and the state (e.g., <code>running</code>) for the instance.</p>"]
    #[serde(rename="state")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub state: Option<InstanceState>,
    #[doc="<p>The support code. Include this code in your email to support when you have questions about an instance or another resource in Lightsail. This code enables our support team to look up your Lightsail information more easily.</p>"]
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub support_code: Option<String>,
    #[doc="<p>The user name for connecting to the instance (e.g., <code>ec2-user</code>).</p>"]
...
pub struct InstanceAccessDetails {
    ...
    #[doc="<p>For SSH access, the date on which the temporary keys expire.</p>"]
    #[serde(rename="expiresAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub expires_at: Option<f64>,
    #[doc="<p>The name of this Amazon Lightsail instance.</p>"]
    #[serde(rename="instanceName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub instance_name: Option<String>,
    #[doc="<p>The public IP address of the Amazon Lightsail instance.</p>"]
    #[serde(rename="ipAddress")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ip_address: Option<String>,
    #[doc="<p>For RDP access, the temporary password of the Amazon EC2 instance.</p>"]
    #[serde(rename="password")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub password: Option<String>,
    #[doc="<p>For SSH access, the temporary private key. For OpenSSH clients (e.g., command line SSH), you should save this value to <code>tempkey</code>).</p>"]
    #[serde(rename="privateKey")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub private_key: Option<String>,
    #[doc="<p>The protocol for these Amazon Lightsail instance access details.</p>"]
    #[serde(rename="protocol")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub protocol: Option<String>,
    #[doc="<p>The user name to use when logging in to the Amazon Lightsail instance.</p>"]
    #[serde(rename="username")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub username: Option<String>,
}
...
pub struct InstanceHardware {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub cpu_count: Option<i64>,
    #[doc="<p>The disks attached to the instance.</p>"]
    #[serde(rename="disks")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub disks: Option<Vec<Disk>>,
    #[doc="<p>The amount of RAM in GB on the instance (e.g., <code>1.0</code>).</p>"]
    #[serde(rename="ramSizeInGb")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ram_size_in_gb: Option<f32>,
}
...
pub struct InstanceNetworking {
    ...
    #[doc="<p>An array of key-value pairs containing information about the ports on the instance.</p>"]
    #[serde(rename="ports")]
    #[serde(skip_serializing_if="Option::is_none")]
...
pub struct InstancePortInfo {
    ...
    #[doc="<p>The location from which access is allowed (e.g., <code>Anywhere (0.0.0.0/0)</code>).</p>"]
    #[serde(rename="accessFrom")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub access_from: Option<String>,
    #[doc="<p>The type of access (<code>Public</code> or <code>Private</code>).</p>"]
    #[serde(rename="accessType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub access_type: Option<String>,
    #[doc="<p>The common name.</p>"]
...
pub struct InstancePortState {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub protocol: Option<String>,
    #[doc="<p>Specifies whether the instance port is <code>open</code> or <code>closed</code>.</p>"]
    #[serde(rename="state")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub state: Option<String>,
    #[doc="<p>The last port in the range.</p>"]
...
pub struct InstanceSnapshot {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub arn: Option<String>,
    #[doc="<p>The timestamp when the snapshot was created (e.g., <code>1479907467.024</code>).</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>The blueprint ID from which you created the snapshot (e.g., <code>os_debian_8_3</code>). A blueprint is a virtual private server (or <i>instance</i>) image used to create instances quickly.</p>"]
    #[serde(rename="fromBlueprintId")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_blueprint_id: Option<String>,
    #[doc="<p>The bundle ID from which you created the snapshot (e.g., <code>micro_1_0</code>).</p>"]
    #[serde(rename="fromBundleId")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_bundle_id: Option<String>,
    #[doc="<p>The Amazon Resource Name (ARN) of the instance from which the snapshot was created (e.g., <code>arn:aws:lightsail:us-east-1:123456789101:Instance/64b8404c-ccb1-430b-8daf-12345EXAMPLE</code>).</p>"]
    #[serde(rename="fromInstanceArn")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_instance_arn: Option<String>,
    #[doc="<p>The instance from which the snapshot was created.</p>"]
    #[serde(rename="fromInstanceName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub from_instance_name: Option<String>,
    #[doc="<p>The region name and availability zone where you created the snapshot.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>The name of the snapshot.</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The progress of the snapshot.</p>"]
    #[serde(rename="progress")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub progress: Option<String>,
    #[doc="<p>The type of resource (usually <code>InstanceSnapshot</code>).</p>"]
    #[serde(rename="resourceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resource_type: Option<String>,
    #[doc="<p>The size in GB of the SSD.</p>"]
    #[serde(rename="sizeInGb")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub size_in_gb: Option<i64>,
    #[doc="<p>The state the snapshot is in.</p>"]
    #[serde(rename="state")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub state: Option<String>,
    #[doc="<p>The support code. Include this code in your email to support when you have questions about an instance or another resource in Lightsail. This code enables our support team to look up your Lightsail information more easily.</p>"]
...
pub struct InstanceState {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub code: Option<i64>,
    #[doc="<p>The state of the instance (e.g., <code>running</code> or <code>pending</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
}
...
pub struct KeyPair {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub arn: Option<String>,
    #[doc="<p>The timestamp when the key pair was created (e.g., <code>1479816991.349</code>).</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>The RSA fingerprint of the key pair.</p>"]
    #[serde(rename="fingerprint")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub fingerprint: Option<String>,
    #[doc="<p>The region name and Availability Zone where the key pair was created.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>The friendly name of the SSH key pair.</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The resource type (usually <code>KeyPair</code>).</p>"]
    #[serde(rename="resourceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resource_type: Option<String>,
    #[doc="<p>The support code. Include this code in your email to support when you have questions about an instance or another resource in Lightsail. This code enables our support team to look up your Lightsail information more easily.</p>"]
...
pub struct MetricDatapoint {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub sum: Option<f64>,
    #[doc="<p>The timestamp (e.g., <code>1479816991.349</code>).</p>"]
...
pub struct OpenInstancePublicPortsRequest {
    ...
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>An array of key-value pairs containing information about the port mappings.</p>"]
    #[serde(rename="portInfo")]
    pub port_info: PortInfo,
}
...
pub struct Operation {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub id: Option<String>,
    #[doc="<p>A Boolean value indicating whether the operation is terminal.</p>"]
    #[serde(rename="isTerminal")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_terminal: Option<bool>,
    #[doc="<p>The region and Availability Zone.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>Details about the operation (e.g., <code>Debian-1GB-Virginia-1</code>).</p>"]
    #[serde(rename="operationDetails")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub operation_details: Option<String>,
    #[doc="<p>The type of operation. </p>"]
    #[serde(rename="operationType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub operation_type: Option<String>,
    #[doc="<p>The resource name.</p>"]
    #[serde(rename="resourceName")]
    #[serde(skip_serializing_if="Option::is_none")]
    ...
    #[doc="<p>The timestamp when the status was changed (e.g., <code>1479816991.349</code>).</p>"]
...
pub struct PutInstancePublicPortsRequest {
    ...
    #[serde(rename="instanceName")]
    pub instance_name: String,
    #[doc="<p>Specifies information about the public port(s).</p>"]
...
pub struct Region {
    ...
    #[doc="<p>The continent code (e.g., <code>NA</code>, meaning North America).</p>"]
    #[serde(rename="continentCode")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub continent_code: Option<String>,
    #[doc="<p>The description of the AWS Region (e.g., <code>This region is recommended to serve users in the eastern United States and eastern Canada</code>).</p>"]
    #[serde(rename="description")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub description: Option<String>,
    #[doc="<p>The display name (e.g., <code>Virginia</code>).</p>"]
    #[serde(rename="displayName")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub display_name: Option<String>,
    #[doc="<p>The region name (e.g., <code>us-east-1</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
}
...
pub struct StaticIp {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub arn: Option<String>,
    #[doc="<p>The instance where the static IP is attached (e.g., <code>Amazon_Linux-1GB-Virginia-1</code>).</p>"]
    #[serde(rename="attachedTo")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attached_to: Option<String>,
    #[doc="<p>The timestamp when the static IP was created (e.g., <code>1479735304.222</code>).</p>"]
    #[serde(rename="createdAt")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub created_at: Option<f64>,
    #[doc="<p>The static IP address.</p>"]
    #[serde(rename="ipAddress")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub ip_address: Option<String>,
    #[doc="<p>A Boolean value indicating whether the static IP is attached.</p>"]
    #[serde(rename="isAttached")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub is_attached: Option<bool>,
    #[doc="<p>The region and Availability Zone where the static IP was created.</p>"]
    #[serde(rename="location")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub location: Option<ResourceLocation>,
    #[doc="<p>The name of the static IP (e.g., <code>StaticIP-Virginia-EXAMPLE</code>).</p>"]
    #[serde(rename="name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The resource type (usually <code>StaticIp</code>).</p>"]
    #[serde(rename="resourceType")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resource_type: Option<String>,
    #[doc="<p>The support code. Include this code in your email to support when you have questions about an instance or another resource in Lightsail. This code enables our support team to look up your Lightsail information more easily.</p>"]
...
pub struct UpdateDomainEntryRequest {
    ...
    #[serde(rename="domainEntry")]
    pub domain_entry: DomainEntry,
    #[doc="<p>The name of the domain recordset to update.</p>"]
    #[serde(rename="domainName")]
    pub domain_name: String,
}
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => CloseInstancePublicPortsError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => CreateInstanceSnapshotError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => CreateInstancesFromSnapshotError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
                    ...
                    "OperationFailureException" => CreateInstancesFromSnapshotError::OperationFailure(String::from(error_message)),
                    "ServiceException" => {
                        CreateInstancesFromSnapshotError::Service(String::from(error_message))
                    }
                    "UnauthenticatedException" => CreateInstancesFromSnapshotError::Unauthenticated(String::from(error_message)),
                    "ValidationException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => DeleteInstanceSnapshotError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => DownloadDefaultKeyPairError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetInstanceAccessDetailsError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetInstanceMetricDataError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetInstancePortStatesError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetInstanceSnapshotError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetInstanceSnapshotsError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => GetOperationsForResourceError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => OpenInstancePublicPortsError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
        ...
        match from_str::<SerdeJsonValue>(body) {
            Ok(json) => {
                ...
                match *error_type {
                    ...
                    "AccountSetupInProgressException" => PutInstancePublicPortsError::AccountSetupInProgress(String::from(error_message)),
                    "InvalidInputException" => {
