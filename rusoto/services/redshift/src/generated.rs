            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "AccountWithRestoreAccess" {
                        obj.push(try!(AccountWithRestoreAccessDeserializer::deserialize("AccountWithRestoreAccess", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        "ClusterSecurityGroup" => {
                            obj.cluster_security_group =
                                Some(try!(ClusterSecurityGroupDeserializer::deserialize("ClusterSecurityGroup",
                                                                                        stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AllowVersionUpgrade" => {
                            obj.allow_version_upgrade =
                                Some(try!(BooleanDeserializer::deserialize("AllowVersionUpgrade",
                                                                           stack)));
                        }
                        "AutomatedSnapshotRetentionPeriod" => {
                            obj.automated_snapshot_retention_period =
                                Some(try!(IntegerDeserializer::deserialize("AutomatedSnapshotRetentionPeriod",
                                                                           stack)));
                        }
                        "AvailabilityZone" => {
                        ...
                        "ClusterIdentifier" => {
                            obj.cluster_identifier =
                                Some(try!(StringDeserializer::deserialize("ClusterIdentifier",
                                                                          stack)));
                        }
                        "ClusterNodes" => {
                            obj.cluster_nodes =
                                Some(try!(ClusterNodesListDeserializer::deserialize("ClusterNodes",
                                                                                    stack)));
                        }
                        "ClusterParameterGroups" => {
                            obj.cluster_parameter_groups = Some(try!(ClusterParameterGroupStatusListDeserializer::deserialize("ClusterParameterGroups", stack)));
                        }
                        "ClusterPublicKey" => {
                            obj.cluster_public_key =
                                Some(try!(StringDeserializer::deserialize("ClusterPublicKey",
                                                                          stack)));
                        }
                        "ClusterRevisionNumber" => {
                            obj.cluster_revision_number =
                                Some(try!(StringDeserializer::deserialize("ClusterRevisionNumber",
                                                                          stack)));
                        }
                        "ClusterSecurityGroups" => {
                            obj.cluster_security_groups = Some(try!(ClusterSecurityGroupMembershipListDeserializer::deserialize("ClusterSecurityGroups", stack)));
                        }
                        "ClusterSnapshotCopyStatus" => {
                            obj.cluster_snapshot_copy_status = Some(try!(ClusterSnapshotCopyStatusDeserializer::deserialize("ClusterSnapshotCopyStatus", stack)));
                        }
                        "ClusterStatus" => {
                            obj.cluster_status = Some(try!(StringDeserializer::deserialize("ClusterStatus",
                                                                                           stack)));
                        }
                        "ClusterSubnetGroupName" => {
                            obj.cluster_subnet_group_name =
                                Some(try!(StringDeserializer::deserialize("ClusterSubnetGroupName",
                                                                          stack)));
                        }
                        "ClusterVersion" => {
                            obj.cluster_version =
                                Some(try!(StringDeserializer::deserialize("ClusterVersion",
                                                                          stack)));
                        }
                        "DBName" => {
                        ...
                        "ElasticIpStatus" => {
                            obj.elastic_ip_status =
                                Some(try!(ElasticIpStatusDeserializer::deserialize("ElasticIpStatus",
                                                                                   stack)));
                        }
                        "Encrypted" => {
                        ...
                        "EnhancedVpcRouting" => {
                            obj.enhanced_vpc_routing =
                                Some(try!(BooleanDeserializer::deserialize("EnhancedVpcRouting",
                                                                           stack)));
                        }
                        "HsmStatus" => {
                            obj.hsm_status = Some(try!(HsmStatusDeserializer::deserialize("HsmStatus",
                                                                                          stack)));
                        }
                        "IamRoles" => {
                            obj.iam_roles =
                                Some(try!(ClusterIamRoleListDeserializer::deserialize("IamRoles",
                                                                                      stack)));
                        }
                        "KmsKeyId" => {
                        ...
                        "ModifyStatus" => {
                            obj.modify_status = Some(try!(StringDeserializer::deserialize("ModifyStatus",
                                                                                          stack)));
                        }
                        "NodeType" => {
                            obj.node_type = Some(try!(StringDeserializer::deserialize("NodeType",
                                                                                      stack)));
                        }
                        "NumberOfNodes" => {
                            obj.number_of_nodes =
                                Some(try!(IntegerDeserializer::deserialize("NumberOfNodes",
                                                                           stack)));
                        }
                        ...
                        "RestoreStatus" => {
                            obj.restore_status =
                                Some(try!(RestoreStatusDeserializer::deserialize("RestoreStatus",
                                                                                 stack)));
                        }
                        "Tags" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ApplyStatus" => {
                            obj.apply_status = Some(try!(StringDeserializer::deserialize("ApplyStatus",
                                                                                         stack)));
                        }
                        "IamRoleArn" => {
                            obj.iam_role_arn = Some(try!(StringDeserializer::deserialize("IamRoleArn",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterIamRole" {
                        obj.push(try!(ClusterIamRoleDeserializer::deserialize("ClusterIamRole",
                                                                              stack)));
                    } else {
                        skip_tree(stack);
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "NodeRole" => {
                            obj.node_role = Some(try!(StringDeserializer::deserialize("NodeRole",
                                                                                      stack)));
                        }
                        "PrivateIPAddress" => {
                        ...
                        "PublicIPAddress" => {
                            obj.public_ip_address =
                                Some(try!(StringDeserializer::deserialize("PublicIPAddress",
                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "ParameterGroupFamily" => {
                            obj.parameter_group_family =
                                Some(try!(StringDeserializer::deserialize("ParameterGroupFamily",
                                                                          stack)));
                        }
                        "ParameterGroupName" => {
                            obj.parameter_group_name =
                                Some(try!(StringDeserializer::deserialize("ParameterGroupName",
                                                                          stack)));
                        }
                        "Tags" => {
                            obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterParameterStatusList" => {
                            obj.cluster_parameter_status_list = Some(try!(ClusterParameterStatusListDeserializer::deserialize("ClusterParameterStatusList", stack)));
                        }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterParameterGroup" {
                        obj.push(try!(ClusterParameterGroupStatusDeserializer::deserialize("ClusterParameterGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ParameterGroups" => {
                            obj.parameter_groups =
                                Some(try!(ParameterGroupListDeserializer::deserialize("ParameterGroups",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "ParameterApplyErrorDescription" => {
                            obj.parameter_apply_error_description =
                                Some(try!(StringDeserializer::deserialize("ParameterApplyErrorDescription",
                                                                          stack)));
                        }
                        "ParameterApplyStatus" => {
                            obj.parameter_apply_status =
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ClusterParameterStatusDeserializer::deserialize("member",
                                                                                      stack)));
                    } else {
                        skip_tree(stack);
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterSecurityGroupName" => {
                            obj.cluster_security_group_name =
                                Some(try!(StringDeserializer::deserialize("ClusterSecurityGroupName",
                                                                          stack)));
                        }
                        "Description" => {
                            obj.description = Some(try!(StringDeserializer::deserialize("Description",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterSecurityGroup" {
                        obj.push(try!(ClusterSecurityGroupMembershipDeserializer::deserialize("ClusterSecurityGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        "ClusterSecurityGroups" => {
                            obj.cluster_security_groups =
                                Some(try!(ClusterSecurityGroupsDeserializer::deserialize("ClusterSecurityGroups",
                                                                                         stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterSecurityGroup" {
                        obj.push(try!(ClusterSecurityGroupDeserializer::deserialize("ClusterSecurityGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        "DestinationRegion" => {
                            obj.destination_region =
                                Some(try!(StringDeserializer::deserialize("DestinationRegion",
                                                                          stack)));
                        }
                        "RetentionPeriod" => {
                            obj.retention_period = Some(try!(LongDeserializer::deserialize("RetentionPeriod",
                                                                                           stack)));
                        }
                        "SnapshotCopyGrantName" => {
                            obj.snapshot_copy_grant_name =
                                Some(try!(StringDeserializer::deserialize("SnapshotCopyGrantName",
                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "ClusterSubnetGroups" => {
                            obj.cluster_subnet_groups =
                                Some(try!(ClusterSubnetGroupsDeserializer::deserialize("ClusterSubnetGroups",
                                                                                       stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterSubnetGroup" {
                        obj.push(try!(ClusterSubnetGroupDeserializer::deserialize("ClusterSubnetGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterParameterGroupFamily" => {
                            obj.cluster_parameter_group_family =
                                Some(try!(StringDeserializer::deserialize("ClusterParameterGroupFamily",
                                                                          stack)));
                        }
                        "ClusterVersion" => {
                            obj.cluster_version =
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterVersion" {
                        obj.push(try!(ClusterVersionDeserializer::deserialize("ClusterVersion",
                                                                              stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "ClusterVersions" => {
                            obj.cluster_versions =
                                Some(try!(ClusterVersionListDeserializer::deserialize("ClusterVersions",
                                                                                      stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Clusters" => {
                            obj.clusters = Some(try!(ClusterListDeserializer::deserialize("Clusters",
                                                                                          stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
                    ...
                    match &name[..] {
                        "ClusterParameterGroup" => {
                            obj.cluster_parameter_group =
                                Some(try!(ClusterParameterGroupDeserializer::deserialize("ClusterParameterGroup",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Cluster" => {
                            obj.cluster = Some(try!(ClusterDeserializer::deserialize("Cluster",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "ClusterSubnetGroup" => {
                            obj.cluster_subnet_group =
                                Some(try!(ClusterSubnetGroupDeserializer::deserialize("ClusterSubnetGroup",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "HsmClientCertificate" => {
                            obj.hsm_client_certificate =
                                Some(try!(HsmClientCertificateDeserializer::deserialize("HsmClientCertificate",
                                                                                        stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HsmConfiguration" => {
                            obj.hsm_configuration =
                                Some(try!(HsmConfigurationDeserializer::deserialize("HsmConfiguration",
                                                                                    stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "SnapshotCopyGrant" => {
                            obj.snapshot_copy_grant =
                                Some(try!(SnapshotCopyGrantDeserializer::deserialize("SnapshotCopyGrant",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl DescribeClusterParameterGroupsMessageSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeClusterParameterGroupsMessage) {
        ...
        if let Some(ref field_value) = obj.tag_values {
            TagValueListSerializer::serialize(params,
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DefaultClusterParameters" => {
                            obj.default_cluster_parameters = Some(try!(DefaultClusterParametersDeserializer::deserialize("DefaultClusterParameters", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ElasticIp" => {
                            obj.elastic_ip = Some(try!(StringDeserializer::deserialize("ElasticIp",
                                                                                       stack)));
                        }
                        "Status" => {
                            obj.status = Some(try!(StringDeserializer::deserialize("Status",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Severity" => {
                            obj.severity = Some(try!(StringDeserializer::deserialize("Severity",
                                                                                     stack)));
                        }
                        "SourceIdentifier" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Events" => {
                            obj.events =
                                Some(try!(EventInfoMapListDeserializer::deserialize("Events",
                                                                                    stack)));
                        }
                        "SourceType" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "EventInfoMap" {
                        obj.push(try!(EventInfoMapDeserializer::deserialize("EventInfoMap",
                                                                            stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        ...
                        "SubscriptionCreationTime" => {
                            obj.subscription_creation_time =
                                Some(try!(TStampDeserializer::deserialize("SubscriptionCreationTime",
                                                                          stack)));
                        }
                        "Tags" => {
                            obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HsmClientCertificateIdentifier" => {
                            obj.hsm_client_certificate_identifier =
                                Some(try!(StringDeserializer::deserialize("HsmClientCertificateIdentifier",
                                                                          stack)));
                        }
                        "HsmClientCertificatePublicKey" => {
                            obj.hsm_client_certificate_public_key =
                                Some(try!(StringDeserializer::deserialize("HsmClientCertificatePublicKey",
                                                                          stack)));
                        }
                        "Tags" => {
                            obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "HsmClientCertificate" {
                        obj.push(try!(HsmClientCertificateDeserializer::deserialize("HsmClientCertificate", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HsmClientCertificates" => {
                            obj.hsm_client_certificates = Some(try!(HsmClientCertificateListDeserializer::deserialize("HsmClientCertificates", stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
                                                                                   stack)));
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "HsmConfigurationIdentifier" => {
                            obj.hsm_configuration_identifier =
                                Some(try!(StringDeserializer::deserialize("HsmConfigurationIdentifier",
                                                                          stack)));
                        }
                        "HsmIpAddress" => {
                            obj.hsm_ip_address = Some(try!(StringDeserializer::deserialize("HsmIpAddress",
                                                                                           stack)));
                        }
                        "HsmPartitionName" => {
                            obj.hsm_partition_name =
                                Some(try!(StringDeserializer::deserialize("HsmPartitionName",
                                                                          stack)));
                        }
                        "Tags" => {
                            obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "HsmConfiguration" {
                        obj.push(try!(HsmConfigurationDeserializer::deserialize("HsmConfiguration",
                                                                                stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "HsmConfigurations" => {
                            obj.hsm_configurations =
                                Some(try!(HsmConfigurationListDeserializer::deserialize("HsmConfigurations",
                                                                                        stack)));
                        }
                        "Marker" => {
                            obj.marker = Some(try!(StringDeserializer::deserialize("Marker",
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "BucketName" => {
                            obj.bucket_name = Some(try!(StringDeserializer::deserialize("BucketName",
                                                                                        stack)));
                        }
                        "LastFailureMessage" => {
                            obj.last_failure_message =
                                Some(try!(StringDeserializer::deserialize("LastFailureMessage",
                                                                          stack)));
                        }
                        "LastFailureTime" => {
                            obj.last_failure_time =
                                Some(try!(TStampDeserializer::deserialize("LastFailureTime",
                                                                          stack)));
                        }
                        "LastSuccessfulDeliveryTime" => {
                            obj.last_successful_delivery_time =
                                Some(try!(TStampDeserializer::deserialize("LastSuccessfulDeliveryTime",
                                                                          stack)));
                        }
                        "LoggingEnabled" => {
                            obj.logging_enabled =
                                Some(try!(BooleanDeserializer::deserialize("LoggingEnabled",
                                                                           stack)));
                        }
                        "S3KeyPrefix" => {
                            obj.s3_key_prefix = Some(try!(StringDeserializer::deserialize("S3KeyPrefix",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ClusterType" => {
                            obj.cluster_type = Some(try!(StringDeserializer::deserialize("ClusterType",
                                                                                         stack)));
                        }
                        "ClusterVersion" => {
                            obj.cluster_version =
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "OrderableClusterOption" {
                        obj.push(try!(OrderableClusterOptionDeserializer::deserialize("OrderableClusterOption", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "OrderableClusterOptions" => {
                            obj.orderable_cluster_options = Some(try!(OrderableClusterOptionsListDeserializer::deserialize("OrderableClusterOptions", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ApplyType" => {
                            obj.apply_type =
                                Some(try!(ParameterApplyTypeDeserializer::deserialize("ApplyType",
                                                                                      stack)));
                        }
                        "DataType" => {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterParameterGroup" {
                        obj.push(try!(ClusterParameterGroupDeserializer::deserialize("ClusterParameterGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutomatedSnapshotRetentionPeriod" => {
                            obj.automated_snapshot_retention_period =
                                Some(try!(IntegerOptionalDeserializer::deserialize("AutomatedSnapshotRetentionPeriod",
                                                                                   stack)));
                        }
                        "ClusterIdentifier" => {
                            obj.cluster_identifier =
                        ...
                        "EnhancedVpcRouting" => {
                            obj.enhanced_vpc_routing =
                                Some(try!(BooleanOptionalDeserializer::deserialize("EnhancedVpcRouting",
                                                                                   stack)));
                        }
                        "MasterUserPassword" => {
                            obj.master_user_password =
                        ...
                        "NumberOfNodes" => {
                            obj.number_of_nodes =
                                Some(try!(IntegerOptionalDeserializer::deserialize("NumberOfNodes",
                                                                                   stack)));
                        }
                        "PubliclyAccessible" => {
                            obj.publicly_accessible =
                                Some(try!(BooleanOptionalDeserializer::deserialize("PubliclyAccessible",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ReservedNode" => {
                            obj.reserved_node =
                                Some(try!(ReservedNodeDeserializer::deserialize("ReservedNode",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "NodeCount" => {
                            obj.node_count = Some(try!(IntegerDeserializer::deserialize("NodeCount",
                                                                                        stack)));
                        }
                        "NodeType" => {
                            obj.node_type = Some(try!(StringDeserializer::deserialize("NodeType",
                        ...
                        "ReservedNodeId" => {
                            obj.reserved_node_id =
                                Some(try!(StringDeserializer::deserialize("ReservedNodeId",
                                                                          stack)));
                        }
                        "ReservedNodeOfferingId" => {
                            obj.reserved_node_offering_id =
                                Some(try!(StringDeserializer::deserialize("ReservedNodeOfferingId",
                                                                          stack)));
                        }
                        "StartTime" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ReservedNode" {
                        obj.push(try!(ReservedNodeDeserializer::deserialize("ReservedNode",
                                                                            stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ReservedNodeOffering" {
                        obj.push(try!(ReservedNodeOfferingDeserializer::deserialize("ReservedNodeOffering", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ReservedNodeOfferings" => {
                            obj.reserved_node_offerings = Some(try!(ReservedNodeOfferingListDeserializer::deserialize("ReservedNodeOfferings", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ReservedNodes" => {
                            obj.reserved_nodes =
                                Some(try!(ReservedNodeListDeserializer::deserialize("ReservedNodes",
                                                                                    stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "AvgResizeRateInMegaBytesPerSecond" => {
                            obj.avg_resize_rate_in_mega_bytes_per_second =
                                Some(try!(DoubleOptionalDeserializer::deserialize("AvgResizeRateInMegaBytesPerSecond",
                                                                                  stack)));
                        }
                        "ElapsedTimeInSeconds" => {
                            obj.elapsed_time_in_seconds =
                                Some(try!(LongOptionalDeserializer::deserialize("ElapsedTimeInSeconds",
                                                                                stack)));
                        }
                        "EstimatedTimeToCompletionInSeconds" => {
                            obj.estimated_time_to_completion_in_seconds =
                                Some(try!(LongOptionalDeserializer::deserialize("EstimatedTimeToCompletionInSeconds",
                                                                                stack)));
                        }
                        "ImportTablesCompleted" => {
                            obj.import_tables_completed =
                                Some(try!(ImportTablesCompletedDeserializer::deserialize("ImportTablesCompleted",
                                                                                         stack)));
                        }
                        "ImportTablesInProgress" => {
                            obj.import_tables_in_progress =
                                Some(try!(ImportTablesInProgressDeserializer::deserialize("ImportTablesInProgress",
                                                                                          stack)));
                        }
                        "ImportTablesNotStarted" => {
                            obj.import_tables_not_started =
                                Some(try!(ImportTablesNotStartedDeserializer::deserialize("ImportTablesNotStarted",
                                                                                          stack)));
                        }
                        "ProgressInMegaBytes" => {
                            obj.progress_in_mega_bytes =
                                Some(try!(LongOptionalDeserializer::deserialize("ProgressInMegaBytes",
                                                                                stack)));
                        }
                        "Status" => {
                            obj.status = Some(try!(StringDeserializer::deserialize("Status",
                        ...
                        "TargetClusterType" => {
                            obj.target_cluster_type =
                                Some(try!(StringDeserializer::deserialize("TargetClusterType",
                                                                          stack)));
                        }
                        "TargetNodeType" => {
                            obj.target_node_type =
                                Some(try!(StringDeserializer::deserialize("TargetNodeType",
                                                                          stack)));
                        }
                        "TargetNumberOfNodes" => {
                            obj.target_number_of_nodes =
                                Some(try!(IntegerOptionalDeserializer::deserialize("TargetNumberOfNodes",
                                                                                   stack)));
                        }
                        "TotalResizeDataInMegaBytes" => {
                            obj.total_resize_data_in_mega_bytes =
                                Some(try!(LongOptionalDeserializer::deserialize("TotalResizeDataInMegaBytes",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "CurrentRestoreRateInMegaBytesPerSecond" => {
                            obj.current_restore_rate_in_mega_bytes_per_second =
                                Some(try!(DoubleDeserializer::deserialize("CurrentRestoreRateInMegaBytesPerSecond",
                                                                          stack)));
                        }
                        "ElapsedTimeInSeconds" => {
                            obj.elapsed_time_in_seconds =
                                Some(try!(LongDeserializer::deserialize("ElapsedTimeInSeconds",
                                                                        stack)));
                        }
                        "EstimatedTimeToCompletionInSeconds" => {
                            obj.estimated_time_to_completion_in_seconds =
                                Some(try!(LongDeserializer::deserialize("EstimatedTimeToCompletionInSeconds",
                                                                        stack)));
                        }
                        "ProgressInMegaBytes" => {
                            obj.progress_in_mega_bytes =
                                Some(try!(LongDeserializer::deserialize("ProgressInMegaBytes",
                                                                        stack)));
                        }
                        "SnapshotSizeInMegaBytes" => {
                            obj.snapshot_size_in_mega_bytes =
                                Some(try!(LongDeserializer::deserialize("SnapshotSizeInMegaBytes",
                                                                        stack)));
                        }
                        "Status" => {
                            obj.status = Some(try!(StringDeserializer::deserialize("Status",
                    ...
                    match &name[..] {
                        "TableRestoreStatus" => {
                            obj.table_restore_status =
                                Some(try!(TableRestoreStatusDeserializer::deserialize("TableRestoreStatus",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccountsWithRestoreAccess" => {
                            obj.accounts_with_restore_access = Some(try!(AccountsWithRestoreAccessListDeserializer::deserialize("AccountsWithRestoreAccess", stack)));
                        }
                        "ActualIncrementalBackupSizeInMegaBytes" => {
                            obj.actual_incremental_backup_size_in_mega_bytes =
                                Some(try!(DoubleDeserializer::deserialize("ActualIncrementalBackupSizeInMegaBytes",
                                                                          stack)));
                        }
                        "AvailabilityZone" => {
                            obj.availability_zone =
                        ...
                        "BackupProgressInMegaBytes" => {
                            obj.backup_progress_in_mega_bytes =
                                Some(try!(DoubleDeserializer::deserialize("BackupProgressInMegaBytes",
                                                                          stack)));
                        }
                        "ClusterCreateTime" => {
                            obj.cluster_create_time =
                        ...
                        "CurrentBackupRateInMegaBytesPerSecond" => {
                            obj.current_backup_rate_in_mega_bytes_per_second =
                                Some(try!(DoubleDeserializer::deserialize("CurrentBackupRateInMegaBytesPerSecond",
                                                                          stack)));
                        }
                        "DBName" => {
                            obj.db_name = Some(try!(StringDeserializer::deserialize("DBName",
                        ...
                        "EncryptedWithHSM" => {
                            obj.encrypted_with_hsm =
                                Some(try!(BooleanDeserializer::deserialize("EncryptedWithHSM",
                                                                           stack)));
                        }
                        "EnhancedVpcRouting" => {
                            obj.enhanced_vpc_routing =
                        ...
                        "EstimatedSecondsToCompletion" => {
                            obj.estimated_seconds_to_completion =
                                Some(try!(LongDeserializer::deserialize("EstimatedSecondsToCompletion",
                                                                        stack)));
                        }
                        "KmsKeyId" => {
                            obj.kms_key_id = Some(try!(StringDeserializer::deserialize("KmsKeyId",
                        ...
                        "OwnerAccount" => {
                            obj.owner_account = Some(try!(StringDeserializer::deserialize("OwnerAccount",
                                                                                          stack)));
                        }
                        "Port" => {
                            obj.port = Some(try!(IntegerDeserializer::deserialize("Port", stack)));
                        ...
                        "RestorableNodeTypes" => {
                            obj.restorable_node_types =
                                Some(try!(RestorableNodeTypeListDeserializer::deserialize("RestorableNodeTypes",
                                                                                          stack)));
                        }
                        "SnapshotCreateTime" => {
                        ...
                        "SnapshotIdentifier" => {
                            obj.snapshot_identifier =
                                Some(try!(StringDeserializer::deserialize("SnapshotIdentifier",
                                                                          stack)));
                        }
                        "SnapshotType" => {
                        ...
                        "TotalBackupSizeInMegaBytes" => {
                            obj.total_backup_size_in_mega_bytes =
                                Some(try!(DoubleDeserializer::deserialize("TotalBackupSizeInMegaBytes",
                                                                          stack)));
                        }
                        "VpcId" => {
                            obj.vpc_id = Some(try!(StringDeserializer::deserialize("VpcId",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "SnapshotCopyGrant" {
                        obj.push(try!(SnapshotCopyGrantDeserializer::deserialize("SnapshotCopyGrant", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        ...
                        "SnapshotCopyGrants" => {
                            obj.snapshot_copy_grants =
                                Some(try!(SnapshotCopyGrantListDeserializer::deserialize("SnapshotCopyGrants",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "NewTableName" => {
                            obj.new_table_name = Some(try!(StringDeserializer::deserialize("NewTableName",
                                                                                           stack)));
                        }
                        "ProgressInMegaBytes" => {
                            obj.progress_in_mega_bytes =
                        ...
                        "RequestTime" => {
                            obj.request_time = Some(try!(TStampDeserializer::deserialize("RequestTime",
                                                                                         stack)));
                        }
                        "SnapshotIdentifier" => {
                            obj.snapshot_identifier =
                        ...
                        "SourceDatabaseName" => {
                            obj.source_database_name =
                                Some(try!(StringDeserializer::deserialize("SourceDatabaseName",
                                                                          stack)));
                        }
                        "SourceSchemaName" => {
                            obj.source_schema_name =
                                Some(try!(StringDeserializer::deserialize("SourceSchemaName",
                                                                          stack)));
                        }
                        "SourceTableName" => {
                            obj.source_table_name =
                                Some(try!(StringDeserializer::deserialize("SourceTableName",
                                                                          stack)));
                        }
                        "Status" => {
                            obj.status =
                                Some(try!(TableRestoreStatusTypeDeserializer::deserialize("Status",
                                                                                          stack)));
                        }
                        "TableRestoreRequestId" => {
                            obj.table_restore_request_id =
                                Some(try!(StringDeserializer::deserialize("TableRestoreRequestId",
                                                                          stack)));
                        }
                        "TargetDatabaseName" => {
                            obj.target_database_name =
                                Some(try!(StringDeserializer::deserialize("TargetDatabaseName",
                                                                          stack)));
                        }
                        "TargetSchemaName" => {
                            obj.target_schema_name =
                                Some(try!(StringDeserializer::deserialize("TargetSchemaName",
                                                                          stack)));
                        }
                        "TotalDataInMegaBytes" => {
                            obj.total_data_in_mega_bytes =
                                Some(try!(LongOptionalDeserializer::deserialize("TotalDataInMegaBytes",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "TableRestoreStatus" {
                        obj.push(try!(TableRestoreStatusDeserializer::deserialize("TableRestoreStatus", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        ...
                        "TableRestoreStatusDetails" => {
                            obj.table_restore_status_details =
                                Some(try!(TableRestoreStatusListDeserializer::deserialize("TableRestoreStatusDetails",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ResourceName" => {
                            obj.resource_name = Some(try!(StringDeserializer::deserialize("ResourceName",
                                                                                          stack)));
                        }
                        "ResourceType" => {
                            obj.resource_type = Some(try!(StringDeserializer::deserialize("ResourceType",
                                                                                          stack)));
                        }
                        "Tag" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "TaggedResource" {
                        obj.push(try!(TaggedResourceDeserializer::deserialize("TaggedResource",
                                                                              stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "TaggedResources" => {
                            obj.tagged_resources =
                                Some(try!(TaggedResourceListDeserializer::deserialize("TaggedResources",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "VpcSecurityGroup" {
                        obj.push(try!(VpcSecurityGroupMembershipDeserializer::deserialize("VpcSecurityGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AuthorizationAlreadyExistsFault" => AuthorizeClusterSecurityGroupIngressError::AuthorizationAlreadyExistsFault(String::from(parsed_error.message)),
                    "AuthorizationQuotaExceededFault" => AuthorizeClusterSecurityGroupIngressError::AuthorizationQuotaExceededFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupNotFoundFault" => AuthorizeClusterSecurityGroupIngressError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterSecurityGroupStateFault" => AuthorizeClusterSecurityGroupIngressError::InvalidClusterSecurityGroupStateFault(String::from(parsed_error.message)),
...
impl AuthorizeSnapshotAccessError {
    pub fn from_body(body: &str) -> AuthorizeSnapshotAccessError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AuthorizationAlreadyExistsFault" => AuthorizeSnapshotAccessError::AuthorizationAlreadyExistsFault(String::from(parsed_error.message)),
                    "AuthorizationQuotaExceededFault" => AuthorizeSnapshotAccessError::AuthorizationQuotaExceededFault(String::from(parsed_error.message)),
                    "ClusterSnapshotNotFoundFault" => AuthorizeSnapshotAccessError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => AuthorizeSnapshotAccessError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "InvalidClusterSnapshotStateFault" => AuthorizeSnapshotAccessError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => AuthorizeSnapshotAccessError::LimitExceededFault(String::from(parsed_error.message)),
...
impl CopyClusterSnapshotError {
    pub fn from_body(body: &str) -> CopyClusterSnapshotError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSnapshotAlreadyExistsFault" => CopyClusterSnapshotError::ClusterSnapshotAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterSnapshotNotFoundFault" => CopyClusterSnapshotError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSnapshotQuotaExceededFault" => CopyClusterSnapshotError::ClusterSnapshotQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidClusterSnapshotStateFault" => CopyClusterSnapshotError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),
...
impl CreateClusterError {
    pub fn from_body(body: &str) -> CreateClusterError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterAlreadyExistsFault" => CreateClusterError::ClusterAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterParameterGroupNotFoundFault" => CreateClusterError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterQuotaExceededFault" => CreateClusterError::ClusterQuotaExceededFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupNotFoundFault" => CreateClusterError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSubnetGroupNotFoundFault" => CreateClusterError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => CreateClusterError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "HsmClientCertificateNotFoundFault" => CreateClusterError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),
                    "HsmConfigurationNotFoundFault" => CreateClusterError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),
                    "InsufficientClusterCapacityFault" => CreateClusterError::InsufficientClusterCapacityFault(String::from(parsed_error.message)),
                    "InvalidClusterSubnetGroupStateFault" => CreateClusterError::InvalidClusterSubnetGroupStateFault(String::from(parsed_error.message)),
                    "InvalidElasticIpFault" => CreateClusterError::InvalidElasticIpFault(String::from(parsed_error.message)),
                    "InvalidSubnet" => {
                    ...
                    "InvalidVPCNetworkStateFault" => CreateClusterError::InvalidVPCNetworkStateFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => {
                        CreateClusterError::LimitExceededFault(String::from(parsed_error.message))
                    }
                    "NumberOfNodesPerClusterLimitExceededFault" => CreateClusterError::NumberOfNodesPerClusterLimitExceededFault(String::from(parsed_error.message)),
                    "NumberOfNodesQuotaExceededFault" => CreateClusterError::NumberOfNodesQuotaExceededFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateClusterError::TagLimitExceededFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => CreateClusterError::UnauthorizedOperation(String::from(parsed_error.message)),
...
impl CreateClusterParameterGroupError {
    pub fn from_body(body: &str) -> CreateClusterParameterGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupAlreadyExistsFault" => CreateClusterParameterGroupError::ClusterParameterGroupAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterParameterGroupQuotaExceededFault" => CreateClusterParameterGroupError::ClusterParameterGroupQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateClusterParameterGroupError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateClusterParameterGroupError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateClusterSecurityGroupError {
    pub fn from_body(body: &str) -> CreateClusterSecurityGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSecurityGroupAlreadyExistsFault" => CreateClusterSecurityGroupError::ClusterSecurityGroupAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupQuotaExceededFault" => CreateClusterSecurityGroupError::ClusterSecurityGroupQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateClusterSecurityGroupError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateClusterSecurityGroupError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateClusterSnapshotError {
    pub fn from_body(body: &str) -> CreateClusterSnapshotError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => CreateClusterSnapshotError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSnapshotAlreadyExistsFault" => CreateClusterSnapshotError::ClusterSnapshotAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterSnapshotQuotaExceededFault" => CreateClusterSnapshotError::ClusterSnapshotQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => CreateClusterSnapshotError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateClusterSnapshotError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateClusterSnapshotError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateClusterSubnetGroupError {
    pub fn from_body(body: &str) -> CreateClusterSubnetGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSubnetGroupAlreadyExistsFault" => CreateClusterSubnetGroupError::ClusterSubnetGroupAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterSubnetGroupQuotaExceededFault" => CreateClusterSubnetGroupError::ClusterSubnetGroupQuotaExceededFault(String::from(parsed_error.message)),
                    "ClusterSubnetQuotaExceededFault" => CreateClusterSubnetGroupError::ClusterSubnetQuotaExceededFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => CreateClusterSubnetGroupError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "InvalidSubnet" => CreateClusterSubnetGroupError::InvalidSubnet(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateClusterSubnetGroupError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateClusterSubnetGroupError::TagLimitExceededFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => CreateClusterSubnetGroupError::UnauthorizedOperation(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "InvalidTagFault" => CreateEventSubscriptionError::InvalidTagFault(String::from(parsed_error.message)),
                    ...
                    "SubscriptionEventIdNotFoundFault" => CreateEventSubscriptionError::SubscriptionEventIdNotFoundFault(String::from(parsed_error.message)),
                    "SubscriptionSeverityNotFoundFault" => CreateEventSubscriptionError::SubscriptionSeverityNotFoundFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateEventSubscriptionError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateHsmClientCertificateError {
    pub fn from_body(body: &str) -> CreateHsmClientCertificateError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmClientCertificateAlreadyExistsFault" => CreateHsmClientCertificateError::HsmClientCertificateAlreadyExistsFault(String::from(parsed_error.message)),
                    "HsmClientCertificateQuotaExceededFault" => CreateHsmClientCertificateError::HsmClientCertificateQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateHsmClientCertificateError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateHsmClientCertificateError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateHsmConfigurationError {
    pub fn from_body(body: &str) -> CreateHsmConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmConfigurationAlreadyExistsFault" => CreateHsmConfigurationError::HsmConfigurationAlreadyExistsFault(String::from(parsed_error.message)),
                    "HsmConfigurationQuotaExceededFault" => CreateHsmConfigurationError::HsmConfigurationQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateHsmConfigurationError::InvalidTagFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateHsmConfigurationError::TagLimitExceededFault(String::from(parsed_error.message)),
...
impl CreateSnapshotCopyGrantError {
    pub fn from_body(body: &str) -> CreateSnapshotCopyGrantError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "DependentServiceRequestThrottlingFault" => CreateSnapshotCopyGrantError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => CreateSnapshotCopyGrantError::InvalidTagFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => CreateSnapshotCopyGrantError::LimitExceededFault(String::from(parsed_error.message)),
                    "SnapshotCopyGrantAlreadyExistsFault" => CreateSnapshotCopyGrantError::SnapshotCopyGrantAlreadyExistsFault(String::from(parsed_error.message)),
                    "SnapshotCopyGrantQuotaExceededFault" => CreateSnapshotCopyGrantError::SnapshotCopyGrantQuotaExceededFault(String::from(parsed_error.message)),
                    "TagLimitExceededFault" => CreateSnapshotCopyGrantError::TagLimitExceededFault(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "ClusterSnapshotAlreadyExistsFault" => DeleteClusterError::ClusterSnapshotAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterSnapshotQuotaExceededFault" => DeleteClusterError::ClusterSnapshotQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => DeleteClusterError::InvalidClusterStateFault(String::from(parsed_error.message)),
...
impl DeleteClusterParameterGroupError {
    pub fn from_body(body: &str) -> DeleteClusterParameterGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupNotFoundFault" => DeleteClusterParameterGroupError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterParameterGroupStateFault" => DeleteClusterParameterGroupError::InvalidClusterParameterGroupStateFault(String::from(parsed_error.message)),
...
impl DeleteClusterSecurityGroupError {
    pub fn from_body(body: &str) -> DeleteClusterSecurityGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSecurityGroupNotFoundFault" => DeleteClusterSecurityGroupError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterSecurityGroupStateFault" => DeleteClusterSecurityGroupError::InvalidClusterSecurityGroupStateFault(String::from(parsed_error.message)),
...
impl DeleteClusterSnapshotError {
    pub fn from_body(body: &str) -> DeleteClusterSnapshotError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSnapshotNotFoundFault" => DeleteClusterSnapshotError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterSnapshotStateFault" => DeleteClusterSnapshotError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),
...
impl DeleteClusterSubnetGroupError {
    pub fn from_body(body: &str) -> DeleteClusterSubnetGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSubnetGroupNotFoundFault" => DeleteClusterSubnetGroupError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterSubnetGroupStateFault" => DeleteClusterSubnetGroupError::InvalidClusterSubnetGroupStateFault(String::from(parsed_error.message)),
                    "InvalidClusterSubnetStateFault" => DeleteClusterSubnetGroupError::InvalidClusterSubnetStateFault(String::from(parsed_error.message)),
...
impl DeleteEventSubscriptionError {
    pub fn from_body(body: &str) -> DeleteEventSubscriptionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidSubscriptionStateFault" => DeleteEventSubscriptionError::InvalidSubscriptionStateFault(String::from(parsed_error.message)),
...
impl DeleteHsmClientCertificateError {
    pub fn from_body(body: &str) -> DeleteHsmClientCertificateError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmClientCertificateNotFoundFault" => DeleteHsmClientCertificateError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),
                    "InvalidHsmClientCertificateStateFault" => DeleteHsmClientCertificateError::InvalidHsmClientCertificateStateFault(String::from(parsed_error.message)),
...
impl DeleteHsmConfigurationError {
    pub fn from_body(body: &str) -> DeleteHsmConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmConfigurationNotFoundFault" => DeleteHsmConfigurationError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),
                    "InvalidHsmConfigurationStateFault" => DeleteHsmConfigurationError::InvalidHsmConfigurationStateFault(String::from(parsed_error.message)),
...
impl DeleteSnapshotCopyGrantError {
    pub fn from_body(body: &str) -> DeleteSnapshotCopyGrantError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidSnapshotCopyGrantStateFault" => DeleteSnapshotCopyGrantError::InvalidSnapshotCopyGrantStateFault(String::from(parsed_error.message)),
                    "SnapshotCopyGrantNotFoundFault" => DeleteSnapshotCopyGrantError::SnapshotCopyGrantNotFoundFault(String::from(parsed_error.message)),
...
impl DescribeClusterParameterGroupsError {
    pub fn from_body(body: &str) -> DescribeClusterParameterGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupNotFoundFault" => DescribeClusterParameterGroupsError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeClusterParameterGroupsError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeClusterParametersError {
    pub fn from_body(body: &str) -> DescribeClusterParametersError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupNotFoundFault" => DescribeClusterParametersError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
...
impl DescribeClusterSecurityGroupsError {
    pub fn from_body(body: &str) -> DescribeClusterSecurityGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSecurityGroupNotFoundFault" => DescribeClusterSecurityGroupsError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeClusterSecurityGroupsError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeClusterSnapshotsError {
    pub fn from_body(body: &str) -> DescribeClusterSnapshotsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSnapshotNotFoundFault" => DescribeClusterSnapshotsError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeClusterSnapshotsError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeClusterSubnetGroupsError {
    pub fn from_body(body: &str) -> DescribeClusterSubnetGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSubnetGroupNotFoundFault" => DescribeClusterSubnetGroupsError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeClusterSubnetGroupsError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeClustersError {
    pub fn from_body(body: &str) -> DescribeClustersError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DescribeClustersError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => {
...
impl DescribeHsmClientCertificatesError {
    pub fn from_body(body: &str) -> DescribeHsmClientCertificatesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmClientCertificateNotFoundFault" => DescribeHsmClientCertificatesError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeHsmClientCertificatesError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeHsmConfigurationsError {
    pub fn from_body(body: &str) -> DescribeHsmConfigurationsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HsmConfigurationNotFoundFault" => DescribeHsmConfigurationsError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),
                    "InvalidTagFault" => DescribeHsmConfigurationsError::InvalidTagFault(String::from(parsed_error.message)),
...
impl DescribeLoggingStatusError {
    pub fn from_body(body: &str) -> DescribeLoggingStatusError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DescribeLoggingStatusError::ClusterNotFoundFault(String::from(parsed_error.message)),
...
impl DescribeResizeError {
    pub fn from_body(body: &str) -> DescribeResizeError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DescribeResizeError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "ResizeNotFoundFault" => {
...
impl DescribeSnapshotCopyGrantsError {
    pub fn from_body(body: &str) -> DescribeSnapshotCopyGrantsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidTagFault" => DescribeSnapshotCopyGrantsError::InvalidTagFault(String::from(parsed_error.message)),
                    "SnapshotCopyGrantNotFoundFault" => DescribeSnapshotCopyGrantsError::SnapshotCopyGrantNotFoundFault(String::from(parsed_error.message)),
...
impl DescribeTableRestoreStatusError {
    pub fn from_body(body: &str) -> DescribeTableRestoreStatusError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DescribeTableRestoreStatusError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "TableRestoreNotFoundFault" => DescribeTableRestoreStatusError::TableRestoreNotFoundFault(String::from(parsed_error.message)),
...
impl DisableLoggingError {
    pub fn from_body(body: &str) -> DisableLoggingError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DisableLoggingError::ClusterNotFoundFault(String::from(parsed_error.message)),
...
impl DisableSnapshotCopyError {
    pub fn from_body(body: &str) -> DisableSnapshotCopyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => DisableSnapshotCopyError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => DisableSnapshotCopyError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "SnapshotCopyAlreadyDisabledFault" => DisableSnapshotCopyError::SnapshotCopyAlreadyDisabledFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => DisableSnapshotCopyError::UnauthorizedOperation(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "InsufficientS3BucketPolicyFault" => EnableLoggingError::InsufficientS3BucketPolicyFault(String::from(parsed_error.message)),
                    "InvalidS3BucketNameFault" => EnableLoggingError::InvalidS3BucketNameFault(String::from(parsed_error.message)),
                    "InvalidS3KeyPrefixFault" => EnableLoggingError::InvalidS3KeyPrefixFault(String::from(parsed_error.message)),
...
impl EnableSnapshotCopyError {
    pub fn from_body(body: &str) -> EnableSnapshotCopyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => EnableSnapshotCopyError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "CopyToRegionDisabledFault" => EnableSnapshotCopyError::CopyToRegionDisabledFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => EnableSnapshotCopyError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "IncompatibleOrderableOptions" => EnableSnapshotCopyError::IncompatibleOrderableOptions(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => EnableSnapshotCopyError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => EnableSnapshotCopyError::LimitExceededFault(String::from(parsed_error.message)),
                    "SnapshotCopyAlreadyEnabledFault" => EnableSnapshotCopyError::SnapshotCopyAlreadyEnabledFault(String::from(parsed_error.message)),
                    "SnapshotCopyGrantNotFoundFault" => EnableSnapshotCopyError::SnapshotCopyGrantNotFoundFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => EnableSnapshotCopyError::UnauthorizedOperation(String::from(parsed_error.message)),
                    "UnknownSnapshotCopyRegionFault" => EnableSnapshotCopyError::UnknownSnapshotCopyRegionFault(String::from(parsed_error.message)),
...
impl ModifyClusterError {
    pub fn from_body(body: &str) -> ModifyClusterError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterAlreadyExistsFault" => ModifyClusterError::ClusterAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterNotFoundFault" => {
                        ModifyClusterError::ClusterNotFoundFault(String::from(parsed_error.message))
                    }
                    "ClusterParameterGroupNotFoundFault" => ModifyClusterError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupNotFoundFault" => ModifyClusterError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => ModifyClusterError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "HsmClientCertificateNotFoundFault" => ModifyClusterError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),
                    "HsmConfigurationNotFoundFault" => ModifyClusterError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),
                    "InsufficientClusterCapacityFault" => ModifyClusterError::InsufficientClusterCapacityFault(String::from(parsed_error.message)),
                    "InvalidClusterSecurityGroupStateFault" => ModifyClusterError::InvalidClusterSecurityGroupStateFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => ModifyClusterError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "InvalidElasticIpFault" => ModifyClusterError::InvalidElasticIpFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => {
...
impl ModifyClusterIamRolesError {
    pub fn from_body(body: &str) -> ModifyClusterIamRolesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => ModifyClusterIamRolesError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => ModifyClusterIamRolesError::InvalidClusterStateFault(String::from(parsed_error.message)),
...
impl ModifyClusterParameterGroupError {
    pub fn from_body(body: &str) -> ModifyClusterParameterGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupNotFoundFault" => ModifyClusterParameterGroupError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterParameterGroupStateFault" => ModifyClusterParameterGroupError::InvalidClusterParameterGroupStateFault(String::from(parsed_error.message)),
...
impl ModifyClusterSubnetGroupError {
    pub fn from_body(body: &str) -> ModifyClusterSubnetGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterSubnetGroupNotFoundFault" => ModifyClusterSubnetGroupError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSubnetQuotaExceededFault" => ModifyClusterSubnetGroupError::ClusterSubnetQuotaExceededFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => ModifyClusterSubnetGroupError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "InvalidSubnet" => ModifyClusterSubnetGroupError::InvalidSubnet(String::from(parsed_error.message)),
                    "SubnetAlreadyInUse" => ModifyClusterSubnetGroupError::SubnetAlreadyInUse(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => ModifyClusterSubnetGroupError::UnauthorizedOperation(String::from(parsed_error.message)),
...
impl ModifyEventSubscriptionError {
    pub fn from_body(body: &str) -> ModifyEventSubscriptionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidSubscriptionStateFault" => ModifyEventSubscriptionError::InvalidSubscriptionStateFault(String::from(parsed_error.message)),
                    ...
                    "SourceNotFoundFault" => ModifyEventSubscriptionError::SourceNotFoundFault(String::from(parsed_error.message)),
                    ...
                    "SubscriptionEventIdNotFoundFault" => ModifyEventSubscriptionError::SubscriptionEventIdNotFoundFault(String::from(parsed_error.message)),
                    "SubscriptionNotFoundFault" => ModifyEventSubscriptionError::SubscriptionNotFoundFault(String::from(parsed_error.message)),
                    "SubscriptionSeverityNotFoundFault" => ModifyEventSubscriptionError::SubscriptionSeverityNotFoundFault(String::from(parsed_error.message)),
...
impl ModifySnapshotCopyRetentionPeriodError {
    pub fn from_body(body: &str) -> ModifySnapshotCopyRetentionPeriodError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => ModifySnapshotCopyRetentionPeriodError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => ModifySnapshotCopyRetentionPeriodError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "SnapshotCopyDisabledFault" => ModifySnapshotCopyRetentionPeriodError::SnapshotCopyDisabledFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => ModifySnapshotCopyRetentionPeriodError::UnauthorizedOperation(String::from(parsed_error.message)),
...
impl PurchaseReservedNodeOfferingError {
    pub fn from_body(body: &str) -> PurchaseReservedNodeOfferingError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ReservedNodeAlreadyExistsFault" => PurchaseReservedNodeOfferingError::ReservedNodeAlreadyExistsFault(String::from(parsed_error.message)),
                    "ReservedNodeOfferingNotFoundFault" => PurchaseReservedNodeOfferingError::ReservedNodeOfferingNotFoundFault(String::from(parsed_error.message)),
                    "ReservedNodeQuotaExceededFault" => PurchaseReservedNodeOfferingError::ReservedNodeQuotaExceededFault(String::from(parsed_error.message)),
                    "UnsupportedOperationFault" => PurchaseReservedNodeOfferingError::UnsupportedOperationFault(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "InvalidClusterStateFault" => RebootClusterError::InvalidClusterStateFault(String::from(parsed_error.message)),
...
impl ResetClusterParameterGroupError {
    pub fn from_body(body: &str) -> ResetClusterParameterGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterParameterGroupNotFoundFault" => ResetClusterParameterGroupError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterParameterGroupStateFault" => ResetClusterParameterGroupError::InvalidClusterParameterGroupStateFault(String::from(parsed_error.message)),
...
impl RestoreFromClusterSnapshotError {
    pub fn from_body(body: &str) -> RestoreFromClusterSnapshotError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AccessToSnapshotDeniedFault" => RestoreFromClusterSnapshotError::AccessToSnapshotDeniedFault(String::from(parsed_error.message)),
                    "ClusterAlreadyExistsFault" => RestoreFromClusterSnapshotError::ClusterAlreadyExistsFault(String::from(parsed_error.message)),
                    "ClusterParameterGroupNotFoundFault" => RestoreFromClusterSnapshotError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterQuotaExceededFault" => RestoreFromClusterSnapshotError::ClusterQuotaExceededFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupNotFoundFault" => RestoreFromClusterSnapshotError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSnapshotNotFoundFault" => RestoreFromClusterSnapshotError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSubnetGroupNotFoundFault" => RestoreFromClusterSnapshotError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => RestoreFromClusterSnapshotError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "HsmClientCertificateNotFoundFault" => RestoreFromClusterSnapshotError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),
                    "HsmConfigurationNotFoundFault" => RestoreFromClusterSnapshotError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),
                    "InsufficientClusterCapacityFault" => RestoreFromClusterSnapshotError::InsufficientClusterCapacityFault(String::from(parsed_error.message)),
                    "InvalidClusterSnapshotStateFault" => RestoreFromClusterSnapshotError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),
                    "InvalidClusterSubnetGroupStateFault" => RestoreFromClusterSnapshotError::InvalidClusterSubnetGroupStateFault(String::from(parsed_error.message)),
                    "InvalidElasticIpFault" => RestoreFromClusterSnapshotError::InvalidElasticIpFault(String::from(parsed_error.message)),
                    "InvalidRestoreFault" => RestoreFromClusterSnapshotError::InvalidRestoreFault(String::from(parsed_error.message)),
                    "InvalidSubnet" => RestoreFromClusterSnapshotError::InvalidSubnet(String::from(parsed_error.message)),
                    "InvalidVPCNetworkStateFault" => RestoreFromClusterSnapshotError::InvalidVPCNetworkStateFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => RestoreFromClusterSnapshotError::LimitExceededFault(String::from(parsed_error.message)),
                    "NumberOfNodesPerClusterLimitExceededFault" => RestoreFromClusterSnapshotError::NumberOfNodesPerClusterLimitExceededFault(String::from(parsed_error.message)),
                    "NumberOfNodesQuotaExceededFault" => RestoreFromClusterSnapshotError::NumberOfNodesQuotaExceededFault(String::from(parsed_error.message)),
                    "UnauthorizedOperation" => RestoreFromClusterSnapshotError::UnauthorizedOperation(String::from(parsed_error.message)),
...
impl RestoreTableFromClusterSnapshotError {
    pub fn from_body(body: &str) -> RestoreTableFromClusterSnapshotError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => RestoreTableFromClusterSnapshotError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSnapshotNotFoundFault" => RestoreTableFromClusterSnapshotError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
                    "InProgressTableRestoreQuotaExceededFault" => RestoreTableFromClusterSnapshotError::InProgressTableRestoreQuotaExceededFault(String::from(parsed_error.message)),
                    "InvalidClusterSnapshotStateFault" => RestoreTableFromClusterSnapshotError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => RestoreTableFromClusterSnapshotError::InvalidClusterStateFault(String::from(parsed_error.message)),
                    "InvalidTableRestoreArgumentFault" => RestoreTableFromClusterSnapshotError::InvalidTableRestoreArgumentFault(String::from(parsed_error.message)),
                    "UnsupportedOperationFault" => RestoreTableFromClusterSnapshotError::UnsupportedOperationFault(String::from(parsed_error.message)),
...
impl RevokeClusterSecurityGroupIngressError {
    pub fn from_body(body: &str) -> RevokeClusterSecurityGroupIngressError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AuthorizationNotFoundFault" => RevokeClusterSecurityGroupIngressError::AuthorizationNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSecurityGroupNotFoundFault" => RevokeClusterSecurityGroupIngressError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),
                    "InvalidClusterSecurityGroupStateFault" => RevokeClusterSecurityGroupIngressError::InvalidClusterSecurityGroupStateFault(String::from(parsed_error.message)),
...
impl RevokeSnapshotAccessError {
    pub fn from_body(body: &str) -> RevokeSnapshotAccessError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AccessToSnapshotDeniedFault" => RevokeSnapshotAccessError::AccessToSnapshotDeniedFault(String::from(parsed_error.message)),
                    "AuthorizationNotFoundFault" => RevokeSnapshotAccessError::AuthorizationNotFoundFault(String::from(parsed_error.message)),
                    "ClusterSnapshotNotFoundFault" => RevokeSnapshotAccessError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),
...
impl RotateEncryptionKeyError {
    pub fn from_body(body: &str) -> RotateEncryptionKeyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ClusterNotFoundFault" => RotateEncryptionKeyError::ClusterNotFoundFault(String::from(parsed_error.message)),
                    "DependentServiceRequestThrottlingFault" => RotateEncryptionKeyError::DependentServiceRequestThrottlingFault(String::from(parsed_error.message)),
                    "InvalidClusterStateFault" => RotateEncryptionKeyError::InvalidClusterStateFault(String::from(parsed_error.message)),
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(AuthorizeSnapshotAccessResultDeserializer::deserialize("AuthorizeSnapshotAccessResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(CopyClusterSnapshotResultDeserializer::deserialize("CopyClusterSnapshotResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(CreateClusterResultDeserializer::deserialize("CreateClusterResult",
                                                                               &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CreateClusterSecurityGroupResultDeserializer::deserialize("CreateClusterSecurityGroupResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(CreateClusterSnapshotResultDeserializer::deserialize("CreateClusterSnapshotResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CreateClusterSubnetGroupResultDeserializer::deserialize("CreateClusterSubnetGroupResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CreateHsmClientCertificateResultDeserializer::deserialize("CreateHsmClientCertificateResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CreateHsmConfigurationResultDeserializer::deserialize("CreateHsmConfigurationResult",
                                                                                   &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CreateSnapshotCopyGrantResultDeserializer::deserialize("CreateSnapshotCopyGrantResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DeleteClusterResultDeserializer::deserialize("DeleteClusterResult",
                                                                               &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DeleteClusterSnapshotResultDeserializer::deserialize("DeleteClusterSnapshotResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ClusterParameterGroupsMessageDeserializer::deserialize("DescribeClusterParameterGroupsResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ClusterParameterGroupDetailsDeserializer::deserialize("DescribeClusterParametersResult",
                                                                                   &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ClusterSecurityGroupMessageDeserializer::deserialize("DescribeClusterSecurityGroupsResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(SnapshotMessageDeserializer::deserialize("DescribeClusterSnapshotsResult",
                                                                           &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ClusterSubnetGroupMessageDeserializer::deserialize("DescribeClusterSubnetGroupsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ClusterVersionsMessageDeserializer::deserialize("DescribeClusterVersionsResult",
                                                                                  &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ClustersMessageDeserializer::deserialize("DescribeClustersResult",
                                                                           &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(HsmClientCertificateMessageDeserializer::deserialize("DescribeHsmClientCertificatesResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(HsmConfigurationMessageDeserializer::deserialize("DescribeHsmConfigurationsResult",
                                                                                   &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(LoggingStatusDeserializer::deserialize("DescribeLoggingStatusResult",
                                                                         &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(OrderableClusterOptionsMessageDeserializer::deserialize("DescribeOrderableClusterOptionsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ReservedNodeOfferingsMessageDeserializer::deserialize("DescribeReservedNodeOfferingsResult",
                                                                                   &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ReservedNodesMessageDeserializer::deserialize("DescribeReservedNodesResult",
                                                                                &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ResizeProgressMessageDeserializer::deserialize("DescribeResizeResult",
                                                                                 &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(SnapshotCopyGrantMessageDeserializer::deserialize("DescribeSnapshotCopyGrantsResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(TableRestoreStatusMessageDeserializer::deserialize("DescribeTableRestoreStatusResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(TaggedResourceListMessageDeserializer::deserialize("DescribeTagsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(LoggingStatusDeserializer::deserialize("DisableLoggingResult",
                                                                         &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DisableSnapshotCopyResultDeserializer::deserialize("DisableSnapshotCopyResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(LoggingStatusDeserializer::deserialize("EnableLoggingResult",
                                                                         &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EnableSnapshotCopyResultDeserializer::deserialize("EnableSnapshotCopyResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ModifyClusterResultDeserializer::deserialize("ModifyClusterResult",
                                                                               &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ModifyClusterIamRolesResultDeserializer::deserialize("ModifyClusterIamRolesResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ClusterParameterGroupNameMessageDeserializer::deserialize("ModifyClusterParameterGroupResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ModifyClusterSubnetGroupResultDeserializer::deserialize("ModifyClusterSubnetGroupResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(RebootClusterResultDeserializer::deserialize("RebootClusterResult",
                                                                               &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ClusterParameterGroupNameMessageDeserializer::deserialize("ResetClusterParameterGroupResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(RestoreFromClusterSnapshotResultDeserializer::deserialize("RestoreFromClusterSnapshotResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(RevokeSnapshotAccessResultDeserializer::deserialize("RevokeSnapshotAccessResult",
                                                                                      &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(RotateEncryptionKeyResultDeserializer::deserialize("RotateEncryptionKeyResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
