...
pub struct AddTagsInput {
    ...
    #[doc="<p>The type of the ML object to tag. </p>"]
    #[serde(rename="ResourceType")]
    pub resource_type: String,
    #[doc="<p>The key-value pairs to use to create tags. If you specify a key without specifying a value, Amazon ML creates a tag with the specified key and a value of null.</p>"]
    #[serde(rename="Tags")]
    pub tags: Vec<Tag>,
}
...
pub struct CreateDataSourceFromRDSInput {
    ...
    #[doc="<p>The role that Amazon ML assumes on behalf of the user to create and activate a data pipeline in the user's account and copy data using the <code>SelectSqlQuery</code> query from Amazon RDS to Amazon S3.</p> <p> </p>"]
...
pub struct CreateEvaluationInput {
    ...
    #[doc="<p>A user-supplied ID that uniquely identifies the <code>Evaluation</code>.</p>"]
...
pub struct DeleteTagsInput {
    ...
    #[serde(rename="ResourceType")]
    pub resource_type: String,
    #[doc="<p>One or more tags to delete.</p>"]
...
pub struct DescribeTagsInput {
    ...
    #[serde(rename="ResourceId")]
    pub resource_id: String,
    #[doc="<p>The type of the ML object.</p>"]
    #[serde(rename="ResourceType")]
    pub resource_type: String,
}
...
pub struct RDSDataSpec {
    ...
    #[doc="<p>Describes the <code>DatabaseName</code> and <code>InstanceIdentifier</code> of an Amazon RDS database.</p>"]
    #[serde(rename="DatabaseInformation")]
    pub database_information: RDSDatabase,
    #[doc="<p>The role (DataPipelineDefaultResourceRole) assumed by an Amazon Elastic Compute Cloud (Amazon EC2) instance to carry out the copy operation from Amazon RDS to an Amazon S3 task. For more information, see <a href=\"http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html\">Role templates</a> for data pipelines.</p>"]
    #[serde(rename="ResourceRole")]
    pub resource_role: String,
    #[doc="<p>The Amazon S3 location for staging Amazon RDS data. The data retrieved from Amazon RDS using <code>SelectSqlQuery</code> is stored in this location.</p>"]
    #[serde(rename="S3StagingLocation")]
    pub s3_staging_location: String,
    #[doc="<p>The security group IDs to be used to access a VPC-based RDS DB instance. Ensure that there are appropriate ingress rules set up to allow access to the RDS DB instance. This attribute is used by Data Pipeline to carry out the copy operation from Amazon RDS to an Amazon S3 task.</p>"]
    #[serde(rename="SecurityGroupIds")]
    pub security_group_ids: Vec<String>,
    #[doc="<p>The query that is used to retrieve the observation data for the <code>DataSource</code>.</p>"]
    #[serde(rename="SelectSqlQuery")]
    pub select_sql_query: String,
    #[doc="<p>The role (DataPipelineDefaultRole) assumed by AWS Data Pipeline service to monitor the progress of the copy task from Amazon RDS to Amazon S3. For more information, see <a href=\"http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html\">Role templates</a> for data pipelines.</p>"]
    #[serde(rename="ServiceRole")]
    pub service_role: String,
    #[doc="<p>The subnet ID to be used to access a VPC-based RDS DB instance. This attribute is used by Data Pipeline to carry out the copy task from Amazon RDS to Amazon S3.</p>"]
...
pub struct RDSDatabase {
    ...
    #[doc="<p>The ID of an RDS DB instance.</p>"]
...
pub struct RedshiftDataSpec {
    ...
    #[doc="<p>Describes the <code>DatabaseName</code> and <code>ClusterIdentifier</code> for an Amazon Redshift <code>DataSource</code>.</p>"]
    #[serde(rename="DatabaseInformation")]
    pub database_information: RedshiftDatabase,
    #[doc="<p>Describes an Amazon S3 location to store the result set of the <code>SelectSqlQuery</code> query.</p>"]
    #[serde(rename="S3StagingLocation")]
    pub s3_staging_location: String,
    #[doc="<p>Describes the SQL Query to execute on an Amazon Redshift database for an Amazon Redshift <code>DataSource</code>.</p>"]
    #[serde(rename="SelectSqlQuery")]
    pub select_sql_query: String,
}
...
pub struct UpdateBatchPredictionInput {
    ...
    #[serde(rename="BatchPredictionId")]
    pub batch_prediction_id: String,
    #[doc="<p>A new user-supplied name or description of the <code>BatchPrediction</code>.</p>"]
    #[serde(rename="BatchPredictionName")]
...
pub struct UpdateDataSourceInput {
    ...
    #[serde(rename="DataSourceId")]
    pub data_source_id: String,
    #[doc="<p>A new user-supplied name or description of the <code>DataSource</code> that will replace the current description. </p>"]
    #[serde(rename="DataSourceName")]
...
pub struct UpdateEvaluationInput {
    ...
    #[serde(rename="EvaluationId")]
    pub evaluation_id: String,
    #[doc="<p>A new user-supplied name or description of the <code>Evaluation</code> that will replace the current content. </p>"]
    #[serde(rename="EvaluationName")]
...
pub trait MachineLearning {
    ...
    #[doc="<p>Creates a real-time endpoint for the <code>MLModel</code>. The endpoint contains the URI of the <code>MLModel</code>; that is, the location to send real-time prediction requests for the specified <code>MLModel</code>.</p>"]
    ...
    #[doc="<p>Deletes a real time endpoint of an <code>MLModel</code>.</p>"]
    ...
    #[doc="<p>Returns a list of <code>BatchPrediction</code> operations that match the search criteria in the request.</p>"]
    ...
    #[doc="<p>Updates the <code>BatchPredictionName</code> of a <code>BatchPrediction</code>.</p> <p>You can use the <code>GetBatchPrediction</code> operation to view the contents of the updated data element.</p>"]
    ...
    #[doc="<p>Updates the <code>DataSourceName</code> of a <code>DataSource</code>.</p> <p>You can use the <code>GetDataSource</code> operation to view the contents of the updated data element.</p>"]
    fn update_data_source(&self,
                          input: &UpdateDataSourceInput)
                          -> Result<UpdateDataSourceOutput, UpdateDataSourceError>;


    #[doc="<p>Updates the <code>EvaluationName</code> of an <code>Evaluation</code>.</p> <p>You can use the <code>GetEvaluation</code> operation to view the contents of the updated data element.</p>"]
    fn update_evaluation(&self,
                         input: &UpdateEvaluationInput)
                         -> Result<UpdateEvaluationOutput, UpdateEvaluationError>;


    #[doc="<p>Updates the <code>MLModelName</code> and the <code>ScoreThreshold</code> of an <code>MLModel</code>.</p> <p>You can use the <code>GetMLModel</code> operation to view the contents of the updated data element.</p>"]
    fn update_ml_model(&self,
                       input: &UpdateMLModelInput)
                       -> Result<UpdateMLModelOutput, UpdateMLModelError>;
}
/// A client for the Amazon Machine Learning API.
pub struct MachineLearningClient<P, D>
