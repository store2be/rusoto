            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Region" => {
                            obj.region = try!(CloudWatchRegionDeserializer::deserialize("Region",
                                                                                        stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl AlarmIdentifierSerializer {
    ...
    pub fn serialize(name: &str, obj: &AlarmIdentifier) -> String {
        ...
        serialized += &format!("<Name>{value}</Name>", value = obj.name);
        serialized += &format!("<Region>{value}</Region>", value = obj.region);
                    ...
                    match &name[..] {
                        ...
                        "EvaluateTargetHealth" => {
                            obj.evaluate_target_health =
                                try!(AliasHealthEnabledDeserializer::deserialize("EvaluateTargetHealth",
                                                                                 stack));
                        }
                        "HostedZoneId" => {
                            obj.hosted_zone_id = try!(ResourceIdDeserializer::deserialize("HostedZoneId",
                                                                                          stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl AliasTargetSerializer {
    ...
    pub fn serialize(name: &str, obj: &AliasTarget) -> String {
        let mut serialized = format!("<{name}>", name = name);
        serialized += &format!("<DNSName>{value}</DNSName>", value = obj.dns_name);
        serialized += &format!("<EvaluateTargetHealth>{value}</EvaluateTargetHealth>",
                value = obj.evaluate_target_health);
        serialized += &format!("<HostedZoneId>{value}</HostedZoneId>",
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ChangeInfo" => {
                            obj.change_info = try!(ChangeInfoDeserializer::deserialize("ChangeInfo",
                                                                                       stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl ChangeSerializer {
    ...
    pub fn serialize(name: &str, obj: &Change) -> String {
        let mut serialized = format!("<{name}>", name = name);
        serialized += &format!("<Action>{value}</Action>", value = obj.action);
        serialized += &ResourceRecordSetSerializer::serialize("ResourceRecordSet",
...
impl ChangeBatchSerializer {
    ...
    pub fn serialize(name: &str, obj: &ChangeBatch) -> String {
        let mut serialized = format!("<{name}>", name = name);
        serialized += &ChangesSerializer::serialize("Changes", &obj.changes);
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Comment" => {
                            obj.comment =
                                Some(try!(ResourceDescriptionDeserializer::deserialize("Comment",
                                                                                       stack)));
                        }
                        "Id" => {
                        ...
                        "Status" => {
                            obj.status = try!(ChangeStatusDeserializer::deserialize("Status",
                                                                                    stack));
                        }
                        "SubmittedAt" => {
                            obj.submitted_at = try!(TimeStampDeserializer::deserialize("SubmittedAt",
                                                                                       stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl ChangesSerializer {
    #[allow(unused_variables, warnings)]
    pub fn serialize(name: &str, obj: &Vec<Change>) -> String {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ChildHealthCheck" {
                        obj.push(try!(HealthCheckIdDeserializer::deserialize("ChildHealthCheck",
                                                                             stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "ComparisonOperator" => {
                            obj.comparison_operator =
                                try!(ComparisonOperatorDeserializer::deserialize("ComparisonOperator",
                                                                                 stack));
                        }
                        "Dimensions" => {
                            obj.dimensions =
                                Some(try!(DimensionListDeserializer::deserialize("Dimensions",
                                                                                 stack)));
                        }
                        "EvaluationPeriods" => {
                            obj.evaluation_periods =
                                try!(EvaluationPeriodsDeserializer::deserialize("EvaluationPeriods",
                                                                                stack));
                        }
                        "MetricName" => {
                        ...
                        "Namespace" => {
                            obj.namespace = try!(NamespaceDeserializer::deserialize("Namespace",
                                                                                    stack));
                        }
                        "Period" => {
                        ...
                        "Statistic" => {
                            obj.statistic = try!(StatisticDeserializer::deserialize("Statistic",
                                                                                    stack));
                        }
                        "Threshold" => {
                            obj.threshold = try!(ThresholdDeserializer::deserialize("Threshold",
                                                                                    stack));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HealthCheck" => {
                            obj.health_check = try!(HealthCheckDeserializer::deserialize("HealthCheck",
                                                                                         stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "DelegationSet" => {
                            obj.delegation_set =
                                try!(DelegationSetDeserializer::deserialize("DelegationSet",
                                                                            stack));
                        }
                        "HostedZone" => {
                            obj.hosted_zone = try!(HostedZoneDeserializer::deserialize("HostedZone",
                                                                                       stack));
                        }
                        "VPC" => {
                    ...
                    match &name[..] {
                        "TrafficPolicyInstance" => {
                            obj.traffic_policy_instance =
                                try!(TrafficPolicyInstanceDeserializer::deserialize("TrafficPolicyInstance",
                                                                                    stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "TrafficPolicy" => {
                            obj.traffic_policy =
                                try!(TrafficPolicyDeserializer::deserialize("TrafficPolicy",
                                                                            stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "CallerReference" => {
                            obj.caller_reference =
                                Some(try!(NonceDeserializer::deserialize("CallerReference",
                                                                         stack)));
                        }
                        "Id" => {
                        ...
                        "NameServers" => {
                            obj.name_servers =
                                try!(DelegationSetNameServersDeserializer::deserialize("NameServers",
                                                                                       stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "DelegationSet" {
                        obj.push(try!(DelegationSetDeserializer::deserialize("DelegationSet",
                                                                             stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Value" => {
                            obj.value = try!(DimensionFieldDeserializer::deserialize("Value",
                                                                                     stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "CountryCode" => {
                            obj.country_code =
                                Some(try!(GeoLocationCountryCodeDeserializer::deserialize("CountryCode",
                                                                                          stack)));
                        }
                        "SubdivisionCode" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "CountryName" => {
                            obj.country_name =
                                Some(try!(GeoLocationCountryNameDeserializer::deserialize("CountryName",
                                                                                          stack)));
                        }
                        "SubdivisionCode" => {
                            obj.subdivision_code = Some(try!(GeoLocationSubdivisionCodeDeserializer::deserialize("SubdivisionCode", stack)));
                    ...
                    match &name[..] {
                        "CheckerIpRanges" => {
                            obj.checker_ip_ranges =
                                try!(CheckerIpRangesDeserializer::deserialize("CheckerIpRanges",
                                                                              stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "GeoLocationDetails" => {
                            obj.geo_location_details =
                                try!(GeoLocationDetailsDeserializer::deserialize("GeoLocationDetails",
                                                                                 stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "HealthCheckCount" => {
                            obj.health_check_count =
                                try!(HealthCheckCountDeserializer::deserialize("HealthCheckCount",
                                                                               stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "HealthCheckObservations" => {
                            obj.health_check_observations =
                                try!(HealthCheckObservationsDeserializer::deserialize("HealthCheckObservations",
                                                                                      stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "HostedZoneCount" => {
                            obj.hosted_zone_count =
                                try!(HostedZoneCountDeserializer::deserialize("HostedZoneCount",
                                                                              stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DelegationSet" => {
                            obj.delegation_set =
                                Some(try!(DelegationSetDeserializer::deserialize("DelegationSet",
                                                                                 stack)));
                        }
                        "HostedZone" => {
                            obj.hosted_zone = try!(HostedZoneDeserializer::deserialize("HostedZone",
                    ...
                    match &name[..] {
                        "TrafficPolicyInstanceCount" => {
                            obj.traffic_policy_instance_count =
                                try!(TrafficPolicyInstanceCountDeserializer::deserialize("TrafficPolicyInstanceCount",
                                                                                         stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CallerReference" => {
                            obj.caller_reference =
                                try!(HealthCheckNonceDeserializer::deserialize("CallerReference",
                                                                               stack));
                        }
                        ...
                        "HealthCheckConfig" => {
                            obj.health_check_config =
                                try!(HealthCheckConfigDeserializer::deserialize("HealthCheckConfig",
                                                                                stack));
                        }
                        "HealthCheckVersion" => {
                            obj.health_check_version =
                                try!(HealthCheckVersionDeserializer::deserialize("HealthCheckVersion",
                                                                                 stack));
                        }
                        "Id" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlarmIdentifier" => {
                            obj.alarm_identifier =
                                Some(try!(AlarmIdentifierDeserializer::deserialize("AlarmIdentifier",
                                                                                   stack)));
                        }
                        "ChildHealthChecks" => {
                            obj.child_health_checks =
                                Some(try!(ChildHealthCheckListDeserializer::deserialize("ChildHealthChecks",
                                                                                        stack)));
                        }
                        "EnableSNI" => {
                            obj.enable_sni = Some(try!(EnableSNIDeserializer::deserialize("EnableSNI",
                                                                                          stack)));
                        }
                        "FailureThreshold" => {
                            obj.failure_threshold =
                                Some(try!(FailureThresholdDeserializer::deserialize("FailureThreshold",
                                                                                    stack)));
                        }
                        ...
                        "HealthThreshold" => {
                            obj.health_threshold =
                                Some(try!(HealthThresholdDeserializer::deserialize("HealthThreshold",
                                                                                   stack)));
                        }
                        "IPAddress" => {
                            obj.ip_address = Some(try!(IPAddressDeserializer::deserialize("IPAddress",
                                                                                          stack)));
                        }
                        ...
                        "Inverted" => {
                            obj.inverted = Some(try!(InvertedDeserializer::deserialize("Inverted",
                                                                                       stack)));
                        }
                        "MeasureLatency" => {
                            obj.measure_latency =
                                Some(try!(MeasureLatencyDeserializer::deserialize("MeasureLatency",
                                                                                  stack)));
                        }
                        "Port" => {
                        ...
                        "Regions" => {
                            obj.regions =
                                Some(try!(HealthCheckRegionListDeserializer::deserialize("Regions",
                                                                                         stack)));
                        }
                        "RequestInterval" => {
                            obj.request_interval =
                                Some(try!(RequestIntervalDeserializer::deserialize("RequestInterval",
                                                                                   stack)));
                        }
                        "ResourcePath" => {
                            obj.resource_path =
                                Some(try!(ResourcePathDeserializer::deserialize("ResourcePath",
                                                                                stack)));
                        }
                        "SearchString" => {
                            obj.search_string =
                                Some(try!(SearchStringDeserializer::deserialize("SearchString",
                                                                                stack)));
                        }
                        "Type" => {
                            obj.type_ = try!(HealthCheckTypeDeserializer::deserialize("Type",
                                                                                      stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl HealthCheckConfigSerializer {
    ...
    pub fn serialize(name: &str, obj: &HealthCheckConfig) -> String {
        ...
        if let Some(ref value) = obj.failure_threshold {
            serialized += &format!("<FailureThreshold>{value}</FailureThreshold>",
                    value = value);
        }
        if let Some(ref value) = obj.fully_qualified_domain_name {
            serialized += &format!("<FullyQualifiedDomainName>{value}</FullyQualifiedDomainName>",
                    value = value);
        }
        ...
        if let Some(ref value) = obj.insufficient_data_health_status {
            serialized += &format!("<InsufficientDataHealthStatus>{value}</InsufficientDataHealthStatus>",
                    value = value);
        }
        ...
        serialized += &format!("<Type>{value}</Type>", value = obj.type_);
        serialized += &format!("</{name}>", name = name);
        serialized
    }
}
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Region" => {
                            obj.region =
                                Some(try!(HealthCheckRegionDeserializer::deserialize("Region",
                                                                                     stack)));
                        }
                        "StatusReport" => {
                            obj.status_report =
                                Some(try!(StatusReportDeserializer::deserialize("StatusReport",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CallerReference" => {
                            obj.caller_reference = try!(NonceDeserializer::deserialize("CallerReference",
                                                                                       stack));
                        }
                        "Config" => {
                            obj.config =
                                Some(try!(HostedZoneConfigDeserializer::deserialize("Config",
                                                                                    stack)));
                        }
                        "Id" => {
                            obj.id = try!(ResourceIdDeserializer::deserialize("Id", stack));
                        ...
                        "ResourceRecordSetCount" => {
                            obj.resource_record_set_count =
                                Some(try!(HostedZoneRRSetCountDeserializer::deserialize("ResourceRecordSetCount",
                                                                                        stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "PrivateZone" => {
                            obj.private_zone =
                                Some(try!(IsPrivateZoneDeserializer::deserialize("PrivateZone",
                                                                                 stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "GeoLocationDetailsList" => {
                            obj.geo_location_details_list =
                                try!(GeoLocationDetailsListDeserializer::deserialize("GeoLocationDetailsList",
                                                                                     stack));
                        }
                        "IsTruncated" => {
                            obj.is_truncated = try!(PageTruncatedDeserializer::deserialize("IsTruncated",
                                                                                           stack));
                        }
                        "MaxItems" => {
                            obj.max_items = try!(PageMaxItemsDeserializer::deserialize("MaxItems",
                                                                                       stack));
                        }
                        "NextContinentCode" => {
                        ...
                        "NextCountryCode" => {
                            obj.next_country_code =
                                Some(try!(GeoLocationCountryCodeDeserializer::deserialize("NextCountryCode",
                                                                                          stack)));
                        }
                        "NextSubdivisionCode" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HealthChecks" => {
                            obj.health_checks = try!(HealthChecksDeserializer::deserialize("HealthChecks",
                                                                                           stack));
                        }
                        "IsTruncated" => {
                            obj.is_truncated = try!(PageTruncatedDeserializer::deserialize("IsTruncated",
                        ...
                        "NextMarker" => {
                            obj.next_marker =
                                Some(try!(PageMarkerDeserializer::deserialize("NextMarker",
                                                                              stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "HostedZoneId" => {
                            obj.hosted_zone_id =
                                Some(try!(ResourceIdDeserializer::deserialize("HostedZoneId",
                                                                              stack)));
                        }
                        "HostedZones" => {
                            obj.hosted_zones = try!(HostedZonesDeserializer::deserialize("HostedZones",
                                                                                         stack));
                        }
                        "IsTruncated" => {
                            obj.is_truncated = try!(PageTruncatedDeserializer::deserialize("IsTruncated",
                        ...
                        "NextDNSName" => {
                            obj.next_dns_name = Some(try!(DNSNameDeserializer::deserialize("NextDNSName",
                                                                                           stack)));
                        }
                        "NextHostedZoneId" => {
                            obj.next_hosted_zone_id =
                                Some(try!(ResourceIdDeserializer::deserialize("NextHostedZoneId",
                                                                              stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "NextRecordName" => {
                            obj.next_record_name =
                                Some(try!(DNSNameDeserializer::deserialize("NextRecordName",
                                                                           stack)));
                        }
                        "NextRecordType" => {
                            obj.next_record_type =
                                Some(try!(RRTypeDeserializer::deserialize("NextRecordType",
                                                                          stack)));
                        }
                        "ResourceRecordSets" => {
                            obj.resource_record_sets =
                                try!(ResourceRecordSetsDeserializer::deserialize("ResourceRecordSets",
                                                                                 stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DelegationSets" => {
                            obj.delegation_sets =
                                try!(DelegationSetsDeserializer::deserialize("DelegationSets",
                                                                             stack));
                        }
                        "IsTruncated" => {
                            obj.is_truncated = try!(PageTruncatedDeserializer::deserialize("IsTruncated",
                    ...
                    match &name[..] {
                        "ResourceTagSet" => {
                            obj.resource_tag_set =
                                try!(ResourceTagSetDeserializer::deserialize("ResourceTagSet",
                                                                             stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "ResourceTagSets" => {
                            obj.resource_tag_sets =
                                try!(ResourceTagSetListDeserializer::deserialize("ResourceTagSets",
                                                                                 stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "TrafficPolicyIdMarker" => {
                            obj.traffic_policy_id_marker =
                                try!(TrafficPolicyIdDeserializer::deserialize("TrafficPolicyIdMarker",
                                                                              stack));
                        }
                        "TrafficPolicySummaries" => {
                            obj.traffic_policy_summaries =
                                try!(TrafficPolicySummariesDeserializer::deserialize("TrafficPolicySummaries",
                                                                                     stack));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "TrafficPolicyInstanceNameMarker" => {
                            obj.traffic_policy_instance_name_marker =
                                Some(try!(DNSNameDeserializer::deserialize("TrafficPolicyInstanceNameMarker",
                                                                           stack)));
                        }
                        "TrafficPolicyInstanceTypeMarker" => {
                            obj.traffic_policy_instance_type_marker =
                                Some(try!(RRTypeDeserializer::deserialize("TrafficPolicyInstanceTypeMarker",
                                                                          stack)));
                        }
                        "TrafficPolicyInstances" => {
                            obj.traffic_policy_instances =
                                try!(TrafficPolicyInstancesDeserializer::deserialize("TrafficPolicyInstances",
                                                                                     stack));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HostedZoneIdMarker" => {
                            obj.hosted_zone_id_marker =
                                Some(try!(ResourceIdDeserializer::deserialize("HostedZoneIdMarker",
                                                                              stack)));
                        }
                        "IsTruncated" => {
                            obj.is_truncated = try!(PageTruncatedDeserializer::deserialize("IsTruncated",
                    ...
                    match &name[..] {
                        ...
                        "TrafficPolicies" => {
                            obj.traffic_policies =
                                try!(TrafficPoliciesDeserializer::deserialize("TrafficPolicies",
                                                                              stack));
                        }
                        "TrafficPolicyVersionMarker" => {
                            obj.traffic_policy_version_marker =
                                try!(TrafficPolicyVersionMarkerDeserializer::deserialize("TrafficPolicyVersionMarker",
                                                                                         stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "NextToken" => {
                            obj.next_token =
                                Some(try!(PaginationTokenDeserializer::deserialize("NextToken",
                                                                                   stack)));
                        }
                        "VPCs" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "RecordDataEntry" {
                        obj.push(try!(RecordDataEntryDeserializer::deserialize("RecordDataEntry",
                                                                               stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AliasTarget" => {
                            obj.alias_target =
                                Some(try!(AliasTargetDeserializer::deserialize("AliasTarget",
                                                                               stack)));
                        }
                        "Failover" => {
                        ...
                        "GeoLocation" => {
                            obj.geo_location =
                                Some(try!(GeoLocationDeserializer::deserialize("GeoLocation",
                                                                               stack)));
                        }
                        "HealthCheckId" => {
                            obj.health_check_id =
                                Some(try!(HealthCheckIdDeserializer::deserialize("HealthCheckId",
                                                                                 stack)));
                        }
                        "MultiValueAnswer" => {
                            obj.multi_value_answer = Some(try!(ResourceRecordSetMultiValueAnswerDeserializer::deserialize("MultiValueAnswer", stack)));
                        }
                        "Name" => {
                            obj.name = try!(DNSNameDeserializer::deserialize("Name", stack));
                        }
                        "Region" => {
                            obj.region =
                                Some(try!(ResourceRecordSetRegionDeserializer::deserialize("Region",
                                                                                           stack)));
                        }
                        "ResourceRecords" => {
                            obj.resource_records =
                                Some(try!(ResourceRecordsDeserializer::deserialize("ResourceRecords",
                                                                                   stack)));
                        }
                        "SetIdentifier" => {
                        ...
                        "TrafficPolicyInstanceId" => {
                            obj.traffic_policy_instance_id =
                                Some(try!(TrafficPolicyInstanceIdDeserializer::deserialize("TrafficPolicyInstanceId",
                                                                                           stack)));
                        }
                        "Type" => {
                        ...
                        "Weight" => {
                            obj.weight =
                                Some(try!(ResourceRecordSetWeightDeserializer::deserialize("Weight",
                                                                                           stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl ResourceRecordSetSerializer {
    ...
    pub fn serialize(name: &str, obj: &ResourceRecordSet) -> String {
        ...
        if let Some(ref value) = obj.multi_value_answer {
            serialized += &format!("<MultiValueAnswer>{value}</MultiValueAnswer>",
                    value = value);
        }
        serialized += &format!("<Name>{value}</Name>", value = obj.name);
        ...
        if let Some(ref value) = obj.traffic_policy_instance_id {
            serialized += &format!("<TrafficPolicyInstanceId>{value}</TrafficPolicyInstanceId>",
                    value = value);
        }
        serialized += &format!("<Type>{value}</Type>", value = obj.type_);
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ResourceRecord" {
                        obj.push(try!(ResourceRecordDeserializer::deserialize("ResourceRecord",
                                                                              stack)));
                    } else {
                        skip_tree(stack);
                    }
...
impl ResourceRecordsSerializer {
    #[allow(unused_variables, warnings)]
    pub fn serialize(name: &str, obj: &Vec<ResourceRecord>) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("<{}>", name));
        for element in obj {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ResourceId" => {
                            obj.resource_id =
                                Some(try!(TagResourceIdDeserializer::deserialize("ResourceId",
                                                                                 stack)));
                        }
                        "ResourceType" => {
                            obj.resource_type =
                                Some(try!(TagResourceTypeDeserializer::deserialize("ResourceType",
                                                                                   stack)));
                        }
                        "Tags" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ResourceTagSet" {
                        obj.push(try!(ResourceTagSetDeserializer::deserialize("ResourceTagSet",
                                                                              stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CheckedTime" => {
                            obj.checked_time =
                                Some(try!(TimeStampDeserializer::deserialize("CheckedTime",
                                                                             stack)));
                        }
                        "Status" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Nameserver" => {
                            obj.nameserver = try!(NameserverDeserializer::deserialize("Nameserver",
                                                                                      stack));
                        }
                        "Protocol" => {
                            obj.protocol = try!(TransportProtocolDeserializer::deserialize("Protocol",
                                                                                           stack));
                        }
                        "RecordData" => {
                            obj.record_data = try!(RecordDataDeserializer::deserialize("RecordData",
                                                                                       stack));
                        }
                        "RecordName" => {
                            obj.record_name = try!(DNSNameDeserializer::deserialize("RecordName",
                                                                                    stack));
                        }
                        "RecordType" => {
                            obj.record_type = try!(RRTypeDeserializer::deserialize("RecordType",
                                                                                   stack));
                        }
                        "ResponseCode" => {
                            obj.response_code = try!(DNSRCodeDeserializer::deserialize("ResponseCode",
                                                                                       stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "TrafficPolicy" {
                        obj.push(try!(TrafficPolicyDeserializer::deserialize("TrafficPolicy",
                                                                             stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Comment" => {
                            obj.comment =
                                Some(try!(TrafficPolicyCommentDeserializer::deserialize("Comment",
                                                                                        stack)));
                        }
                        "Document" => {
                            obj.document =
                                try!(TrafficPolicyDocumentDeserializer::deserialize("Document",
                                                                                    stack));
                        }
                        "Id" => {
                        ...
                        "Name" => {
                            obj.name = try!(TrafficPolicyNameDeserializer::deserialize("Name",
                                                                                       stack));
                        }
                        "Type" => {
                            obj.type_ = try!(RRTypeDeserializer::deserialize("Type", stack));
                        ...
                        "Version" => {
                            obj.version =
                                try!(TrafficPolicyVersionDeserializer::deserialize("Version",
                                                                                   stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Id" => {
                            obj.id = try!(TrafficPolicyInstanceIdDeserializer::deserialize("Id",
                                                                                           stack));
                        }
                        "Message" => {
                        ...
                        "State" => {
                            obj.state =
                                try!(TrafficPolicyInstanceStateDeserializer::deserialize("State",
                                                                                         stack));
                        }
                        "TTL" => {
                        ...
                        "TrafficPolicyId" => {
                            obj.traffic_policy_id =
                                try!(TrafficPolicyIdDeserializer::deserialize("TrafficPolicyId",
                                                                              stack));
                        }
                        "TrafficPolicyType" => {
                            obj.traffic_policy_type = try!(RRTypeDeserializer::deserialize("TrafficPolicyType",
                                                                                           stack));
                        }
                        "TrafficPolicyVersion" => {
                            obj.traffic_policy_version =
                                try!(TrafficPolicyVersionDeserializer::deserialize("TrafficPolicyVersion",
                                                                                   stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "LatestVersion" => {
                            obj.latest_version =
                                try!(TrafficPolicyVersionDeserializer::deserialize("LatestVersion",
                                                                                   stack));
                        }
                        "Name" => {
                            obj.name = try!(TrafficPolicyNameDeserializer::deserialize("Name",
                        ...
                        "TrafficPolicyCount" => {
                            obj.traffic_policy_count =
                                try!(TrafficPolicyVersionDeserializer::deserialize("TrafficPolicyCount",
                                                                                   stack));
                        }
                        "Type" => {
                            obj.type_ = try!(RRTypeDeserializer::deserialize("Type", stack));
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "VPCRegion" => {
                            obj.vpc_region = Some(try!(VPCRegionDeserializer::deserialize("VPCRegion",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConflictingDomainExists" => AssociateVPCWithHostedZoneError::ConflictingDomainExists(String::from(parsed_error.message)),
                    "InvalidInput" => AssociateVPCWithHostedZoneError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidVPCId" => AssociateVPCWithHostedZoneError::InvalidVPCId(String::from(parsed_error.message)),
                    "LimitsExceeded" => AssociateVPCWithHostedZoneError::LimitsExceeded(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => AssociateVPCWithHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "NotAuthorizedException" => AssociateVPCWithHostedZoneError::NotAuthorized(String::from(parsed_error.message)),
                    "PublicZoneVPCAssociation" => AssociateVPCWithHostedZoneError::PublicZoneVPCAssociation(String::from(parsed_error.message)),
...
impl ChangeResourceRecordSetsError {
    pub fn from_body(body: &str) -> ChangeResourceRecordSetsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidChangeBatch" => ChangeResourceRecordSetsError::InvalidChangeBatch(String::from(parsed_error.message)),
                    "InvalidInput" => ChangeResourceRecordSetsError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHealthCheck" => ChangeResourceRecordSetsError::NoSuchHealthCheck(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ChangeResourceRecordSetsError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => ChangeResourceRecordSetsError::PriorRequestNotComplete(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchHealthCheck" => ChangeTagsForResourceError::NoSuchHealthCheck(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ChangeTagsForResourceError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => ChangeTagsForResourceError::PriorRequestNotComplete(String::from(parsed_error.message)),
                    "ThrottlingException" => {
...
impl CreateHealthCheckError {
    pub fn from_body(body: &str) -> CreateHealthCheckError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HealthCheckAlreadyExists" => CreateHealthCheckError::HealthCheckAlreadyExists(String::from(parsed_error.message)),
                    "InvalidInput" => {
                        CreateHealthCheckError::InvalidInput(String::from(parsed_error.message))
                    }
                    "TooManyHealthChecks" => CreateHealthCheckError::TooManyHealthChecks(String::from(parsed_error.message)),
...
impl CreateHostedZoneError {
    pub fn from_body(body: &str) -> CreateHostedZoneError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConflictingDomainExists" => CreateHostedZoneError::ConflictingDomainExists(String::from(parsed_error.message)),
                    "DelegationSetNotAvailable" => CreateHostedZoneError::DelegationSetNotAvailable(String::from(parsed_error.message)),
                    "DelegationSetNotReusable" => CreateHostedZoneError::DelegationSetNotReusable(String::from(parsed_error.message)),
                    "HostedZoneAlreadyExists" => CreateHostedZoneError::HostedZoneAlreadyExists(String::from(parsed_error.message)),
                    "InvalidDomainName" => {
                    ...
                    "NoSuchDelegationSet" => CreateHostedZoneError::NoSuchDelegationSet(String::from(parsed_error.message)),
                    "TooManyHostedZones" => CreateHostedZoneError::TooManyHostedZones(String::from(parsed_error.message)),
...
impl CreateReusableDelegationSetError {
    pub fn from_body(body: &str) -> CreateReusableDelegationSetError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "DelegationSetAlreadyCreated" => CreateReusableDelegationSetError::DelegationSetAlreadyCreated(String::from(parsed_error.message)),
                    "DelegationSetAlreadyReusable" => CreateReusableDelegationSetError::DelegationSetAlreadyReusable(String::from(parsed_error.message)),
                    "DelegationSetNotAvailable" => CreateReusableDelegationSetError::DelegationSetNotAvailable(String::from(parsed_error.message)),
                    "HostedZoneNotFound" => CreateReusableDelegationSetError::HostedZoneNotFound(String::from(parsed_error.message)),
                    "InvalidArgument" => CreateReusableDelegationSetError::InvalidArgument(String::from(parsed_error.message)),
                    "InvalidInput" => CreateReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),
                    "LimitsExceeded" => CreateReusableDelegationSetError::LimitsExceeded(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "InvalidTrafficPolicyDocument" => CreateTrafficPolicyError::InvalidTrafficPolicyDocument(String::from(parsed_error.message)),
                    "TooManyTrafficPolicies" => CreateTrafficPolicyError::TooManyTrafficPolicies(String::from(parsed_error.message)),
                    "TrafficPolicyAlreadyExists" => CreateTrafficPolicyError::TrafficPolicyAlreadyExists(String::from(parsed_error.message)),
...
impl CreateTrafficPolicyInstanceError {
    pub fn from_body(body: &str) -> CreateTrafficPolicyInstanceError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => CreateTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => CreateTrafficPolicyInstanceError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => CreateTrafficPolicyInstanceError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
                    "TooManyTrafficPolicyInstances" => CreateTrafficPolicyInstanceError::TooManyTrafficPolicyInstances(String::from(parsed_error.message)),
                    "TrafficPolicyInstanceAlreadyExists" => CreateTrafficPolicyInstanceError::TrafficPolicyInstanceAlreadyExists(String::from(parsed_error.message)),
...
impl CreateTrafficPolicyVersionError {
    pub fn from_body(body: &str) -> CreateTrafficPolicyVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConcurrentModification" => CreateTrafficPolicyVersionError::ConcurrentModification(String::from(parsed_error.message)),
                    "InvalidInput" => CreateTrafficPolicyVersionError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidTrafficPolicyDocument" => CreateTrafficPolicyVersionError::InvalidTrafficPolicyDocument(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => CreateTrafficPolicyVersionError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
...
impl CreateVPCAssociationAuthorizationError {
    pub fn from_body(body: &str) -> CreateVPCAssociationAuthorizationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConcurrentModification" => CreateVPCAssociationAuthorizationError::ConcurrentModification(String::from(parsed_error.message)),
                    "InvalidInput" => CreateVPCAssociationAuthorizationError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidVPCId" => CreateVPCAssociationAuthorizationError::InvalidVPCId(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => CreateVPCAssociationAuthorizationError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "TooManyVPCAssociationAuthorizations" => CreateVPCAssociationAuthorizationError::TooManyVPCAssociationAuthorizations(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchHealthCheck" => DeleteHealthCheckError::NoSuchHealthCheck(String::from(parsed_error.message)),
...
impl DeleteHostedZoneError {
    pub fn from_body(body: &str) -> DeleteHostedZoneError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HostedZoneNotEmpty" => DeleteHostedZoneError::HostedZoneNotEmpty(String::from(parsed_error.message)),
                    "InvalidDomainName" => {
                    ...
                    "PriorRequestNotComplete" => DeleteHostedZoneError::PriorRequestNotComplete(String::from(parsed_error.message)),
...
impl DeleteReusableDelegationSetError {
    pub fn from_body(body: &str) -> DeleteReusableDelegationSetError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "DelegationSetInUse" => DeleteReusableDelegationSetError::DelegationSetInUse(String::from(parsed_error.message)),
                    "DelegationSetNotReusable" => DeleteReusableDelegationSetError::DelegationSetNotReusable(String::from(parsed_error.message)),
                    "InvalidInput" => DeleteReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchDelegationSet" => DeleteReusableDelegationSetError::NoSuchDelegationSet(String::from(parsed_error.message)),
...
impl DeleteTrafficPolicyError {
    pub fn from_body(body: &str) -> DeleteTrafficPolicyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConcurrentModification" => DeleteTrafficPolicyError::ConcurrentModification(String::from(parsed_error.message)),
                    "InvalidInput" => {
                        DeleteTrafficPolicyError::InvalidInput(String::from(parsed_error.message))
                    }
                    "NoSuchTrafficPolicy" => DeleteTrafficPolicyError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
                    "TrafficPolicyInUse" => DeleteTrafficPolicyError::TrafficPolicyInUse(String::from(parsed_error.message)),
...
impl DeleteTrafficPolicyInstanceError {
    pub fn from_body(body: &str) -> DeleteTrafficPolicyInstanceError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => DeleteTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => DeleteTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => DeleteTrafficPolicyInstanceError::PriorRequestNotComplete(String::from(parsed_error.message)),
...
impl DeleteVPCAssociationAuthorizationError {
    pub fn from_body(body: &str) -> DeleteVPCAssociationAuthorizationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConcurrentModification" => DeleteVPCAssociationAuthorizationError::ConcurrentModification(String::from(parsed_error.message)),
                    "InvalidInput" => DeleteVPCAssociationAuthorizationError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidVPCId" => DeleteVPCAssociationAuthorizationError::InvalidVPCId(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => DeleteVPCAssociationAuthorizationError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "VPCAssociationAuthorizationNotFound" => DeleteVPCAssociationAuthorizationError::VPCAssociationAuthorizationNotFound(String::from(parsed_error.message)),
...
impl DisassociateVPCFromHostedZoneError {
    pub fn from_body(body: &str) -> DisassociateVPCFromHostedZoneError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => DisassociateVPCFromHostedZoneError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidVPCId" => DisassociateVPCFromHostedZoneError::InvalidVPCId(String::from(parsed_error.message)),
                    "LastVPCAssociation" => DisassociateVPCFromHostedZoneError::LastVPCAssociation(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => DisassociateVPCFromHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "VPCAssociationNotFound" => DisassociateVPCFromHostedZoneError::VPCAssociationNotFound(String::from(parsed_error.message)),
    ...
    pub fn from_body(body: &str) -> GetChangeError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => {
                        GetChangeError::InvalidInput(String::from(parsed_error.message))
                    }
                    "NoSuchChange" => {
                        GetChangeError::NoSuchChange(String::from(parsed_error.message))
                    }
...
impl GetHealthCheckLastFailureReasonError {
    pub fn from_body(body: &str) -> GetHealthCheckLastFailureReasonError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => GetHealthCheckLastFailureReasonError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHealthCheck" => GetHealthCheckLastFailureReasonError::NoSuchHealthCheck(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchHealthCheck" => GetHealthCheckStatusError::NoSuchHealthCheck(String::from(parsed_error.message)),
...
impl GetReusableDelegationSetError {
    pub fn from_body(body: &str) -> GetReusableDelegationSetError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "DelegationSetNotReusable" => GetReusableDelegationSetError::DelegationSetNotReusable(String::from(parsed_error.message)),
                    "InvalidInput" => GetReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchDelegationSet" => GetReusableDelegationSetError::NoSuchDelegationSet(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchTrafficPolicy" => GetTrafficPolicyError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
...
impl GetTrafficPolicyInstanceError {
    pub fn from_body(body: &str) -> GetTrafficPolicyInstanceError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => GetTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => GetTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
...
impl ListHealthChecksError {
    pub fn from_body(body: &str) -> ListHealthChecksError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "IncompatibleVersion" => ListHealthChecksError::IncompatibleVersion(String::from(parsed_error.message)),
                    "InvalidInput" => {
...
impl ListHostedZonesError {
    pub fn from_body(body: &str) -> ListHostedZonesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "DelegationSetNotReusable" => ListHostedZonesError::DelegationSetNotReusable(String::from(parsed_error.message)),
                    "InvalidInput" => {
                        ListHostedZonesError::InvalidInput(String::from(parsed_error.message))
                    }
                    "NoSuchDelegationSet" => ListHostedZonesError::NoSuchDelegationSet(String::from(parsed_error.message)),
...
impl ListHostedZonesByNameError {
    pub fn from_body(body: &str) -> ListHostedZonesByNameError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidDomainName" => ListHostedZonesByNameError::InvalidDomainName(String::from(parsed_error.message)),
                    "InvalidInput" => {
...
impl ListResourceRecordSetsError {
    pub fn from_body(body: &str) -> ListResourceRecordSetsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListResourceRecordSetsError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ListResourceRecordSetsError::NoSuchHostedZone(String::from(parsed_error.message)),
...
impl ListReusableDelegationSetsError {
    pub fn from_body(body: &str) -> ListReusableDelegationSetsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListReusableDelegationSetsError::InvalidInput(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchHealthCheck" => ListTagsForResourceError::NoSuchHealthCheck(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ListTagsForResourceError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => ListTagsForResourceError::PriorRequestNotComplete(String::from(parsed_error.message)),
                    "ThrottlingException" => {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "NoSuchHealthCheck" => ListTagsForResourcesError::NoSuchHealthCheck(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ListTagsForResourcesError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => ListTagsForResourcesError::PriorRequestNotComplete(String::from(parsed_error.message)),
                    "ThrottlingException" => {
...
impl ListTrafficPolicyInstancesError {
    pub fn from_body(body: &str) -> ListTrafficPolicyInstancesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListTrafficPolicyInstancesError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => ListTrafficPolicyInstancesError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
...
impl ListTrafficPolicyInstancesByHostedZoneError {
    pub fn from_body(body: &str) -> ListTrafficPolicyInstancesByHostedZoneError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListTrafficPolicyInstancesByHostedZoneError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ListTrafficPolicyInstancesByHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => ListTrafficPolicyInstancesByHostedZoneError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
...
impl ListTrafficPolicyInstancesByPolicyError {
    pub fn from_body(body: &str) -> ListTrafficPolicyInstancesByPolicyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListTrafficPolicyInstancesByPolicyError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => ListTrafficPolicyInstancesByPolicyError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => ListTrafficPolicyInstancesByPolicyError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
...
impl ListTrafficPolicyVersionsError {
    pub fn from_body(body: &str) -> ListTrafficPolicyVersionsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListTrafficPolicyVersionsError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => ListTrafficPolicyVersionsError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
...
impl ListVPCAssociationAuthorizationsError {
    pub fn from_body(body: &str) -> ListVPCAssociationAuthorizationsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => ListVPCAssociationAuthorizationsError::InvalidInput(String::from(parsed_error.message)),
                    "InvalidPaginationToken" => ListVPCAssociationAuthorizationsError::InvalidPaginationToken(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => ListVPCAssociationAuthorizationsError::NoSuchHostedZone(String::from(parsed_error.message)),
...
impl UpdateHealthCheckError {
    pub fn from_body(body: &str) -> UpdateHealthCheckError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "HealthCheckVersionMismatch" => UpdateHealthCheckError::HealthCheckVersionMismatch(String::from(parsed_error.message)),
                    "InvalidInput" => {
                        UpdateHealthCheckError::InvalidInput(String::from(parsed_error.message))
                    }
                    "NoSuchHealthCheck" => UpdateHealthCheckError::NoSuchHealthCheck(String::from(parsed_error.message)),
...
impl UpdateHostedZoneCommentError {
    pub fn from_body(body: &str) -> UpdateHostedZoneCommentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidInput" => UpdateHostedZoneCommentError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchHostedZone" => UpdateHostedZoneCommentError::NoSuchHostedZone(String::from(parsed_error.message)),
...
impl UpdateTrafficPolicyCommentError {
    pub fn from_body(body: &str) -> UpdateTrafficPolicyCommentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConcurrentModification" => UpdateTrafficPolicyCommentError::ConcurrentModification(String::from(parsed_error.message)),
                    "InvalidInput" => UpdateTrafficPolicyCommentError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => UpdateTrafficPolicyCommentError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
...
impl UpdateTrafficPolicyInstanceError {
    pub fn from_body(body: &str) -> UpdateTrafficPolicyInstanceError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ConflictingTypes" => UpdateTrafficPolicyInstanceError::ConflictingTypes(String::from(parsed_error.message)),
                    "InvalidInput" => UpdateTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicy" => UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicy(String::from(parsed_error.message)),
                    "NoSuchTrafficPolicyInstance" => UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),
                    "PriorRequestNotComplete" => UpdateTrafficPolicyInstanceError::PriorRequestNotComplete(String::from(parsed_error.message)),
...
pub trait Route53 {
    ...
    #[doc="<p>Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com).</p>"]
    ...
    #[doc="<p>Deletes a traffic policy.</p>"]
    fn delete_traffic_policy(&self,
                             input: &DeleteTrafficPolicyRequest)
                             -> Result<DeleteTrafficPolicyResponse, DeleteTrafficPolicyError>;


    #[doc="<p>Deletes a traffic policy instance and all of the resource record sets that Amazon Route 53 created when you created the instance.</p> <note> <p>In the Amazon Route 53 console, traffic policy instances are known as policy records.</p> </note>"]
    ...
    #[doc="<p>Disassociates a VPC from a Amazon Route 53 private hosted zone. </p> <note> <p>You can't disassociate the last VPC from a private hosted zone.</p> </note> <important> <p>You can't disassociate a VPC from a private hosted zone when only one VPC is associated with the hosted zone. You also can't convert a private hosted zone into a public hosted zone.</p> </important>"]
    ...
    #[doc="<p>Gets the reason that a specified health check failed most recently.</p>"]
    ...
    #[doc="<p>Gets status of a specified health check. </p>"]
    ...
    #[doc="<p>Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.</p>"]
    fn get_hosted_zone(&self,
                       input: &GetHostedZoneRequest)
                       -> Result<GetHostedZoneResponse, GetHostedZoneError>;


    #[doc="<p>Retrieves the number of hosted zones that are associated with the current AWS account.</p>"]
    fn get_hosted_zone_count(&self,
                             input: &GetHostedZoneCountRequest)
                             -> Result<GetHostedZoneCountResponse, GetHostedZoneCountError>;


    #[doc="<p>Retrieves information about a specified reusable delegation set, including the four name servers that are assigned to the delegation set.</p>"]
    ...
    #[doc="<p>Gets the number of traffic policy instances that are associated with the current AWS account.</p>"]
    ...
    #[doc="<p>Retrieve a list of the health checks that are associated with the current AWS account. </p>"]
    ...
    #[doc="<p>Retrieves a list of the reusable delegation sets that are associated with the current AWS account.</p>"]
    ...
    #[doc="<p>Gets information about the latest version for every traffic policy that is associated with the current AWS account. Policies are listed in the order in which they were created. </p>"]
    ...
    #[doc="<p>Gets information about all of the versions for a specified traffic policy.</p> <p>Traffic policy versions are listed in numerical order by <code>VersionNumber</code>.</p>"]
    ...
    #[doc="<p>Updates the comment for a specified traffic policy version.</p>"]
