                    ...
                    match &name[..] {
                        "ApplicationName" => {
                            obj.application_name =
                                Some(try!(ApplicationNameDeserializer::deserialize("ApplicationName",
                                                                                   stack)));
                        }
                        ...
                        "DateCreated" => {
                            obj.date_created =
                                Some(try!(CreationDateDeserializer::deserialize("DateCreated",
                                                                                stack)));
                        }
                        "DateUpdated" => {
                            obj.date_updated =
                                Some(try!(UpdateDateDeserializer::deserialize("DateUpdated",
                                                                              stack)));
                        }
                        "Description" => {
                            obj.description =
                        ...
                        "Versions" => {
                            obj.versions =
                                Some(try!(VersionLabelsListDeserializer::deserialize("Versions",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ApplicationDescriptionDeserializer::deserialize("member",
                                                                                      stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Application" => {
                            obj.application =
                                Some(try!(ApplicationDescriptionDeserializer::deserialize("Application",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Duration" => {
                            obj.duration =
                                Some(try!(NullableIntegerDeserializer::deserialize("Duration",
                                                                                   stack)));
                        }
                        "Latency" => {
                            obj.latency = Some(try!(LatencyDeserializer::deserialize("Latency",
                                                                                     stack)));
                        }
                        "RequestCount" => {
                            obj.request_count =
                                Some(try!(RequestCountDeserializer::deserialize("RequestCount",
                                                                                stack)));
                        }
                        "StatusCodes" => {
                            obj.status_codes =
                                Some(try!(StatusCodesDeserializer::deserialize("StatusCodes",
                                                                               stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ServiceRole" => {
                            obj.service_role = Some(try!(StringDeserializer::deserialize("ServiceRole",
                                                                                         stack)));
                        }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "BuildArn" => {
                            obj.build_arn = Some(try!(StringDeserializer::deserialize("BuildArn",
                                                                                      stack)));
                        }
                        "DateCreated" => {
                            obj.date_created =
                        ...
                        "SourceBuildInformation" => {
                            obj.source_build_information =
                                Some(try!(SourceBuildInformationDeserializer::deserialize("SourceBuildInformation",
                                                                                          stack)));
                        }
                        "SourceBundle" => {
                            obj.source_bundle =
                                Some(try!(S3LocationDeserializer::deserialize("SourceBundle",
                                                                              stack)));
                        }
                        "Status" => {
                        ...
                        "VersionLabel" => {
                            obj.version_label =
                                Some(try!(VersionLabelDeserializer::deserialize("VersionLabel",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "MaxAgeRule" => {
                            obj.max_age_rule =
                                Some(try!(MaxAgeRuleDeserializer::deserialize("MaxAgeRule",
                                                                              stack)));
                        }
                        "MaxCountRule" => {
                            obj.max_count_rule =
                                Some(try!(MaxCountRuleDeserializer::deserialize("MaxCountRule",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl ApplicationVersionLifecycleConfigSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &ApplicationVersionLifecycleConfig) {
        ...
        if let Some(ref field_value) = obj.max_age_rule {
            MaxAgeRuleSerializer::serialize(params,
                                            &format!("{}{}", prefix, "MaxAgeRule"),
                                            field_value);
        }
        if let Some(ref field_value) = obj.max_count_rule {
            MaxCountRuleSerializer::serialize(params,
                    ...
                    match &name[..] {
                        "ActionDescription" => {
                            obj.action_description =
                                Some(try!(StringDeserializer::deserialize("ActionDescription",
                                                                          stack)));
                        }
                        "ActionId" => {
                            obj.action_id = Some(try!(StringDeserializer::deserialize("ActionId",
                                                                                      stack)));
                        }
                        "ActionType" => {
                            obj.action_type =
                                Some(try!(ActionTypeDeserializer::deserialize("ActionType",
                                                                              stack)));
                        }
                        "Status" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Name" => {
                            obj.name = Some(try!(ResourceIdDeserializer::deserialize("Name",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(SolutionStackDescriptionDeserializer::deserialize("member",
                                                                                        stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "IOWait" => {
                            obj.io_wait =
                                Some(try!(NullableDoubleDeserializer::deserialize("IOWait",
                                                                                  stack)));
                        }
                        "IRQ" => {
                            obj.irq = Some(try!(NullableDoubleDeserializer::deserialize("IRQ",
                                                                                        stack)));
                        }
                        "Idle" => {
                            obj.idle = Some(try!(NullableDoubleDeserializer::deserialize("Idle",
                                                                                         stack)));
                        }
                        "Nice" => {
                            obj.nice = Some(try!(NullableDoubleDeserializer::deserialize("Nice",
                                                                                         stack)));
                        }
                        "SoftIRQ" => {
                            obj.soft_irq =
                                Some(try!(NullableDoubleDeserializer::deserialize("SoftIRQ",
                                                                                  stack)));
                        }
                        "System" => {
                            obj.system = Some(try!(NullableDoubleDeserializer::deserialize("System",
                                                                                           stack)));
                        }
                        "User" => {
                            obj.user = Some(try!(NullableDoubleDeserializer::deserialize("User",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Available" => {
                            obj.available =
                                Some(try!(CnameAvailabilityDeserializer::deserialize("Available",
                                                                                     stack)));
                        }
                        "FullyQualifiedCNAME" => {
                            obj.fully_qualified_cname =
                                Some(try!(DNSCnameDeserializer::deserialize("FullyQualifiedCNAME",
                                                                            stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Name" => {
                            obj.name =
                                Some(try!(ConfigurationOptionNameDeserializer::deserialize("Name",
                                                                                           stack)));
                        }
                        "Namespace" => {
                            obj.namespace =
                                Some(try!(OptionNamespaceDeserializer::deserialize("Namespace",
                                                                                   stack)));
                        }
                        "Regex" => {
                            obj.regex =
                                Some(try!(OptionRestrictionRegexDeserializer::deserialize("Regex",
                                                                                          stack)));
                        }
                        "UserDefined" => {
                            obj.user_defined =
                                Some(try!(UserDefinedOptionDeserializer::deserialize("UserDefined",
                                                                                     stack)));
                        }
                        "ValueOptions" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "OptionName" => {
                            obj.option_name =
                                Some(try!(ConfigurationOptionNameDeserializer::deserialize("OptionName",
                                                                                           stack)));
                        }
                        "ResourceName" => {
                            obj.resource_name =
                                Some(try!(ResourceNameDeserializer::deserialize("ResourceName",
                                                                                stack)));
                        }
                        "Value" => {
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ConfigurationOptionSettingDeserializer::deserialize("member",
                                                                                          stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "PlatformArn" => {
                            obj.platform_arn =
                                Some(try!(PlatformArnDeserializer::deserialize("PlatformArn",
                                                                               stack)));
                        }
                        "SolutionStackName" => {
                            obj.solution_stack_name =
                                Some(try!(SolutionStackNameDeserializer::deserialize("SolutionStackName",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "EnvironmentName" => {
                            obj.environment_name =
                                Some(try!(EnvironmentNameDeserializer::deserialize("EnvironmentName",
                                                                                   stack)));
                        }
                        "OptionSettings" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Messages" => {
                            obj.messages =
                                Some(try!(ValidationMessagesListDeserializer::deserialize("Messages",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ConfigurationTemplateNameDeserializer::deserialize("member",
                                                                                         stack)));
                    } else {
                        skip_tree(stack);
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Builder" => {
                            obj.builder = Some(try!(BuilderDeserializer::deserialize("Builder",
                                                                                     stack)));
                        }
                        "PlatformSummary" => {
                            obj.platform_summary =
                                Some(try!(PlatformSummaryDeserializer::deserialize("PlatformSummary",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "S3Bucket" => {
                            obj.s3_bucket = Some(try!(S3BucketDeserializer::deserialize("S3Bucket",
                                                                                        stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ImageId" => {
                            obj.image_id = Some(try!(ImageIdDeserializer::deserialize("ImageId",
                                                                                      stack)));
                        }
                        "VirtualizationType" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "DeploymentTime" => {
                            obj.deployment_time =
                                Some(try!(DeploymentTimestampDeserializer::deserialize("DeploymentTime",
                                                                                       stack)));
                        }
                        "Status" => {
                            obj.status = Some(try!(StringDeserializer::deserialize("Status",
                        ...
                        "VersionLabel" => {
                            obj.version_label = Some(try!(StringDeserializer::deserialize("VersionLabel",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl DescribeApplicationsMessageSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeApplicationsMessage) {
        ...
        if let Some(ref field_value) = obj.application_names {
            ApplicationNamesListSerializer::serialize(params,
...
impl DescribeEnvironmentHealthRequestSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeEnvironmentHealthRequest) {
        ...
        if let Some(ref field_value) = obj.attribute_names {
            EnvironmentHealthAttributesSerializer::serialize(params,
                                                             &format!("{}{}",
                                                                     prefix,
                                                                     "AttributeNames"),
                                                             field_value);
                    ...
                    match &name[..] {
                        "ApplicationMetrics" => {
                            obj.application_metrics =
                                Some(try!(ApplicationMetricsDeserializer::deserialize("ApplicationMetrics",
                                                                                      stack)));
                        }
                        "Causes" => {
                            obj.causes = Some(try!(CausesDeserializer::deserialize("Causes",
                                                                                   stack)));
                        }
                        "Color" => {
                        ...
                        "HealthStatus" => {
                            obj.health_status = Some(try!(StringDeserializer::deserialize("HealthStatus",
                                                                                          stack)));
                        }
                        "InstancesHealth" => {
                            obj.instances_health =
                                Some(try!(InstanceHealthSummaryDeserializer::deserialize("InstancesHealth",
                                                                                         stack)));
                        }
                        "RefreshedAt" => {
                            obj.refreshed_at =
                                Some(try!(RefreshedAtDeserializer::deserialize("RefreshedAt",
                                                                               stack)));
                        }
                        "Status" => {
                            obj.status =
                                Some(try!(EnvironmentHealthDeserializer::deserialize("Status",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ManagedActions" => {
                            obj.managed_actions =
                                Some(try!(ManagedActionsDeserializer::deserialize("ManagedActions",
                                                                                  stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl DescribeEnvironmentsMessageSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeEnvironmentsMessage) {
        ...
        if let Some(ref field_value) = obj.environment_names {
            EnvironmentNamesListSerializer::serialize(params,
...
impl DescribeInstancesHealthRequestSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeInstancesHealthRequest) {
        ...
        if let Some(ref field_value) = obj.attribute_names {
            InstancesHealthAttributesSerializer::serialize(params,
                                                           &format!("{}{}",
                                                                   prefix,
                                                                   "AttributeNames"),
                                                           field_value);
                    ...
                    match &name[..] {
                        "InstanceHealthList" => {
                            obj.instance_health_list =
                                Some(try!(InstanceHealthListDeserializer::deserialize("InstanceHealthList",
                                                                                      stack)));
                        }
                        "NextToken" => {
                    ...
                    match &name[..] {
                        "PlatformDescription" => {
                            obj.platform_description =
                                Some(try!(PlatformDescriptionDeserializer::deserialize("PlatformDescription",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "CNAME" => {
                            obj.cname = Some(try!(DNSCnameDeserializer::deserialize("CNAME",
                                                                                    stack)));
                        }
                        "DateCreated" => {
                            obj.date_created =
                        ...
                        "EnvironmentId" => {
                            obj.environment_id =
                                Some(try!(EnvironmentIdDeserializer::deserialize("EnvironmentId",
                                                                                 stack)));
                        }
                        "EnvironmentLinks" => {
                            obj.environment_links =
                                Some(try!(EnvironmentLinksDeserializer::deserialize("EnvironmentLinks",
                                                                                    stack)));
                        }
                        "EnvironmentName" => {
                            obj.environment_name =
                        ...
                        "Health" => {
                            obj.health =
                                Some(try!(EnvironmentHealthDeserializer::deserialize("Health",
                                                                                     stack)));
                        }
                        "HealthStatus" => {
                            obj.health_status =
                                Some(try!(EnvironmentHealthStatusDeserializer::deserialize("HealthStatus",
                                                                                           stack)));
                        }
                        "PlatformArn" => {
                            obj.platform_arn =
                        ...
                        "Status" => {
                            obj.status =
                                Some(try!(EnvironmentStatusDeserializer::deserialize("Status",
                                                                                     stack)));
                        }
                        "TemplateName" => {
                            obj.template_name = Some(try!(ConfigurationTemplateNameDeserializer::deserialize("TemplateName", stack)));
                        ...
                        "Tier" => {
                            obj.tier = Some(try!(EnvironmentTierDeserializer::deserialize("Tier",
                                                                                          stack)));
                        }
                        "VersionLabel" => {
                            obj.version_label =
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(EnvironmentDescriptionDeserializer::deserialize("member",
                                                                                      stack)));
                    } else {
                        skip_tree(stack);
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Ec2InstanceId" => {
                            obj.ec_2_instance_id =
                                Some(try!(Ec2InstanceIdDeserializer::deserialize("Ec2InstanceId",
                                                                                 stack)));
                        }
                        "InfoType" => {
                            obj.info_type =
                                Some(try!(EnvironmentInfoTypeDeserializer::deserialize("InfoType",
                                                                                       stack)));
                        }
                        "Message" => {
                        ...
                        "SampleTimestamp" => {
                            obj.sample_timestamp =
                                Some(try!(SampleTimestampDeserializer::deserialize("SampleTimestamp",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(EnvironmentInfoDescriptionDeserializer::deserialize("member",
                                                                                          stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "EnvironmentName" => {
                            obj.environment_name =
                                Some(try!(StringDeserializer::deserialize("EnvironmentName",
                                                                          stack)));
                        }
                        "LinkName" => {
                            obj.link_name = Some(try!(StringDeserializer::deserialize("LinkName",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        "AutoScalingGroups" => {
                            obj.auto_scaling_groups =
                                Some(try!(AutoScalingGroupListDeserializer::deserialize("AutoScalingGroups",
                                                                                        stack)));
                        }
                        "EnvironmentName" => {
                            obj.environment_name =
                        ...
                        "Instances" => {
                            obj.instances =
                                Some(try!(InstanceListDeserializer::deserialize("Instances",
                                                                                stack)));
                        }
                        "LaunchConfigurations" => {
                            obj.launch_configurations =
                                Some(try!(LaunchConfigurationListDeserializer::deserialize("LaunchConfigurations",
                                                                                           stack)));
                        }
                        "LoadBalancers" => {
                            obj.load_balancers =
                                Some(try!(LoadBalancerListDeserializer::deserialize("LoadBalancers",
                                                                                    stack)));
                        }
                        "Queues" => {
                            obj.queues = Some(try!(QueueListDeserializer::deserialize("Queues",
                                                                                      stack)));
                        }
                        "Triggers" => {
                            obj.triggers = Some(try!(TriggerListDeserializer::deserialize("Triggers",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LoadBalancer" => {
                            obj.load_balancer =
                                Some(try!(LoadBalancerDescriptionDeserializer::deserialize("LoadBalancer",
                                                                                           stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "EventDate" => {
                            obj.event_date = Some(try!(EventDateDeserializer::deserialize("EventDate",
                                                                                          stack)));
                        }
                        "Message" => {
                            obj.message = Some(try!(EventMessageDeserializer::deserialize("Message",
                                                                                          stack)));
                        }
                        "PlatformArn" => {
                            obj.platform_arn =
                        ...
                        "RequestId" => {
                            obj.request_id = Some(try!(RequestIdDeserializer::deserialize("RequestId",
                                                                                          stack)));
                        }
                        "Severity" => {
                            obj.severity =
                                Some(try!(EventSeverityDeserializer::deserialize("Severity",
                                                                                 stack)));
                        }
                        "TemplateName" => {
                            obj.template_name = Some(try!(ConfigurationTemplateNameDeserializer::deserialize("TemplateName", stack)));
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Events" => {
                            obj.events =
                                Some(try!(EventDescriptionListDeserializer::deserialize("Events",
                                                                                        stack)));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(TokenDeserializer::deserialize("NextToken",
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(SingleInstanceHealthDeserializer::deserialize("member",
                                                                                    stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Degraded" => {
                            obj.degraded =
                                Some(try!(NullableIntegerDeserializer::deserialize("Degraded",
                                                                                   stack)));
                        }
                        "Info" => {
                            obj.info = Some(try!(NullableIntegerDeserializer::deserialize("Info",
                                                                                          stack)));
                        }
                        "NoData" => {
                            obj.no_data =
                                Some(try!(NullableIntegerDeserializer::deserialize("NoData",
                                                                                   stack)));
                        }
                        "Ok" => {
                            obj.ok = Some(try!(NullableIntegerDeserializer::deserialize("Ok",
                                                                                        stack)));
                        }
                        "Pending" => {
                            obj.pending =
                                Some(try!(NullableIntegerDeserializer::deserialize("Pending",
                                                                                   stack)));
                        }
                        "Severe" => {
                            obj.severe =
                                Some(try!(NullableIntegerDeserializer::deserialize("Severe",
                                                                                   stack)));
                        }
                        "Unknown" => {
                            obj.unknown =
                                Some(try!(NullableIntegerDeserializer::deserialize("Unknown",
                                                                                   stack)));
                        }
                        "Warning" => {
                            obj.warning =
                                Some(try!(NullableIntegerDeserializer::deserialize("Warning",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "P10" => {
                            obj.p10 = Some(try!(NullableDoubleDeserializer::deserialize("P10",
                                                                                        stack)));
                        }
                        "P50" => {
                            obj.p50 = Some(try!(NullableDoubleDeserializer::deserialize("P50",
                                                                                        stack)));
                        }
                        "P75" => {
                            obj.p75 = Some(try!(NullableDoubleDeserializer::deserialize("P75",
                                                                                        stack)));
                        }
                        "P85" => {
                            obj.p85 = Some(try!(NullableDoubleDeserializer::deserialize("P85",
                                                                                        stack)));
                        }
                        "P90" => {
                            obj.p90 = Some(try!(NullableDoubleDeserializer::deserialize("P90",
                                                                                        stack)));
                        }
                        "P95" => {
                            obj.p95 = Some(try!(NullableDoubleDeserializer::deserialize("P95",
                                                                                        stack)));
                        }
                        "P99" => {
                            obj.p99 = Some(try!(NullableDoubleDeserializer::deserialize("P99",
                                                                                        stack)));
                        }
                        "P999" => {
                            obj.p999 = Some(try!(NullableDoubleDeserializer::deserialize("P999",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl ListPlatformVersionsRequestSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &ListPlatformVersionsRequest) {
        ...
        if let Some(ref field_value) = obj.filters {
            PlatformFiltersSerializer::serialize(params,
                    ...
                    match &name[..] {
                        ...
                        "PlatformSummaryList" => {
                            obj.platform_summary_list =
                                Some(try!(PlatformSummaryListDeserializer::deserialize("PlatformSummaryList",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "LoadBalancerName" => {
                            obj.load_balancer_name =
                                Some(try!(StringDeserializer::deserialize("LoadBalancerName",
                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Status" => {
                            obj.status = Some(try!(ActionStatusDeserializer::deserialize("Status",
                                                                                         stack)));
                        }
                        "WindowStartTime" => {
                            obj.window_start_time =
                                Some(try!(TimestampDeserializer::deserialize("WindowStartTime",
                                                                             stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ExecutedTime" => {
                            obj.executed_time =
                                Some(try!(TimestampDeserializer::deserialize("ExecutedTime",
                                                                             stack)));
                        }
                        "FailureDescription" => {
                            obj.failure_description =
                                Some(try!(StringDeserializer::deserialize("FailureDescription",
                                                                          stack)));
                        }
                        "FailureType" => {
                            obj.failure_type =
                                Some(try!(FailureTypeDeserializer::deserialize("FailureType",
                                                                               stack)));
                        }
                        "FinishedTime" => {
                            obj.finished_time =
                                Some(try!(TimestampDeserializer::deserialize("FinishedTime",
                                                                             stack)));
                        }
                        "Status" => {
                            obj.status =
                                Some(try!(ActionHistoryStatusDeserializer::deserialize("Status",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ManagedActionHistoryItemDeserializer::deserialize("member",
                                                                                        stack)));
                    } else {
                        skip_tree(stack);
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DeleteSourceFromS3" => {
                            obj.delete_source_from_s3 =
                                Some(try!(BoxedBooleanDeserializer::deserialize("DeleteSourceFromS3",
                                                                                stack)));
                        }
                        "Enabled" => {
                            obj.enabled = try!(BoxedBooleanDeserializer::deserialize("Enabled",
                                                                                     stack));
                        }
                        "MaxAgeInDays" => {
                            obj.max_age_in_days =
                                Some(try!(BoxedIntDeserializer::deserialize("MaxAgeInDays",
                                                                            stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Label" => {
                            obj.label = Some(try!(RegexLabelDeserializer::deserialize("Label",
                                                                                      stack)));
                        }
                        "Pattern" => {
                            obj.pattern = Some(try!(RegexPatternDeserializer::deserialize("Pattern",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CustomAmiList" => {
                            obj.custom_ami_list =
                                Some(try!(CustomAmiListDeserializer::deserialize("CustomAmiList",
                                                                                 stack)));
                        }
                        "DateCreated" => {
                            obj.date_created =
                        ...
                        "Frameworks" => {
                            obj.frameworks =
                                Some(try!(PlatformFrameworksDeserializer::deserialize("Frameworks",
                                                                                      stack)));
                        }
                        "Maintainer" => {
                            obj.maintainer = Some(try!(MaintainerDeserializer::deserialize("Maintainer",
                                                                                           stack)));
                        }
                        "OperatingSystemName" => {
                            obj.operating_system_name =
                                Some(try!(OperatingSystemNameDeserializer::deserialize("OperatingSystemName",
                                                                                       stack)));
                        }
                        "OperatingSystemVersion" => {
                            obj.operating_system_version =
                                Some(try!(OperatingSystemVersionDeserializer::deserialize("OperatingSystemVersion",
                                                                                          stack)));
                        }
                        "PlatformArn" => {
                            obj.platform_arn =
                        ...
                        "PlatformCategory" => {
                            obj.platform_category =
                                Some(try!(PlatformCategoryDeserializer::deserialize("PlatformCategory",
                                                                                    stack)));
                        }
                        "PlatformName" => {
                            obj.platform_name =
                                Some(try!(PlatformNameDeserializer::deserialize("PlatformName",
                                                                                stack)));
                        }
                        "PlatformOwner" => {
                            obj.platform_owner =
                                Some(try!(PlatformOwnerDeserializer::deserialize("PlatformOwner",
                                                                                 stack)));
                        }
                        "PlatformStatus" => {
                            obj.platform_status =
                                Some(try!(PlatformStatusDeserializer::deserialize("PlatformStatus",
                                                                                  stack)));
                        }
                        "PlatformVersion" => {
                            obj.platform_version =
                                Some(try!(PlatformVersionDeserializer::deserialize("PlatformVersion",
                                                                                   stack)));
                        }
                        ...
                        "SupportedAddonList" => {
                            obj.supported_addon_list =
                                Some(try!(SupportedAddonListDeserializer::deserialize("SupportedAddonList",
                                                                                      stack)));
                        }
                        "SupportedTierList" => {
                            obj.supported_tier_list =
                                Some(try!(SupportedTierListDeserializer::deserialize("SupportedTierList",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "Deployment" => {
                            obj.deployment = Some(try!(DeploymentDeserializer::deserialize("Deployment",
                                                                                           stack)));
                        }
                        "HealthStatus" => {
                            obj.health_status = Some(try!(StringDeserializer::deserialize("HealthStatus",
                        ...
                        "LaunchedAt" => {
                            obj.launched_at =
                                Some(try!(LaunchedAtDeserializer::deserialize("LaunchedAt",
                                                                              stack)));
                        }
                        "System" => {
                            obj.system = Some(try!(SystemStatusDeserializer::deserialize("System",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "SourceLocation" => {
                            obj.source_location =
                                try!(SourceLocationDeserializer::deserialize("SourceLocation",
                                                                             stack));
                        }
                        "SourceRepository" => {
                            obj.source_repository =
                                try!(SourceRepositoryDeserializer::deserialize("SourceRepository",
                                                                               stack));
                        }
                        "SourceType" => {
                            obj.source_type = try!(SourceTypeDeserializer::deserialize("SourceType",
                                                                                       stack));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Status2xx" => {
                            obj.status_2xx =
                                Some(try!(NullableIntegerDeserializer::deserialize("Status2xx",
                                                                                   stack)));
                        }
                        "Status3xx" => {
                            obj.status_3xx =
                                Some(try!(NullableIntegerDeserializer::deserialize("Status3xx",
                                                                                   stack)));
                        }
                        "Status4xx" => {
                            obj.status_4xx =
                                Some(try!(NullableIntegerDeserializer::deserialize("Status4xx",
                                                                                   stack)));
                        }
                        "Status5xx" => {
                            obj.status_5xx =
                                Some(try!(NullableIntegerDeserializer::deserialize("Status5xx",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CPUUtilization" => {
                            obj.cpu_utilization =
                                Some(try!(CPUUtilizationDeserializer::deserialize("CPUUtilization",
                                                                                  stack)));
                        }
                        "LoadAverage" => {
                            obj.load_average =
                                Some(try!(LoadAverageDeserializer::deserialize("LoadAverage",
                                                                               stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Message" => {
                            obj.message =
                                Some(try!(ValidationMessageStringDeserializer::deserialize("Message",
                                                                                           stack)));
                        }
                        "Namespace" => {
                            obj.namespace =
                        ...
                        "Severity" => {
                            obj.severity =
                                Some(try!(ValidationSeverityDeserializer::deserialize("Severity",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => AbortEnvironmentUpdateError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl ApplyEnvironmentManagedActionError {
    pub fn from_body(body: &str) -> ApplyEnvironmentManagedActionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => ApplyEnvironmentManagedActionError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "ManagedActionInvalidStateException" => ApplyEnvironmentManagedActionError::ManagedActionInvalidState(String::from(parsed_error.message)),
...
impl ComposeEnvironmentsError {
    pub fn from_body(body: &str) -> ComposeEnvironmentsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => ComposeEnvironmentsError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyEnvironmentsException" => ComposeEnvironmentsError::TooManyEnvironments(String::from(parsed_error.message)),
...
impl CreateApplicationError {
    pub fn from_body(body: &str) -> CreateApplicationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "TooManyApplicationsException" => CreateApplicationError::TooManyApplications(String::from(parsed_error.message)),
...
impl CreateApplicationVersionError {
    pub fn from_body(body: &str) -> CreateApplicationVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "CodeBuildNotInServiceRegionException" => CreateApplicationVersionError::CodeBuildNotInServiceRegion(String::from(parsed_error.message)),
                    "InsufficientPrivilegesException" => CreateApplicationVersionError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "S3LocationNotInServiceRegionException" => CreateApplicationVersionError::S3LocationNotInServiceRegion(String::from(parsed_error.message)),
                    "TooManyApplicationVersionsException" => CreateApplicationVersionError::TooManyApplicationVersions(String::from(parsed_error.message)),
                    "TooManyApplicationsException" => CreateApplicationVersionError::TooManyApplications(String::from(parsed_error.message)),
...
impl CreateConfigurationTemplateError {
    pub fn from_body(body: &str) -> CreateConfigurationTemplateError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => CreateConfigurationTemplateError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyBucketsException" => CreateConfigurationTemplateError::TooManyBuckets(String::from(parsed_error.message)),
                    "TooManyConfigurationTemplatesException" => CreateConfigurationTemplateError::TooManyConfigurationTemplates(String::from(parsed_error.message)),
...
impl CreateEnvironmentError {
    pub fn from_body(body: &str) -> CreateEnvironmentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => CreateEnvironmentError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyEnvironmentsException" => CreateEnvironmentError::TooManyEnvironments(String::from(parsed_error.message)),
...
impl CreatePlatformVersionError {
    pub fn from_body(body: &str) -> CreatePlatformVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => CreatePlatformVersionError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InsufficientPrivilegesException" => CreatePlatformVersionError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyPlatformsException" => CreatePlatformVersionError::TooManyPlatforms(String::from(parsed_error.message)),
...
impl CreateStorageLocationError {
    pub fn from_body(body: &str) -> CreateStorageLocationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => CreateStorageLocationError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "S3SubscriptionRequiredException" => CreateStorageLocationError::S3SubscriptionRequired(String::from(parsed_error.message)),
                    "TooManyBucketsException" => CreateStorageLocationError::TooManyBuckets(String::from(parsed_error.message)),
...
impl DeleteApplicationError {
    pub fn from_body(body: &str) -> DeleteApplicationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "OperationInProgressException" => DeleteApplicationError::OperationInProgress(String::from(parsed_error.message)),
...
impl DeleteApplicationVersionError {
    pub fn from_body(body: &str) -> DeleteApplicationVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => DeleteApplicationVersionError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "OperationInProgressException" => DeleteApplicationVersionError::OperationInProgress(String::from(parsed_error.message)),
                    "S3LocationNotInServiceRegionException" => DeleteApplicationVersionError::S3LocationNotInServiceRegion(String::from(parsed_error.message)),
                    "SourceBundleDeletionException" => DeleteApplicationVersionError::SourceBundleDeletion(String::from(parsed_error.message)),
...
impl DeleteConfigurationTemplateError {
    pub fn from_body(body: &str) -> DeleteConfigurationTemplateError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "OperationInProgressException" => DeleteConfigurationTemplateError::OperationInProgress(String::from(parsed_error.message)),
...
impl DeletePlatformVersionError {
    pub fn from_body(body: &str) -> DeletePlatformVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DeletePlatformVersionError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InsufficientPrivilegesException" => DeletePlatformVersionError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "OperationInProgressException" => DeletePlatformVersionError::OperationInProgress(String::from(parsed_error.message)),
                    "PlatformVersionStillReferencedException" => DeletePlatformVersionError::PlatformVersionStillReferenced(String::from(parsed_error.message)),
...
impl DescribeConfigurationOptionsError {
    pub fn from_body(body: &str) -> DescribeConfigurationOptionsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "TooManyBucketsException" => DescribeConfigurationOptionsError::TooManyBuckets(String::from(parsed_error.message)),
...
impl DescribeConfigurationSettingsError {
    pub fn from_body(body: &str) -> DescribeConfigurationSettingsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "TooManyBucketsException" => DescribeConfigurationSettingsError::TooManyBuckets(String::from(parsed_error.message)),
...
impl DescribeEnvironmentHealthError {
    pub fn from_body(body: &str) -> DescribeEnvironmentHealthError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DescribeEnvironmentHealthError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InvalidRequestException" => DescribeEnvironmentHealthError::InvalidRequest(String::from(parsed_error.message)),
...
impl DescribeEnvironmentManagedActionHistoryError {
    pub fn from_body(body: &str) -> DescribeEnvironmentManagedActionHistoryError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DescribeEnvironmentManagedActionHistoryError::ElasticBeanstalkService(String::from(parsed_error.message)),
...
impl DescribeEnvironmentManagedActionsError {
    pub fn from_body(body: &str) -> DescribeEnvironmentManagedActionsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DescribeEnvironmentManagedActionsError::ElasticBeanstalkService(String::from(parsed_error.message)),
...
impl DescribeEnvironmentResourcesError {
    pub fn from_body(body: &str) -> DescribeEnvironmentResourcesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => DescribeEnvironmentResourcesError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl DescribeInstancesHealthError {
    pub fn from_body(body: &str) -> DescribeInstancesHealthError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DescribeInstancesHealthError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InvalidRequestException" => DescribeInstancesHealthError::InvalidRequest(String::from(parsed_error.message)),
...
impl DescribePlatformVersionError {
    pub fn from_body(body: &str) -> DescribePlatformVersionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => DescribePlatformVersionError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InsufficientPrivilegesException" => DescribePlatformVersionError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl ListPlatformVersionsError {
    pub fn from_body(body: &str) -> ListPlatformVersionsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ElasticBeanstalkServiceException" => ListPlatformVersionsError::ElasticBeanstalkService(String::from(parsed_error.message)),
                    "InsufficientPrivilegesException" => ListPlatformVersionsError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl RebuildEnvironmentError {
    pub fn from_body(body: &str) -> RebuildEnvironmentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => RebuildEnvironmentError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl TerminateEnvironmentError {
    pub fn from_body(body: &str) -> TerminateEnvironmentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => TerminateEnvironmentError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl UpdateApplicationResourceLifecycleError {
    pub fn from_body(body: &str) -> UpdateApplicationResourceLifecycleError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => UpdateApplicationResourceLifecycleError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl UpdateConfigurationTemplateError {
    pub fn from_body(body: &str) -> UpdateConfigurationTemplateError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => UpdateConfigurationTemplateError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyBucketsException" => UpdateConfigurationTemplateError::TooManyBuckets(String::from(parsed_error.message)),
...
impl UpdateEnvironmentError {
    pub fn from_body(body: &str) -> UpdateEnvironmentError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => UpdateEnvironmentError::InsufficientPrivileges(String::from(parsed_error.message)),
...
impl ValidateConfigurationSettingsError {
    pub fn from_body(body: &str) -> ValidateConfigurationSettingsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InsufficientPrivilegesException" => ValidateConfigurationSettingsError::InsufficientPrivileges(String::from(parsed_error.message)),
                    "TooManyBucketsException" => ValidateConfigurationSettingsError::TooManyBuckets(String::from(parsed_error.message)),
...
pub struct ElasticBeanstalkClient<P, D>
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(EnvironmentDescriptionsMessageDeserializer::deserialize("ComposeEnvironmentsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ApplicationDescriptionMessageDeserializer::deserialize("CreateApplicationResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ConfigurationSettingsDescriptionDeserializer::deserialize("CreateConfigurationTemplateResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EnvironmentDescriptionDeserializer::deserialize("CreateEnvironmentResult",
                                                                                  &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(CreatePlatformVersionResultDeserializer::deserialize("CreatePlatformVersionResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DeletePlatformVersionResultDeserializer::deserialize("DeletePlatformVersionResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ApplicationDescriptionsMessageDeserializer::deserialize("DescribeApplicationsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ConfigurationOptionsDescriptionDeserializer::deserialize("DescribeConfigurationOptionsResult",
                                                                                      &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeEnvironmentHealthResultDeserializer::deserialize("DescribeEnvironmentHealthResult",
                                                                                      &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
...
fn describe_environment_managed_action_history(&self, input: &DescribeEnvironmentManagedActionHistoryRequest) -> Result<DescribeEnvironmentManagedActionHistoryResult, DescribeEnvironmentManagedActionHistoryError>{
        ...
        params.put("Version", "2010-12-01");
        DescribeEnvironmentManagedActionHistoryRequestSerializer::serialize(&mut params,
                                                                            "",
                                                                            &input);
        request.set_params(params);
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(EnvironmentDescriptionsMessageDeserializer::deserialize("DescribeEnvironmentsResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EventDescriptionsMessageDeserializer::deserialize("DescribeEventsResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeInstancesHealthResultDeserializer::deserialize("DescribeInstancesHealthResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribePlatformVersionResultDeserializer::deserialize("DescribePlatformVersionResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ListPlatformVersionsResultDeserializer::deserialize("ListPlatformVersionsResult",
                                                                                      &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EnvironmentDescriptionDeserializer::deserialize("TerminateEnvironmentResult",
                                                                                  &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ApplicationDescriptionMessageDeserializer::deserialize("UpdateApplicationResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(ConfigurationSettingsDescriptionDeserializer::deserialize("UpdateConfigurationTemplateResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EnvironmentDescriptionDeserializer::deserialize("UpdateEnvironmentResult",
                                                                                  &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
