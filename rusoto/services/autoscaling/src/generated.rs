        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activities" => {
                            obj.activities = try!(ActivitiesDeserializer::deserialize("Activities",
                                                                                      stack));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
                                                                                          stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ActivityId" => {
                            obj.activity_id = try!(XmlStringDeserializer::deserialize("ActivityId",
                                                                                      stack));
                        }
                        "AutoScalingGroupName" => {
                            obj.auto_scaling_group_name =
                                try!(XmlStringMaxLen255Deserializer::deserialize("AutoScalingGroupName",
                                                                                 stack));
                        }
                        "Cause" => {
                            obj.cause = try!(XmlStringMaxLen1023Deserializer::deserialize("Cause",
                                                                                          stack));
                        }
                        "Description" => {
                            obj.description = Some(try!(XmlStringDeserializer::deserialize("Description",
                                                                                           stack)));
                        }
                        "Details" => {
                            obj.details = Some(try!(XmlStringDeserializer::deserialize("Details",
                                                                                       stack)));
                        }
                        "EndTime" => {
                            obj.end_time =
                                Some(try!(TimestampTypeDeserializer::deserialize("EndTime",
                                                                                 stack)));
                        }
                        "Progress" => {
                            obj.progress = Some(try!(ProgressDeserializer::deserialize("Progress",
                                                                                       stack)));
                        }
                        "StartTime" => {
                            obj.start_time = try!(TimestampTypeDeserializer::deserialize("StartTime",
                                                                                         stack));
                        }
                        "StatusCode" => {
                            obj.status_code =
                                try!(ScalingActivityStatusCodeDeserializer::deserialize("StatusCode",
                                                                                        stack));
                        }
                        "StatusMessage" => {
                            obj.status_message =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("StatusMessage",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activity" => {
                            obj.activity = Some(try!(ActivityDeserializer::deserialize("Activity",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AdjustmentType" => {
                            obj.adjustment_type =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("AdjustmentType",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AdjustmentTypeDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlarmARN" => {
                            obj.alarm_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("AlarmARN",
                                                                                stack)));
                        }
                        "AlarmName" => {
                            obj.alarm_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("AlarmName",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingGroupARN" => {
                            obj.auto_scaling_group_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("AutoScalingGroupARN",
                                                                                stack)));
                        }
                        "AutoScalingGroupName" => {
                            obj.auto_scaling_group_name =
                        ...
                        "AvailabilityZones" => {
                            obj.availability_zones =
                                try!(AvailabilityZonesDeserializer::deserialize("AvailabilityZones",
                                                                                stack));
                        }
                        "CreatedTime" => {
                            obj.created_time = try!(TimestampTypeDeserializer::deserialize("CreatedTime",
                                                                                           stack));
                        }
                        "DefaultCooldown" => {
                            obj.default_cooldown = try!(CooldownDeserializer::deserialize("DefaultCooldown",
                                                                                          stack));
                        }
                        "DesiredCapacity" => {
                            obj.desired_capacity = try!(AutoScalingGroupDesiredCapacityDeserializer::deserialize("DesiredCapacity", stack));
                        }
                        "EnabledMetrics" => {
                            obj.enabled_metrics =
                                Some(try!(EnabledMetricsDeserializer::deserialize("EnabledMetrics",
                                                                                  stack)));
                        }
                        "HealthCheckGracePeriod" => {
                            obj.health_check_grace_period =
                                Some(try!(HealthCheckGracePeriodDeserializer::deserialize("HealthCheckGracePeriod",
                                                                                          stack)));
                        }
                        "HealthCheckType" => {
                            obj.health_check_type =
                                try!(XmlStringMaxLen32Deserializer::deserialize("HealthCheckType",
                                                                                stack));
                        }
                        "Instances" => {
                        ...
                        "LaunchConfigurationName" => {
                            obj.launch_configuration_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("LaunchConfigurationName",
                                                                                      stack)));
                        }
                        "LoadBalancerNames" => {
                            obj.load_balancer_names =
                                Some(try!(LoadBalancerNamesDeserializer::deserialize("LoadBalancerNames",
                                                                                     stack)));
                        }
                        "MaxSize" => {
                            obj.max_size =
                                try!(AutoScalingGroupMaxSizeDeserializer::deserialize("MaxSize",
                                                                                      stack));
                        }
                        "MinSize" => {
                            obj.min_size =
                                try!(AutoScalingGroupMinSizeDeserializer::deserialize("MinSize",
                                                                                      stack));
                        }
                        "NewInstancesProtectedFromScaleIn" => {
                            obj.new_instances_protected_from_scale_in =
                                Some(try!(InstanceProtectedDeserializer::deserialize("NewInstancesProtectedFromScaleIn",
                                                                                     stack)));
                        }
                        "PlacementGroup" => {
                            obj.placement_group =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("PlacementGroup",
                                                                                      stack)));
                        }
                        "Status" => {
                            obj.status =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("Status",
                                                                                      stack)));
                        }
                        "SuspendedProcesses" => {
                            obj.suspended_processes =
                                Some(try!(SuspendedProcessesDeserializer::deserialize("SuspendedProcesses",
                                                                                      stack)));
                        }
                        "Tags" => {
                            obj.tags =
                                Some(try!(TagDescriptionListDeserializer::deserialize("Tags",
                                                                                      stack)));
                        }
                        "TargetGroupARNs" => {
                            obj.target_group_ar_ns =
                                Some(try!(TargetGroupARNsDeserializer::deserialize("TargetGroupARNs",
                                                                                   stack)));
                        }
                        "TerminationPolicies" => {
                            obj.termination_policies =
                                Some(try!(TerminationPoliciesDeserializer::deserialize("TerminationPolicies",
                                                                                       stack)));
                        }
                        "VPCZoneIdentifier" => {
                            obj.vpc_zone_identifier =
                                Some(try!(XmlStringMaxLen2047Deserializer::deserialize("VPCZoneIdentifier",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl AutoScalingGroupNamesTypeSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &AutoScalingGroupNamesType) {
        ...
        if let Some(ref field_value) = obj.auto_scaling_group_names {
            AutoScalingGroupNamesSerializer::serialize(params,
                                                       &format!("{}{}",
                                                               prefix,
                    ...
                    match &name[..] {
                        "AutoScalingGroups" => {
                            obj.auto_scaling_groups =
                                try!(AutoScalingGroupsDeserializer::deserialize("AutoScalingGroups",
                                                                                stack));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
                    ...
                    match &name[..] {
                        ...
                        "AvailabilityZone" => {
                            obj.availability_zone =
                                try!(XmlStringMaxLen255Deserializer::deserialize("AvailabilityZone",
                                                                                 stack));
                        }
                        "HealthStatus" => {
                            obj.health_status =
                                try!(XmlStringMaxLen32Deserializer::deserialize("HealthStatus",
                                                                                stack));
                        }
                        "InstanceId" => {
                            obj.instance_id =
                                try!(XmlStringMaxLen19Deserializer::deserialize("InstanceId",
                                                                                stack));
                        }
                        "LaunchConfigurationName" => {
                            obj.launch_configuration_name =
                                try!(XmlStringMaxLen255Deserializer::deserialize("LaunchConfigurationName",
                                                                                 stack));
                        }
                        "LifecycleState" => {
                            obj.lifecycle_state =
                                try!(XmlStringMaxLen32Deserializer::deserialize("LifecycleState",
                                                                                stack));
                        }
                        "ProtectedFromScaleIn" => {
                            obj.protected_from_scale_in =
                                try!(InstanceProtectedDeserializer::deserialize("ProtectedFromScaleIn",
                                                                                stack));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AutoScalingInstanceDetailsDeserializer::deserialize("member",
                                                                                          stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "AutoScalingInstances" => {
                            obj.auto_scaling_instances =
                                Some(try!(AutoScalingInstancesDeserializer::deserialize("AutoScalingInstances",
                                                                                        stack)));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen255Deserializer::deserialize("member",
                                                                                  stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DeviceName" => {
                            obj.device_name =
                                try!(XmlStringMaxLen255Deserializer::deserialize("DeviceName",
                                                                                 stack));
                        }
                        "Ebs" => {
                        ...
                        "NoDevice" => {
                            obj.no_device = Some(try!(NoDeviceDeserializer::deserialize("NoDevice",
                                                                                        stack)));
                        }
                        "VirtualName" => {
                            obj.virtual_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("VirtualName",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(BlockDeviceMappingDeserializer::deserialize("member",
                                                                                  stack)));
                    } else {
                        skip_tree(stack);
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "MaxNumberOfAutoScalingGroups" => {
                            obj.max_number_of_auto_scaling_groups = Some(try!(MaxNumberOfAutoScalingGroupsDeserializer::deserialize("MaxNumberOfAutoScalingGroups", stack)));
                        }
                        "MaxNumberOfLaunchConfigurations" => {
                            obj.max_number_of_launch_configurations = Some(try!(MaxNumberOfLaunchConfigurationsDeserializer::deserialize("MaxNumberOfLaunchConfigurations", stack)));
                        }
                        "NumberOfAutoScalingGroups" => {
                            obj.number_of_auto_scaling_groups = Some(try!(NumberOfAutoScalingGroupsDeserializer::deserialize("NumberOfAutoScalingGroups", stack)));
                        }
                        "NumberOfLaunchConfigurations" => {
                            obj.number_of_launch_configurations = Some(try!(NumberOfLaunchConfigurationsDeserializer::deserialize("NumberOfLaunchConfigurations", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
                    ...
                    match &name[..] {
                        "AdjustmentTypes" => {
                            obj.adjustment_types =
                                Some(try!(AdjustmentTypesDeserializer::deserialize("AdjustmentTypes",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingNotificationTypes" => {
                            obj.auto_scaling_notification_types = Some(try!(AutoScalingNotificationTypesDeserializer::deserialize("AutoScalingNotificationTypes", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LifecycleHookTypes" => {
                            obj.lifecycle_hook_types = Some(try!(AutoScalingNotificationTypesDeserializer::deserialize("LifecycleHookTypes", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LifecycleHooks" => {
                            obj.lifecycle_hooks =
                                Some(try!(LifecycleHooksDeserializer::deserialize("LifecycleHooks",
                                                                                  stack)));
                        }
                        _ => skip_tree(stack),
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LoadBalancerTargetGroups" => {
                            obj.load_balancer_target_groups = Some(try!(LoadBalancerTargetGroupStatesDeserializer::deserialize("LoadBalancerTargetGroups", stack)));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
                                                                                          stack)));
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LoadBalancers" => {
                            obj.load_balancers =
                                Some(try!(LoadBalancerStatesDeserializer::deserialize("LoadBalancers",
                                                                                      stack)));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Granularities" => {
                            obj.granularities =
                                Some(try!(MetricGranularityTypesDeserializer::deserialize("Granularities",
                                                                                          stack)));
                        }
                        "Metrics" => {
                            obj.metrics =
                                Some(try!(MetricCollectionTypesDeserializer::deserialize("Metrics",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
                    ...
                    match &name[..] {
                        ...
                        "NotificationConfigurations" => {
                            obj.notification_configurations =
                                try!(NotificationConfigurationsDeserializer::deserialize("NotificationConfigurations",
                                                                                         stack));
                        }
                        _ => skip_tree(stack),
                    }
...
impl DescribePoliciesTypeSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribePoliciesType) {
        ...
        if let Some(ref field_value) = obj.policy_types {
            PolicyTypesSerializer::serialize(params,
...
impl DescribeScalingActivitiesTypeSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &DescribeScalingActivitiesType) {
        ...
        if let Some(ref field_value) = obj.activity_ids {
            ActivityIdsSerializer::serialize(params,
                    ...
                    match &name[..] {
                        "TerminationPolicyTypes" => {
                            obj.termination_policy_types =
                                Some(try!(TerminationPoliciesDeserializer::deserialize("TerminationPolicyTypes",
                                                                                       stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activities" => {
                            obj.activities = Some(try!(ActivitiesDeserializer::deserialize("Activities",
                                                                                           stack)));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DeleteOnTermination" => {
                            obj.delete_on_termination = Some(try!(BlockDeviceEbsDeleteOnTerminationDeserializer::deserialize("DeleteOnTermination", stack)));
                        }
                        "Encrypted" => {
                            obj.encrypted =
                                Some(try!(BlockDeviceEbsEncryptedDeserializer::deserialize("Encrypted",
                                                                                           stack)));
                        }
                        "Iops" => {
                            obj.iops =
                                Some(try!(BlockDeviceEbsIopsDeserializer::deserialize("Iops",
                                                                                      stack)));
                        }
                        "SnapshotId" => {
                            obj.snapshot_id =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("SnapshotId",
                                                                                      stack)));
                        }
                        "VolumeSize" => {
                            obj.volume_size = Some(try!(BlockDeviceEbsVolumeSizeDeserializer::deserialize("VolumeSize", stack)));
                        }
                        "VolumeType" => {
                            obj.volume_type = Some(try!(BlockDeviceEbsVolumeTypeDeserializer::deserialize("VolumeType", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Granularity" => {
                            obj.granularity =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("Granularity",
                                                                                      stack)));
                        }
                        "Metric" => {
                            obj.metric =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("Metric",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(EnabledMetricDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "LifecycleState" => {
                            obj.lifecycle_state =
                                try!(LifecycleStateDeserializer::deserialize("LifecycleState",
                                                                             stack));
                        }
                        "ProtectedFromScaleIn" => {
                            obj.protected_from_scale_in =
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Enabled" => {
                            obj.enabled =
                                Some(try!(MonitoringEnabledDeserializer::deserialize("Enabled",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AssociatePublicIpAddress" => {
                            obj.associate_public_ip_address = Some(try!(AssociatePublicIpAddressDeserializer::deserialize("AssociatePublicIpAddress", stack)));
                        }
                        "BlockDeviceMappings" => {
                            obj.block_device_mappings =
                                Some(try!(BlockDeviceMappingsDeserializer::deserialize("BlockDeviceMappings",
                                                                                       stack)));
                        }
                        "ClassicLinkVPCId" => {
                            obj.classic_link_vpc_id =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("ClassicLinkVPCId",
                                                                                      stack)));
                        }
                        "ClassicLinkVPCSecurityGroups" => {
                            obj.classic_link_vpc_security_groups = Some(try!(ClassicLinkVPCSecurityGroupsDeserializer::deserialize("ClassicLinkVPCSecurityGroups", stack)));
                        }
                        "CreatedTime" => {
                            obj.created_time = try!(TimestampTypeDeserializer::deserialize("CreatedTime",
                                                                                           stack));
                        ...
                        "EbsOptimized" => {
                            obj.ebs_optimized =
                                Some(try!(EbsOptimizedDeserializer::deserialize("EbsOptimized",
                                                                                stack)));
                        }
                        "IamInstanceProfile" => {
                            obj.iam_instance_profile =
                                Some(try!(XmlStringMaxLen1600Deserializer::deserialize("IamInstanceProfile",
                                                                                       stack)));
                        }
                        "ImageId" => {
                            obj.image_id = try!(XmlStringMaxLen255Deserializer::deserialize("ImageId",
                                                                                            stack));
                        }
                        "InstanceMonitoring" => {
                            obj.instance_monitoring =
                                Some(try!(InstanceMonitoringDeserializer::deserialize("InstanceMonitoring",
                                                                                      stack)));
                        }
                        "InstanceType" => {
                            obj.instance_type =
                                try!(XmlStringMaxLen255Deserializer::deserialize("InstanceType",
                                                                                 stack));
                        }
                        "KernelId" => {
                            obj.kernel_id =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("KernelId",
                                                                                      stack)));
                        }
                        "KeyName" => {
                            obj.key_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("KeyName",
                                                                                      stack)));
                        }
                        "LaunchConfigurationARN" => {
                            obj.launch_configuration_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("LaunchConfigurationARN",
                                                                                stack)));
                        }
                        "LaunchConfigurationName" => {
                            obj.launch_configuration_name =
                        ...
                        "PlacementTenancy" => {
                            obj.placement_tenancy =
                                Some(try!(XmlStringMaxLen64Deserializer::deserialize("PlacementTenancy",
                                                                                     stack)));
                        }
                        "RamdiskId" => {
                            obj.ramdisk_id =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("RamdiskId",
                                                                                      stack)));
                        }
                        "SecurityGroups" => {
                            obj.security_groups =
                        ...
                        "SpotPrice" => {
                            obj.spot_price = Some(try!(SpotPriceDeserializer::deserialize("SpotPrice",
                                                                                          stack)));
                        }
                        "UserData" => {
                            obj.user_data =
                                Some(try!(XmlStringUserDataDeserializer::deserialize("UserData",
                                                                                     stack)));
                        }
                        _ => skip_tree(stack),
                    }
...
impl LaunchConfigurationNamesTypeSerializer {
    fn serialize(params: &mut Params, name: &str, obj: &LaunchConfigurationNamesType) {
        ...
        if let Some(ref field_value) = obj.launch_configuration_names {
            LaunchConfigurationNamesSerializer::serialize(params,
                                                          &format!("{}{}",
                                                                  prefix,
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LaunchConfigurationDeserializer::deserialize("member",
                                                                                   stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "LaunchConfigurations" => {
                            obj.launch_configurations =
                                try!(LaunchConfigurationsDeserializer::deserialize("LaunchConfigurations",
                                                                                   stack));
                        }
                        "NextToken" => {
                            obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken",
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingGroupName" => {
                            obj.auto_scaling_group_name =
                                Some(try!(ResourceNameDeserializer::deserialize("AutoScalingGroupName",
                                                                                stack)));
                        }
                        "DefaultResult" => {
                            obj.default_result =
                                Some(try!(LifecycleActionResultDeserializer::deserialize("DefaultResult",
                                                                                         stack)));
                        }
                        "GlobalTimeout" => {
                            obj.global_timeout =
                                Some(try!(GlobalTimeoutDeserializer::deserialize("GlobalTimeout",
                                                                                 stack)));
                        }
                        "HeartbeatTimeout" => {
                            obj.heartbeat_timeout =
                                Some(try!(HeartbeatTimeoutDeserializer::deserialize("HeartbeatTimeout",
                                                                                    stack)));
                        }
                        "LifecycleHookName" => {
                            obj.lifecycle_hook_name =
                                Some(try!(AsciiStringMaxLen255Deserializer::deserialize("LifecycleHookName",
                                                                                        stack)));
                        }
                        "LifecycleTransition" => {
                            obj.lifecycle_transition =
                                Some(try!(LifecycleTransitionDeserializer::deserialize("LifecycleTransition",
                                                                                       stack)));
                        }
                        "NotificationMetadata" => {
                            obj.notification_metadata =
                                Some(try!(XmlStringMaxLen1023Deserializer::deserialize("NotificationMetadata",
                                                                                       stack)));
                        }
                        "NotificationTargetARN" => {
                            obj.notification_target_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("NotificationTargetARN",
                                                                                stack)));
                        }
                        "RoleARN" => {
                            obj.role_arn = Some(try!(ResourceNameDeserializer::deserialize("RoleARN",
                                                                                           stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LifecycleHookDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        "LoadBalancerName" => {
                            obj.load_balancer_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("LoadBalancerName",
                                                                                      stack)));
                        }
                        "State" => {
                            obj.state =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("State",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LoadBalancerStateDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
                    ...
                    match &name[..] {
                        "LoadBalancerTargetGroupARN" => {
                            obj.load_balancer_target_group_arn =
                                Some(try!(XmlStringMaxLen511Deserializer::deserialize("LoadBalancerTargetGroupARN",
                                                                                      stack)));
                        }
                        "State" => {
                            obj.state =
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LoadBalancerTargetGroupStateDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(MetricCollectionTypeDeserializer::deserialize("member",
                                                                                    stack)));
                    } else {
                        skip_tree(stack);
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(MetricGranularityTypeDeserializer::deserialize("member",
                                                                                     stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        ...
                        "NotificationType" => {
                            obj.notification_type =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("NotificationType",
                                                                                      stack)));
                        }
                        "TopicARN" => {
                            obj.topic_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("TopicARN",
                                                                                stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(NotificationConfigurationDeserializer::deserialize("member",
                                                                                         stack)));
                    } else {
                        skip_tree(stack);
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ScalingPolicies" => {
                            obj.scaling_policies =
                                Some(try!(ScalingPoliciesDeserializer::deserialize("ScalingPolicies",
                                                                                   stack)));
                        }
                        _ => skip_tree(stack),
                    }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ProcessName" => {
                            obj.process_name =
                                try!(XmlStringMaxLen255Deserializer::deserialize("ProcessName",
                                                                                 stack));
                        }
                        _ => skip_tree(stack),
                    }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Processes" => {
                            obj.processes = Some(try!(ProcessesDeserializer::deserialize("Processes",
                                                                                         stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ScalingPolicyDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "AutoScalingGroupName" => {
                            obj.auto_scaling_group_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("AutoScalingGroupName",
                                                                                      stack)));
                        }
                        "Cooldown" => {
                            obj.cooldown = Some(try!(CooldownDeserializer::deserialize("Cooldown",
                                                                                       stack)));
                        }
                        "EstimatedInstanceWarmup" => {
                            obj.estimated_instance_warmup =
                                Some(try!(EstimatedInstanceWarmupDeserializer::deserialize("EstimatedInstanceWarmup",
                                                                                           stack)));
                        }
                        "MetricAggregationType" => {
                            obj.metric_aggregation_type =
                                Some(try!(XmlStringMaxLen32Deserializer::deserialize("MetricAggregationType",
                                                                                     stack)));
                        }
                        "MinAdjustmentMagnitude" => {
                            obj.min_adjustment_magnitude =
                                Some(try!(MinAdjustmentMagnitudeDeserializer::deserialize("MinAdjustmentMagnitude",
                                                                                          stack)));
                        }
                        "MinAdjustmentStep" => {
                            obj.min_adjustment_step =
                                Some(try!(MinAdjustmentStepDeserializer::deserialize("MinAdjustmentStep",
                                                                                     stack)));
                        }
                        "PolicyARN" => {
                            obj.policy_arn =
                        ...
                        "PolicyName" => {
                            obj.policy_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("PolicyName",
                                                                                      stack)));
                        }
                        "PolicyType" => {
                            obj.policy_type =
                                Some(try!(XmlStringMaxLen64Deserializer::deserialize("PolicyType",
                                                                                     stack)));
                        }
                        "ScalingAdjustment" => {
                            obj.scaling_adjustment =
                                Some(try!(PolicyIncrementDeserializer::deserialize("ScalingAdjustment",
                                                                                   stack)));
                        }
                        "StepAdjustments" => {
                            obj.step_adjustments =
                ...
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "ScheduledUpdateGroupActions" => {
                            obj.scheduled_update_group_actions = Some(try!(ScheduledUpdateGroupActionsDeserializer::deserialize("ScheduledUpdateGroupActions", stack)));
                        }
                        _ => skip_tree(stack),
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "DesiredCapacity" => {
                            obj.desired_capacity = Some(try!(AutoScalingGroupDesiredCapacityDeserializer::deserialize("DesiredCapacity", stack)));
                        }
                        "EndTime" => {
                            obj.end_time =
                                Some(try!(TimestampTypeDeserializer::deserialize("EndTime",
                        ...
                        "MaxSize" => {
                            obj.max_size =
                                Some(try!(AutoScalingGroupMaxSizeDeserializer::deserialize("MaxSize",
                                                                                           stack)));
                        }
                        "MinSize" => {
                            obj.min_size =
                                Some(try!(AutoScalingGroupMinSizeDeserializer::deserialize("MinSize",
                                                                                           stack)));
                        }
                        "Recurrence" => {
                            obj.recurrence =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("Recurrence",
                                                                                      stack)));
                        }
                        "ScheduledActionARN" => {
                            obj.scheduled_action_arn =
                                Some(try!(ResourceNameDeserializer::deserialize("ScheduledActionARN",
                                                                                stack)));
                        }
                        "ScheduledActionName" => {
                            obj.scheduled_action_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("ScheduledActionName",
                                                                                      stack)));
                        }
                        "StartTime" => {
                            obj.start_time =
                                Some(try!(TimestampTypeDeserializer::deserialize("StartTime",
                                                                                 stack)));
                        }
                        "Time" => {
                            obj.time = Some(try!(TimestampTypeDeserializer::deserialize("Time",
                                                                                        stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ScheduledUpdateGroupActionDeserializer::deserialize("member",
                                                                                          stack)));
                    } else {
                        skip_tree(stack);
                    }
                    ...
                    match &name[..] {
                        "MetricIntervalLowerBound" => {
                            obj.metric_interval_lower_bound =
                                Some(try!(MetricScaleDeserializer::deserialize("MetricIntervalLowerBound",
                                                                               stack)));
                        }
                        "MetricIntervalUpperBound" => {
                            obj.metric_interval_upper_bound =
                                Some(try!(MetricScaleDeserializer::deserialize("MetricIntervalUpperBound",
                                                                               stack)));
                        }
                        "ScalingAdjustment" => {
                            obj.scaling_adjustment =
                                try!(PolicyIncrementDeserializer::deserialize("ScalingAdjustment",
                                                                              stack));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(StepAdjustmentDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ProcessName" => {
                            obj.process_name =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("ProcessName",
                                                                                      stack)));
                        }
                        "SuspensionReason" => {
                            obj.suspension_reason =
                                Some(try!(XmlStringMaxLen255Deserializer::deserialize("SuspensionReason",
                                                                                      stack)));
                        }
                        _ => skip_tree(stack),
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(SuspendedProcessDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        ...
                        "PropagateAtLaunch" => {
                            obj.propagate_at_launch =
                                Some(try!(PropagateAtLaunchDeserializer::deserialize("PropagateAtLaunch",
                                                                                     stack)));
                        }
                        "ResourceId" => {
                            obj.resource_id = Some(try!(XmlStringDeserializer::deserialize("ResourceId",
                                                                                           stack)));
                        }
                        "ResourceType" => {
                            obj.resource_type =
                                Some(try!(XmlStringDeserializer::deserialize("ResourceType",
                                                                             stack)));
                        }
                        "Value" => {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen511Deserializer::deserialize("member",
                                                                                  stack)));
                    } else {
                        skip_tree(stack);
                    }
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen1600Deserializer::deserialize("member",
                                                                                   stack)));
                    } else {
                        skip_tree(stack);
                    }
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => AttachInstancesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl AttachLoadBalancerTargetGroupsError {
    pub fn from_body(body: &str) -> AttachLoadBalancerTargetGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => AttachLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl AttachLoadBalancersError {
    pub fn from_body(body: &str) -> AttachLoadBalancersError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => AttachLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl CompleteLifecycleActionError {
    pub fn from_body(body: &str) -> CompleteLifecycleActionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => CompleteLifecycleActionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl CreateAutoScalingGroupError {
    pub fn from_body(body: &str) -> CreateAutoScalingGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AlreadyExistsFault" => CreateAutoScalingGroupError::AlreadyExistsFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => CreateAutoScalingGroupError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => CreateAutoScalingGroupError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl CreateLaunchConfigurationError {
    pub fn from_body(body: &str) -> CreateLaunchConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AlreadyExistsFault" => CreateLaunchConfigurationError::AlreadyExistsFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => CreateLaunchConfigurationError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => CreateLaunchConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DeleteAutoScalingGroupError {
    pub fn from_body(body: &str) -> DeleteAutoScalingGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeleteAutoScalingGroupError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ResourceInUseFault" => DeleteAutoScalingGroupError::ResourceInUseFault(String::from(parsed_error.message)),
                    "ScalingActivityInProgressFault" => DeleteAutoScalingGroupError::ScalingActivityInProgressFault(String::from(parsed_error.message)),
...
impl DeleteLaunchConfigurationError {
    pub fn from_body(body: &str) -> DeleteLaunchConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeleteLaunchConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ResourceInUseFault" => DeleteLaunchConfigurationError::ResourceInUseFault(String::from(parsed_error.message)),
...
impl DeleteLifecycleHookError {
    pub fn from_body(body: &str) -> DeleteLifecycleHookError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeleteLifecycleHookError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DeleteNotificationConfigurationError {
    pub fn from_body(body: &str) -> DeleteNotificationConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeleteNotificationConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DeletePolicyError {
    pub fn from_body(body: &str) -> DeletePolicyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeletePolicyError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DeleteScheduledActionError {
    pub fn from_body(body: &str) -> DeleteScheduledActionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DeleteScheduledActionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeAccountLimitsError {
    pub fn from_body(body: &str) -> DescribeAccountLimitsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeAccountLimitsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeAdjustmentTypesError {
    pub fn from_body(body: &str) -> DescribeAdjustmentTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeAdjustmentTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeAutoScalingGroupsError {
    pub fn from_body(body: &str) -> DescribeAutoScalingGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeAutoScalingGroupsError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeAutoScalingGroupsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeAutoScalingInstancesError {
    pub fn from_body(body: &str) -> DescribeAutoScalingInstancesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeAutoScalingInstancesError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeAutoScalingInstancesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeAutoScalingNotificationTypesError {
    pub fn from_body(body: &str) -> DescribeAutoScalingNotificationTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeAutoScalingNotificationTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeLaunchConfigurationsError {
    pub fn from_body(body: &str) -> DescribeLaunchConfigurationsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeLaunchConfigurationsError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeLaunchConfigurationsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeLifecycleHookTypesError {
    pub fn from_body(body: &str) -> DescribeLifecycleHookTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeLifecycleHookTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeLifecycleHooksError {
    pub fn from_body(body: &str) -> DescribeLifecycleHooksError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeLifecycleHooksError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeLoadBalancerTargetGroupsError {
    pub fn from_body(body: &str) -> DescribeLoadBalancerTargetGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeLoadBalancersError {
    pub fn from_body(body: &str) -> DescribeLoadBalancersError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeMetricCollectionTypesError {
    pub fn from_body(body: &str) -> DescribeMetricCollectionTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeMetricCollectionTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeNotificationConfigurationsError {
    pub fn from_body(body: &str) -> DescribeNotificationConfigurationsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeNotificationConfigurationsError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeNotificationConfigurationsError::ResourceContentionFault(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "ResourceContentionFault" => DescribePoliciesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeScalingActivitiesError {
    pub fn from_body(body: &str) -> DescribeScalingActivitiesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeScalingActivitiesError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeScalingActivitiesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeScalingProcessTypesError {
    pub fn from_body(body: &str) -> DescribeScalingProcessTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeScalingProcessTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeScheduledActionsError {
    pub fn from_body(body: &str) -> DescribeScheduledActionsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "InvalidNextToken" => DescribeScheduledActionsError::InvalidNextToken(String::from(parsed_error.message)),
                    "ResourceContentionFault" => DescribeScheduledActionsError::ResourceContentionFault(String::from(parsed_error.message)),
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    ...
                    "ResourceContentionFault" => DescribeTagsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DescribeTerminationPolicyTypesError {
    pub fn from_body(body: &str) -> DescribeTerminationPolicyTypesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DescribeTerminationPolicyTypesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DetachInstancesError {
    pub fn from_body(body: &str) -> DetachInstancesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DetachInstancesError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DetachLoadBalancerTargetGroupsError {
    pub fn from_body(body: &str) -> DetachLoadBalancerTargetGroupsError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DetachLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DetachLoadBalancersError {
    pub fn from_body(body: &str) -> DetachLoadBalancersError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DetachLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl DisableMetricsCollectionError {
    pub fn from_body(body: &str) -> DisableMetricsCollectionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => DisableMetricsCollectionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl EnableMetricsCollectionError {
    pub fn from_body(body: &str) -> EnableMetricsCollectionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => EnableMetricsCollectionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl EnterStandbyError {
    pub fn from_body(body: &str) -> EnterStandbyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => EnterStandbyError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl ExecutePolicyError {
    pub fn from_body(body: &str) -> ExecutePolicyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => ExecutePolicyError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ScalingActivityInProgressFault" => ExecutePolicyError::ScalingActivityInProgressFault(String::from(parsed_error.message)),
...
impl ExitStandbyError {
    pub fn from_body(body: &str) -> ExitStandbyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => ExitStandbyError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl PutLifecycleHookError {
    pub fn from_body(body: &str) -> PutLifecycleHookError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "LimitExceededFault" => PutLifecycleHookError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => PutLifecycleHookError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl PutNotificationConfigurationError {
    pub fn from_body(body: &str) -> PutNotificationConfigurationError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "LimitExceededFault" => PutNotificationConfigurationError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => PutNotificationConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl PutScalingPolicyError {
    pub fn from_body(body: &str) -> PutScalingPolicyError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "LimitExceededFault" => PutScalingPolicyError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => PutScalingPolicyError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl PutScheduledUpdateGroupActionError {
    pub fn from_body(body: &str) -> PutScheduledUpdateGroupActionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "AlreadyExistsFault" => PutScheduledUpdateGroupActionError::AlreadyExistsFault(String::from(parsed_error.message)),
                    "LimitExceededFault" => PutScheduledUpdateGroupActionError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => PutScheduledUpdateGroupActionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl RecordLifecycleActionHeartbeatError {
    pub fn from_body(body: &str) -> RecordLifecycleActionHeartbeatError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => RecordLifecycleActionHeartbeatError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl ResumeProcessesError {
    pub fn from_body(body: &str) -> ResumeProcessesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => ResumeProcessesError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ResourceInUseFault" => {
...
impl SetDesiredCapacityError {
    pub fn from_body(body: &str) -> SetDesiredCapacityError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => SetDesiredCapacityError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ScalingActivityInProgressFault" => SetDesiredCapacityError::ScalingActivityInProgressFault(String::from(parsed_error.message)),
...
impl SetInstanceHealthError {
    pub fn from_body(body: &str) -> SetInstanceHealthError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => SetInstanceHealthError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl SetInstanceProtectionError {
    pub fn from_body(body: &str) -> SetInstanceProtectionError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "LimitExceededFault" => SetInstanceProtectionError::LimitExceededFault(String::from(parsed_error.message)),
                    "ResourceContentionFault" => SetInstanceProtectionError::ResourceContentionFault(String::from(parsed_error.message)),
...
impl SuspendProcessesError {
    pub fn from_body(body: &str) -> SuspendProcessesError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => SuspendProcessesError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ResourceInUseFault" => SuspendProcessesError::ResourceInUseFault(String::from(parsed_error.message)),
...
impl TerminateInstanceInAutoScalingGroupError {
    pub fn from_body(body: &str) -> TerminateInstanceInAutoScalingGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => TerminateInstanceInAutoScalingGroupError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ScalingActivityInProgressFault" => TerminateInstanceInAutoScalingGroupError::ScalingActivityInProgressFault(String::from(parsed_error.message)),
...
impl UpdateAutoScalingGroupError {
    pub fn from_body(body: &str) -> UpdateAutoScalingGroupError {
        ...
        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
            Ok(parsed_error) => {
                match &parsed_error.code[..] {
                    "ResourceContentionFault" => UpdateAutoScalingGroupError::ResourceContentionFault(String::from(parsed_error.message)),
                    "ScalingActivityInProgressFault" => UpdateAutoScalingGroupError::ScalingActivityInProgressFault(String::from(parsed_error.message)),
...
pub struct AutoscalingClient<P, D>
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(AttachLoadBalancersResultTypeDeserializer::deserialize("AttachLoadBalancersResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(CompleteLifecycleActionAnswerDeserializer::deserialize("CompleteLifecycleActionResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DeleteLifecycleHookAnswerDeserializer::deserialize("DeleteLifecycleHookResult",
                                                                                     &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DescribeAccountLimitsAnswerDeserializer::deserialize("DescribeAccountLimitsResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeAdjustmentTypesAnswerDeserializer::deserialize("DescribeAdjustmentTypesResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(AutoScalingGroupsTypeDeserializer::deserialize("DescribeAutoScalingGroupsResult",
                                                                                 &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(AutoScalingInstancesTypeDeserializer::deserialize("DescribeAutoScalingInstancesResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(LaunchConfigurationsTypeDeserializer::deserialize("DescribeLaunchConfigurationsResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeLifecycleHookTypesAnswerDeserializer::deserialize("DescribeLifecycleHookTypesResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeLifecycleHooksAnswerDeserializer::deserialize("DescribeLifecycleHooksResult",
                                                                                   &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DescribeLoadBalancersResponseDeserializer::deserialize("DescribeLoadBalancersResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(PoliciesTypeDeserializer::deserialize("DescribePoliciesResult",
                                                                        &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ActivitiesTypeDeserializer::deserialize("DescribeScalingActivitiesResult",
                                                                          &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ProcessesTypeDeserializer::deserialize("DescribeScalingProcessTypesResult",
                                                                         &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ScheduledActionsTypeDeserializer::deserialize("DescribeScheduledActionsResult",
                                                                                &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(TagsTypeDeserializer::deserialize("DescribeTagsResult",
                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(DetachInstancesAnswerDeserializer::deserialize("DetachInstancesResult",
                                                                                 &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    try!(start_element(&actual_tag_name, &mut stack));
                    result =
                        try!(DetachLoadBalancersResultTypeDeserializer::deserialize("DetachLoadBalancersResult",
                                                                                    &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(EnterStandbyAnswerDeserializer::deserialize("EnterStandbyResult",
                                                                              &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ExitStandbyAnswerDeserializer::deserialize("ExitStandbyResult",
                                                                             &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(PutLifecycleHookAnswerDeserializer::deserialize("PutLifecycleHookResult",
                                                                                  &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(PolicyARNTypeDeserializer::deserialize("PutScalingPolicyResult",
                                                                         &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(SetInstanceProtectionAnswerDeserializer::deserialize("SetInstanceProtectionResult",
                                                                                       &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
        ...
        match response.status {
            StatusCode::Ok => {
                ...
                if response.body.is_empty() {
                    ...
                    let actual_tag_name = try!(peek_at_name(&mut stack));
                    try!(start_element(&actual_tag_name, &mut stack));
                    result = try!(ActivityTypeDeserializer::deserialize("TerminateInstanceInAutoScalingGroupResult",
                                                                        &mut stack));
                    skip_tree(&mut stack);
                    try!(end_element(&actual_tag_name, &mut stack));
                }
...
mod protocol_tests {
    ...
    fn test_parse_error_autoscaling_delete_policy() {
        ...
        let result = client.delete_policy(&request);
