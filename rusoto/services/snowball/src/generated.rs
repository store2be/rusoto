...
pub struct Address {
    ...
    #[doc="<p>The name of the company to receive a Snowball at an address.</p>"]
    #[serde(rename="Company")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub company: Option<String>,
    #[doc="<p>The country in an address that a Snowball is to be delivered to.</p>"]
    ...
    #[doc="<p>The name of a person to receive a Snowball at an address.</p>"]
    #[serde(rename="Name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
    #[doc="<p>The phone number associated with an address that a Snowball is to be delivered to.</p>"]
    #[serde(rename="PhoneNumber")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub phone_number: Option<String>,
    #[doc="<p>The postal code in an address that a Snowball is to be delivered to.</p>"]
    ...
    #[doc="<p>The state or province in an address that a Snowball is to be delivered to.</p>"]
    #[serde(rename="StateOrProvince")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub state_or_province: Option<String>,
    #[doc="<p>The first line in a street address that a Snowball is to be delivered to.</p>"]
    #[serde(rename="Street1")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub street_1: Option<String>,
    #[doc="<p>The second line in a street address that a Snowball is to be delivered to.</p>"]
    #[serde(rename="Street2")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub street_2: Option<String>,
    #[doc="<p>The third line in a street address that a Snowball is to be delivered to.</p>"]
...
pub struct ClusterMetadata {
    ...
    #[doc="<p>The arrays of <a>JobResource</a> objects that can include updated <a>S3Resource</a> objects or <a>LambdaResource</a> objects.</p>"]
...
pub struct CreateClusterRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub notification: Option<Notification>,
    #[doc="<p>The resources associated with the cluster job. These resources include Amazon S3 buckets and optional AWS Lambda functions written in the Python language. </p>"]
    #[serde(rename="Resources")]
...
pub struct JobLogs {
    ...
    #[doc="<p>A link to an Amazon S3 presigned URL where the job failure log is located.</p>"]
    #[serde(rename="JobFailureLogURI")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub job_failure_log_uri: Option<String>,
    #[doc="<p>A link to an Amazon S3 presigned URL where the job success log is located.</p>"]
...
pub struct JobMetadata {
    ...
    #[doc="<p>The description of the job, provided at job creation.</p>"]
    #[serde(rename="Description")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub description: Option<String>,
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub job_id: Option<String>,
    #[doc="<p>Links to Amazon S3 presigned URLs for the job report and logs. For import jobs, the PDF job report becomes available at the end of the import process. For export jobs, your job report typically becomes available while the Snowball for your job part is being delivered to you.</p>"]
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub notification: Option<Notification>,
    #[doc="<p>An array of <code>S3Resource</code> objects. Each <code>S3Resource</code> object represents an Amazon S3 bucket that your transferred data will be exported from or imported into.</p>"]
    #[serde(rename="Resources")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resources: Option<JobResource>,
...
#[derive(Default,Debug,Clone,Serialize,Deserialize)]
pub struct KeyRange {
    #[doc="<p>The key that starts an optional key range for an export job. Ranges are inclusive and UTF-8 binary sorted.</p>"]
    #[serde(rename="BeginMarker")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub begin_marker: Option<String>,
    #[doc="<p>The key that ends an optional key range for an export job. Ranges are inclusive and UTF-8 binary sorted.</p>"]
...
pub struct Shipment {
    ...
    #[doc="<p>The tracking number for this job. Using this tracking number with your region's carrier's website, you can track a Snowball as the carrier transports it.</p> <p>For India, the carrier is Amazon Logistics. For all other regions, UPS is the carrier.</p>"]
...
pub struct ShippingDetails {
    ...
    #[doc="<p>The <code>Status</code> and <code>TrackingNumber</code> values for a Snowball being returned to AWS for a particular job.</p>"]
...
pub struct UpdateClusterRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub notification: Option<Notification>,
    #[doc="<p>The updated arrays of <a>JobResource</a> objects that can include updated <a>S3Resource</a> objects or <a>LambdaResource</a> objects.</p>"]
    #[serde(rename="Resources")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resources: Option<JobResource>,
...
pub struct UpdateJobRequest {
    ...
    #[serde(skip_serializing_if="Option::is_none")]
    pub notification: Option<Notification>,
    #[doc="<p>The updated <a>S3Resource</a> object (for a single Amazon S3 bucket or key range), or the updated <a>JobResource</a> object (for multiple buckets or key ranges). </p>"]
    #[serde(rename="Resources")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub resources: Option<JobResource>,
